...
> <tr class="class-progression"><th class"level">Level</th><th class"pb">PB</th><th class"feature">Features</th><th class="value"><a href="Sonstige/z_Content%20and%20Rules/lists/list-optfeaturetype-ei.md">Invocations</a></th><th class="value">Cantrips</th><th class="value">Prepared Spells</th><th class="value">Spell Slots</th><th class="value">Slot Level</th></tr>
> </thead><tbody>
...
- **Skill Proficiencies**: *Choose 2:* [Arcana](Sonstige/z_Content%20and%20Rules/skills.md#Arcana), [Deception](Sonstige/z_Content%20and%20Rules/skills.md#Deception), [History](Sonstige/z_Content%20and%20Rules/skills.md#History), [Intimidation](Sonstige/z_Content%20and%20Rules/skills.md#Intimidation), [Investigation](Sonstige/z_Content%20and%20Rules/skills.md#Investigation), [Nature](Sonstige/z_Content%20and%20Rules/skills.md#Nature), or [Religion](Sonstige/z_Content%20and%20Rules/skills.md#Religion)
- **Weapon Proficiencies**: Simple weapons
- **Armor Training**: [Light armor](Sonstige/z_Content%20and%20Rules/item-types.md#Light%20Armor)

**Starting Equipment:** *Choose A or B:* (A) [Leather Armor](Sonstige/z_Content%20and%20Rules/items/leather-armor-xphb.md), [Sickle](Sonstige/z_Content%20and%20Rules/items/sickle-xphb.md), 2 [Daggers](Sonstige/z_Content%20and%20Rules/items/dagger-xphb.md), [Arcane Focus](Sonstige/z_Content%20and%20Rules/items/arcane-focus-xphb.md) ([orb](Sonstige/z_Content%20and%20Rules/items/orb-xphb.md)), [Book](Sonstige/z_Content%20and%20Rules/items/book-xphb.md) (occult lore), [Scholar's Pack](Sonstige/z_Content%20and%20Rules/items/scholars-pack-xphb.md), and 15 GP; or (B) 100 GP
...
You have unearthed Eldritch Invocations, pieces of forbidden knowledge that imbue you with an abiding magical ability or other lessons. You gain one invocation of your choice, such as Pact of the Tome. Invocations are described in the "Eldritch Invocation Options^[Optional features from [Eldritch Invocation](Sonstige/z_Content%20and%20Rules/lists/list-optfeaturetype-ei.md); defined in Player's Handbook (2024)]" section later in this class's description.
...
**Cantrips.** You know two Warlock cantrips of your choice. [Eldritch Blast](Sonstige/z_Content%20and%20Rules/spells/eldritch-blast-xphb.md) and [Prestidigitation](Sonstige/z_Content%20and%20Rules/spells/prestidigitation-xphb.md) are recommended. Whenever you gain a Warlock level, you can replace one of your cantrips from this feature with another Warlock cantrip of your choice.

When you reach Warlock levels 4 and 10, you learn another Warlock cantrip of your choice, as shown in the Cantrips column of the Warlock Features table.

**Spell Slots.** The Warlock Features table shows how many spell slots you have to cast your Warlock spells of levels 1–5. The table also shows the level of those slots, all of which are the same level. You regain all expended Pact Magic spell slots when you finish a [Short](Sonstige/z_Content%20and%20Rules/variant-rules/short-rest-xphb.md) or [Long Rest](Sonstige/z_Content%20and%20Rules/variant-rules/long-rest-xphb.md).

For example, when you're a level 5 Warlock, you have two level 3 spell slots. To cast the level 1 spell [Witch Bolt](Sonstige/z_Content%20and%20Rules/spells/witch-bolt-xphb.md), you must spend one of those slots, and you cast it as a level 3 spell.

**Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Warlock spells. [Charm Person](Sonstige/z_Content%20and%20Rules/spells/charm-person-xphb.md) and [Hex](Sonstige/z_Content%20and%20Rules/spells/hex-xphb.md) are recommended.
...
**Spellcasting Focus.** You can use an [Arcane Focus](Sonstige/z_Content%20and%20Rules/items/arcane-focus-xphb.md) as a [Spellcasting Focus](Sonstige/z_Content%20and%20Rules/variant-rules/spellcasting-focus-xphb.md) for your Warlock spells.
...
- [Agonizing Blast](Sonstige/z_Content%20and%20Rules/optional-features/agonizing-blast-xphb.md)  
- [Armor of Shadows](Sonstige/z_Content%20and%20Rules/optional-features/armor-of-shadows-xphb.md)  
- [Ascendant Step](Sonstige/z_Content%20and%20Rules/optional-features/ascendant-step-xphb.md)  
- [Devil's Sight](Sonstige/z_Content%20and%20Rules/optional-features/devils-sight-xphb.md)  
- [Devouring Blade](Sonstige/z_Content%20and%20Rules/optional-features/devouring-blade-xphb.md)  
- [Eldritch Mind](Sonstige/z_Content%20and%20Rules/optional-features/eldritch-mind-xphb.md)  
- [Eldritch Smite](Sonstige/z_Content%20and%20Rules/optional-features/eldritch-smite-xphb.md)  
- [Eldritch Spear](Sonstige/z_Content%20and%20Rules/optional-features/eldritch-spear-xphb.md)  
- [Fiendish Vigor](Sonstige/z_Content%20and%20Rules/optional-features/fiendish-vigor-xphb.md)  
- [Gaze of Two Minds](Sonstige/z_Content%20and%20Rules/optional-features/gaze-of-two-minds-xphb.md)  
- [Gift of the Depths](Sonstige/z_Content%20and%20Rules/optional-features/gift-of-the-depths-xphb.md)  
- [Gift of the Protectors](Sonstige/z_Content%20and%20Rules/optional-features/gift-of-the-protectors-xphb.md)  
- [Investment of the Chain Master](Sonstige/z_Content%20and%20Rules/optional-features/investment-of-the-chain-master-xphb.md)  
- [Lessons of the First Ones](Sonstige/z_Content%20and%20Rules/optional-features/lessons-of-the-first-ones-xphb.md)  
- [Lifedrinker](Sonstige/z_Content%20and%20Rules/optional-features/lifedrinker-xphb.md)  
- [Mask of Many Faces](Sonstige/z_Content%20and%20Rules/optional-features/mask-of-many-faces-xphb.md)  
- [Master of Myriad Forms](Sonstige/z_Content%20and%20Rules/optional-features/master-of-myriad-forms-xphb.md)  
- [Misty Visions](Sonstige/z_Content%20and%20Rules/optional-features/misty-visions-xphb.md)  
- [One with Shadows](Sonstige/z_Content%20and%20Rules/optional-features/one-with-shadows-xphb.md)  
- [Otherworldly Leap](Sonstige/z_Content%20and%20Rules/optional-features/otherworldly-leap-xphb.md)  
- [Pact of the Blade](Sonstige/z_Content%20and%20Rules/optional-features/pact-of-the-blade-xphb.md)  
- [Pact of the Chain](Sonstige/z_Content%20and%20Rules/optional-features/pact-of-the-chain-xphb.md)  
- [Pact of the Tome](Sonstige/z_Content%20and%20Rules/optional-features/pact-of-the-tome-xphb.md)  
- [Repelling Blast](Sonstige/z_Content%20and%20Rules/optional-features/repelling-blast-xphb.md)  
- [Thirsting Blade](Sonstige/z_Content%20and%20Rules/optional-features/thirsting-blade-xphb.md)  
- [Visions of Distant Realms](Sonstige/z_Content%20and%20Rules/optional-features/visions-of-distant-realms-xphb.md)  
- [Whispers of the Grave](Sonstige/z_Content%20and%20Rules/optional-features/whispers-of-the-grave-xphb.md)  
- [Witch Sight](Sonstige/z_Content%20and%20Rules/optional-features/witch-sight-xphb.md)  

### Magical Cunning (Level 2)

You can perform an esoteric rite for 1 minute. At the end of it, you regain expended Pact Magic spell slots but no more than a number equal to half your maximum (round up). Once you use this feature, you can't do so again until you finish a [Long Rest](Sonstige/z_Content%20and%20Rules/variant-rules/long-rest-xphb.md).
...
You gain the [Ability Score Improvement](Sonstige/z_Content%20and%20Rules/feats/ability-score-improvement-xphb.md) feat or another feat of your choice for which you qualify. You gain this feature again at Warlock levels 8, 12, and 16.
...
Once you cast the spell with this feature, you can't do so in this way again until you finish a [Long Rest](Sonstige/z_Content%20and%20Rules/variant-rules/long-rest-xphb.md).
...
You can cast your arcanum spell once without expending a spell slot, and you must finish a [Long Rest](Sonstige/z_Content%20and%20Rules/variant-rules/long-rest-xphb.md) before you can cast it in this way again.

As shown in the Warlock Features table, you gain another Warlock spell of your choice that can be cast in this way when you reach Warlock levels 13 (level 7 spell), 15 (level 8 spell), and 17 (level 9 spell). You regain all uses of your Mystic Arcanum when you finish a [Long Rest](Sonstige/z_Content%20and%20Rules/variant-rules/long-rest-xphb.md).
...
You gain an Epic Boon feat or another feat of your choice for which you qualify. [Boon of Fate](Sonstige/z_Content%20and%20Rules/feats/boon-of-fate-xphb.md) is recommended.
...
> ![Eldritch Invocation](Sonstige/z_Content%20and%20Rules/lists/list-optfeaturetype-ei.md#Eldritch%20Invocation)
^list-optfeature-ei