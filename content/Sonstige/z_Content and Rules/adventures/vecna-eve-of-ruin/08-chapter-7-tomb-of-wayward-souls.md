...
![The next rod piece lurks deep in the deadly Tomb of Wayward Souls](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/106-07-001-the-tomb-of-wayward-souls.webp#center)

Retrieving the sixth piece of the [Rod of Seven Parts](Sonstige/z_Content%20and%20Rules/items/rod-of-seven-parts-veor.md) leads the characters to a chain of tropical islands on the world of Oerth. There, the party must plumb the depths of a deadly complex called the Tomb of Wayward Souls, which was built to lure in and slay treasure-seekers. This labyrinthine maze of deadly traps was crafted by the diabolical archlich Acererak, who takes perverse pleasure in littering his dungeons with the bones of defeated adventurers.

## Running This Chapter

This chapter begins after the characters retrieve the fifth piece of the [Rod of Seven Parts](Sonstige/z_Content%20and%20Rules/items/rod-of-seven-parts-veor.md). A character who holds that piece instinctively knows that the sixth piece is located on the Isle of Serpents on Oerth, a world known for its legendary dungeons and magical treasures.

The characters arrive on the island in time to witness a battle between a [kraken](Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/kraken-xmm.md) and a crew of archaeologists. The archaeologists are in dire straits, and it's up to the characters to decide whether to help. Eventually, the characters realize that the sixth piece of the [Rod of Seven Parts](Sonstige/z_Content%20and%20Rules/items/rod-of-seven-parts-veor.md) is located in the complex the archaeologists were exploring: the Tomb of Wayward Souls.
...
The [sixth piece](Sonstige/z_Content%20and%20Rules/items/rod-of-seven-parts-veor.md) of the [Rod of Seven Parts](Sonstige/z_Content%20and%20Rules/items/rod-of-seven-parts-veor.md) is in area T27 of the Tomb of Wayward Souls. For more information about the rod and the spell this rod piece allows its wielder to cast, see this book's introduction.
...
> [!gallery]
> ![Map 7.1: Isle of Serpents Lagoon](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/107-7-01-isle-of-serpents-lagoon.webp#gallery)
> ![Player Version](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/108-7-01-isle-of-serpents-lagoon-player.webp#gallery)
...
The tentacles belong to a [kraken](Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/kraken-xmm.md) that took damage in an altercation with a hunting boat earlier and has been reduced to 250 hit points. It was lurking off the lagoon's coast when a group of archaeologists stopped here to fish. Hungry and irate, the kraken ambushed the people, who are desperately trying to escape. The kraken is positioned along the easternmost portion of the 100-foot-deep water shown on map 7.1. The archaeologists are scattered throughout the 2-foot-deep water and along the beach.

There are fifteen human and elf archaeologists on the beach. With the exception of Laysa Matulin, Talo Yieria, Vogren Starcloak, and Marian Xavere (who are described in the following sections), the archaeologists use the [commoner](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/commoner-xmm.md) stat block.

If the characters join the battle, the [kraken](Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/kraken-xmm.md) focuses on them while the archaeologists retreat. If the characters don't join the battle, the kraken gobbles up eight of the archaeologists before sinking into the lagoon, satisfied. Laysa, Talo, Vogren, and Marian are among the survivors.
...
Laysa is a chaotic good, human, pirate-turned-archaeologist (use the [assassin](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/assassin-xmm.md) stat block). Descended from the island's original inhabitants, Laysa seeks to reclaim the treasures stolen from her ancestors. She recruited a crew to help her explore the complex where she believes the treasures are held.

Laysa invites the characters to the archaeologists' camp to rest and chat.

![A kraken attacks people on the Isle of Serpents](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/109-07-001-isle-of-serpents.webp#center)
...
The archaeologists are investigating the ancient complex in which a piece of the [Rod of Seven Parts](Sonstige/z_Content%20and%20Rules/items/rod-of-seven-parts-veor.md) waits. The characters can chat with the archaeologists to learn about the complex and ask to borrow magic items to aid their quest.
...
![Laysa Matulin](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/110-07-002-laysa-matulin.webp#center)
...
Laysa is unfamiliar with the [Rod of Seven Parts](Sonstige/z_Content%20and%20Rules/items/rod-of-seven-parts-veor.md), but she agrees that such a powerful magic item could be found within the complex. She isn't aware of any other location where the rod piece might be.
...
The human woman poring over a spellbook is the camp's resident arcana expert, Marian Xavere (neutral [mage](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/mage-xmm.md)). Hailing from the mainland, Marian joined Laysa's crew because of her intense fascination with magical traps and artifacts.
...
Marian has a [Lantern of Revealing](Sonstige/z_Content%20and%20Rules/items/lantern-of-revealing-xdmg.md) sitting near her and a [Gem of Seeing](Sonstige/z_Content%20and%20Rules/items/gem-of-seeing-xdmg.md) strapped to her belt. If asked, she lends the characters the lantern but is hesitant to lend the gem. A character can convince her to lend them the [Gem of Seeing](Sonstige/z_Content%20and%20Rules/items/gem-of-seeing-xdmg.md) by succeeding on a DC 18 Charisma ([Persuasion](Sonstige/z_Content%20and%20Rules/skills.md#Persuasion)) check.
...
![Map 7.2: Tomb Complex](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/111-map-7-02-tomb-complex.webp#center)
...
The ceilings, floors, and walls of the complex are constructed from limestone. Chamber ceilings are 20 feet high, while hallway ceilings are 10 feet high. Doors are wooden and unlocked unless otherwise specified; some must be opened by special means. The complex's walls are immune to any spell or magical effect that would change their shape, such as a [Passwall](Sonstige/z_Content%20and%20Rules/spells/passwall-xphb.md) or [Stone Shape](Sonstige/z_Content%20and%20Rules/spells/stone-shape-xphb.md) spell.

#### Hidden Doors

Illusion magic conceals many of the complex's doors, making them look like solid walls. These hidden doors are detectable by touch, and creatures with [truesight](Sonstige/z_Content%20and%20Rules/senses.md#Truesight) see the doors as if they weren't hidden. Casting [Dispel Magic](Sonstige/z_Content%20and%20Rules/spells/dispel-magic-xphb.md) on a hidden door permanently removes the magic concealing it. A hidden door is otherwise identical to other doors in the complex. Locations of hidden doors are marked on map 7.3.
...
When a creature within the complex casts a spell or uses an effect that would transport itself or another creature to a different plane (such as casting [Astral Projection](Sonstige/z_Content%20and%20Rules/spells/astral-projection-xphb.md), [Banishment](Sonstige/z_Content%20and%20Rules/spells/banishment-xphb.md), [Etherealness](Sonstige/z_Content%20and%20Rules/spells/etherealness-xphb.md), or [Plane Shift](Sonstige/z_Content%20and%20Rules/spells/plane-shift-xphb.md)), the spell slot and components, item charges, or other resources are expended as normal, but nothing happens.
...
> [!gallery]
> ![Map 7.3: Tomb of Wayward Souls](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/112-7-03-tomb-of-wayward-souls.webp#gallery)
> ![Player Version](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/113-7-03-tomb-of-wayward-souls-player.webp#gallery)
...
The stone slab seals off the corridor until the next dawn, when the slab rises into its ceiling cavity and the trap resets. In the meantime, a creature can use an action to try to lift the slab, creating a passable opening with a successful DC 18 Strength ([Athletics](Sonstige/z_Content%20and%20Rules/skills.md#Athletics)) check.
...
A character who examines the relief with a [Detect Magic](Sonstige/z_Content%20and%20Rules/spells/detect-magic-xphb.md) spell or similar magic finds that the relief's mouth radiates conjuration magic and its eyes radiate abjuration magic.
...
![A cryptic message written in Celestial provides clues about how to use the seven casks in a nearby cave](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/114-07-003-seven-casks.webp#center)
...
- **Blue Square.** A creature that drinks a pint or more of the liquor in this cask gains the benefit of a [Potion of Diminution](Sonstige/z_Content%20and%20Rules/items/potion-of-diminution-xdmg.md). A character reduced to Tiny size by the liquor can't fit through the narrow gaps between the floorboards (see the "Tunnel to Area T8" section for more information).  
- **Green Crescent Moon.** A creature that drinks a pint or more of the liquor in this cask gains the benefit of an [Elixir of Health](Sonstige/z_Content%20and%20Rules/items/elixir-of-health-xdmg.md).  
- **Red Square.** A creature that drinks a pint or more of the liquor in this cask gains the benefit of a [Potion of Gaseous Form](Sonstige/z_Content%20and%20Rules/items/potion-of-gaseous-form-xdmg.md). A character in gaseous form can easily pass through the narrow gaps between the floorboards (see "Tunnel to Area T8" below).  
- **Blue Circle.** A creature that drinks a pint or more of the liquor in this cask gains the benefit of a [Potion of Growth](Sonstige/z_Content%20and%20Rules/items/potion-of-growth-xdmg.md).  
- **Green Circle.** The liquor is this cask is not magical, but it is toxic. A creature that drinks any amount of the liquor must succeed on a DC 25 Constitution saving throw or have the [poisoned](Sonstige/z_Content%20and%20Rules/conditions.md#Poisoned) condition for 1 hour.  
- **Red Star.** The liquor in this cask acts as a magical paralytic. Upon drinking any amount from this cask, a creature must succeed on a DC 20 Constitution saving throw or have the [paralyzed](Sonstige/z_Content%20and%20Rules/conditions.md#Paralyzed) condition for 1 hour.  
...
All the jewels embedded in the walls are made of worthless crystal except for one: an emerald worth 1,000 gp. A character who spends at least 1 minute examining the jewels spots the emerald with a successful DC 20 Intelligence ([Investigation](Sonstige/z_Content%20and%20Rules/skills.md#Investigation)) check. Prying the emerald from its wall socket is easily done. Placing the emerald in the statue opens the door sealing off the passage to area T16. The door resists all other attempts to open it. Once opened, however, it ceases to be locked and can thereafter be opened and closed without the emerald.

A character who succeeds on a DC 16 Intelligence ([Arcana](Sonstige/z_Content%20and%20Rules/skills.md#Arcana)) check recalls that emeralds are used to contain water elementals.
...
If examined with a [Detect Magic](Sonstige/z_Content%20and%20Rules/spells/detect-magic-xphb.md) spell or similar effect, the necklace radiates an aura of necromancy magic.
...
The banyan tree is a neutral [treant](Sonstige/z_Content%20and%20Rules/bestiary/plant/treant-xmm.md) named Abalahin. Abalahin is real, while the rest of the forest is a mirage. The mirage is tactile, so creatures can interact with it.
...
Abalahin is covered with strangling vines that render the treant sluggish and distant. A [Remove Curse](Sonstige/z_Content%20and%20Rules/spells/remove-curse-xphb.md) spell or similar effect causes the blighted vines around Abalahin to dissolve. Once the vines are gone, Abalahin is grateful to the characters and, in return, suppresses the mirage, revealing the room's exits.

##### Bobbing Spirit Lights

There are `1d8` bobbing spirit lights (each uses the [will-o'-wisp](Sonstige/z_Content%20and%20Rules/bestiary/undead/will-o-wisp-xmm.md) stat block and speaks Common and Sylvan) that fill the illusory glade at any given time. The spirit lights are part of the mirage, are indifferent to the characters' presence, and disappear if attacked. Any character with a passive Wisdom ([Perception](Sonstige/z_Content%20and%20Rules/skills.md#Perception)) score of 17 or higher discerns the spirit lights whispering and overhears one of the following remarks:

![+3 Wand of the War Mage](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/115-07-004-wand-of-the-war-mage.webp#center)
...
- **Gold Chest.** This [chest](Sonstige/z_Content%20and%20Rules/items/chest-xphb.md) is worth 100 gp on its own and contains 100 gp.  
- **Silver Chest.** This [chest](Sonstige/z_Content%20and%20Rules/items/chest-xphb.md) is worth 50 gp on its own and contains a ceremonial [dagger](Sonstige/z_Content%20and%20Rules/items/dagger-xphb.md) plated with electrum with an amethyst set in its pommel (worth 750 gp).  
- **Lead Chest.** This worthless [chest](Sonstige/z_Content%20and%20Rules/items/chest-xphb.md) contains a [Spell Scroll](Sonstige/z_Content%20and%20Rules/items/spell-scroll-xdmg.md) of [Knock](Sonstige/z_Content%20and%20Rules/spells/knock-xphb.md), which the altar trap values at 200 gp (see below).  
...
- **Gold Chest.** Six [swarms of poisonous snakes](Sonstige/z_Content%20and%20Rules/bestiary/beast/swarm-of-venomous-snakes-xmm.md) teleport into the room. The snakes are hostile.  
...
- **Lead Chest.** A [death knight](Sonstige/z_Content%20and%20Rules/bestiary/undead/death-knight-xmm.md) teleports into the room, appearing in a random unoccupied space within 15 feet of the altar. The knight is hostile.  
...
The grassy field and night sky are illusions concealing a bare, rectangular room. Characters can move only as far as the room's walls and ceiling allow, for though these surfaces are hidden to normal eyes, they can be felt. Creatures with [truesight](Sonstige/z_Content%20and%20Rules/senses.md#Truesight) recognize the illusions as mirages and can see the room as it actually is; they can also see an engraved black box resting on a black dais in the middle of the room. Characters who can't see the box and dais can locate them by touch after a careful search of the area.

##### Observing the Night Sky

A character observing the mirage of the night sky can make a DC 14 Intelligence ([Nature](Sonstige/z_Content%20and%20Rules/skills.md#Nature)) check. On a success, a character realizes that, while beautiful, the night sky is wholly inaccurate, as if created by someone who has never seen the sky before. Succeeding on this check also allows the character to see through the room's illusions, revealing not only the walls and ceiling but also the box and the dais on which it sits.

##### Box Trap

The engraved box can't be forced open, but a character can try to unlock it using thieves' tools, doing so with a successful a DC 20 Dexterity ([Sleight of Hand](Sonstige/z_Content%20and%20Rules/skills.md#Sleight%20of%20Hand)) check. A [Knock](Sonstige/z_Content%20and%20Rules/spells/knock-xphb.md) spell or similar magic also unlocks the box.

A character who inspects the box before opening it can make a DC 15 Intelligence ([Investigation](Sonstige/z_Content%20and%20Rules/skills.md#Investigation)) check. On a successful check, the character notices a spring-loaded compartment beneath the box's lid. A character can use thieves' tools to try to dismantle this compartment and disable the trap, doing so with a successful DC 15 Dexterity ([Sleight of Hand](Sonstige/z_Content%20and%20Rules/skills.md#Sleight%20of%20Hand)) check. If the trap isn't deactivated, poisoned darts burst from the box when it's opened. Each creature within 10 feet of the box when the trap is sprung must succeed on a DC 20 Dexterity saving throw or take 10 (`4d4`) piercing damage and have the [poisoned](Sonstige/z_Content%20and%20Rules/conditions.md#Poisoned) condition for 1 hour.
...
![Anyone who wanders into the tomb's arena must contend with granite juggernauts](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/116-07-005-granite-juggernauts.webp#center)
...
The room's ceiling is 10 feet high—barely large enough to accommodate the two [granite juggernauts](Sonstige/z_Content%20and%20Rules/bestiary/construct/granite-juggernaut-veor.md) (see appendix A) that trundle between the room's pillars. The juggernauts attack any intruders they notice, but they won't strike pillars.
...
The triangular stone is immovable and powers the [juggernauts](Sonstige/z_Content%20and%20Rules/bestiary/construct/granite-juggernaut-veor.md) in area T14. A character who examines the triangular stone and succeeds on a DC 17 Intelligence ([Arcana](Sonstige/z_Content%20and%20Rules/skills.md#Arcana)) check can decipher its runes and discern its purpose.
...
The central statue uses the [marilith](Sonstige/z_Content%20and%20Rules/bestiary/fiend/marilith-xmm.md) stat block but is a Construct. This central statue controls the two cobra statues; each cobra statue uses the [spirit naga](Sonstige/z_Content%20and%20Rules/bestiary/fiend/spirit-naga-xmm.md) stat block but is a Construct. The statues speak Common. The statues are hostile toward any creature that enters the chamber.

![Sword of Sharpness (scimitar) with a snake-shaped pommel](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/117-07-006-sword-of-sharpness.webp#center)

##### Appeasing the Statues

A character can use an action to try to appease the statues with a DC 20 Charisma ([Persuasion](Sonstige/z_Content%20and%20Rules/skills.md#Persuasion)) check; if the character makes an offering of food or treasure worth 50 gp or more, this check is made with advantage. On a successful check, the statues become friendly toward the characters and cease attacking.
...
One of the central statue's swords functions as a [Sword of Sharpness (scimitar)](Sonstige/z_Content%20and%20Rules/items/sword-of-sharpness-xdmg.md) in the hands of a Humanoid. The scimitar is one of the treasures Laysa mentioned earlier in this chapter. If told about Laysa, the central statue willingly gives the sword; otherwise, the sword can be retrieved when all the statues have been defeated.
...
There are two ways to open the doors. A character can play one of the hallway's instruments and make a DC 20 Charisma ([Performance](Sonstige/z_Content%20and%20Rules/skills.md#Performance)) check; if the character doesn't have proficiency with the chosen instrument, this check is made with disadvantage. On a successful check, the doors open. On a failed check, the character takes 16 (`3d10`) psychic damage, and the doors remain locked.
...
![A Manual of Bodily Healthy written on engraved copper sheets](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/118-07-007-manual-of-bodily-health.webp#center)

##### Guardians

Whenever an item is removed from this room's shelves, one of the five skeletal statues here springs to life. The statue uses the [stone golem](Sonstige/z_Content%20and%20Rules/bestiary/construct/stone-golem-xmm.md) stat block but is Medium and hostile, attacking whichever creature took the item. The statue remains active until the triggering item is returned or until the statue is destroyed. Multiple statues can be active at once.

##### Treasure

A thorough search of the shelves' contents takes 10 minutes and yields the following items:

- [Spell Scroll](Sonstige/z_Content%20and%20Rules/items/spell-scroll-xdmg.md) of [Greater Restoration](Sonstige/z_Content%20and%20Rules/spells/greater-restoration-xphb.md)  
- Set of engraved copper sheets that functions as a [Manual of Bodily Health](Sonstige/z_Content%20and%20Rules/items/manual-of-bodily-health-xdmg.md) (one of the treasures Laysa mentioned earlier in this chapter)  
...
These two storage closets are identical. The door to each room is locked. As an action, a character can use thieves' tools to try to unlock either door, doing so with a successful DC 15 Dexterity ([Sleight of Hand](Sonstige/z_Content%20and%20Rules/skills.md#Sleight%20of%20Hand)) check. Each door can also be forced open from either side with a successful DC 11 Strength ([Athletics](Sonstige/z_Content%20and%20Rules/skills.md#Athletics)) check, or with a [Knock](Sonstige/z_Content%20and%20Rules/spells/knock-xphb.md) spell or similar magic.
...
In the center of each room is an uncontrolled [Sphere of Annihilation](Sonstige/z_Content%20and%20Rules/items/sphere-of-annihilation-xdmg.md). The magical darkness obscures the sphere; only creatures with [truesight](Sonstige/z_Content%20and%20Rules/senses.md#Truesight) can detect its presence.
...
This room is filled with magical darkness, and neither the darkness nor the eerie sounds can be dispelled. Any creature that enters this room for the first time must succeed on a DC 18 Wisdom saving throw or have the [frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened) condition, as the darkness and eerie sounds conjure up the creature's deepest fears. The [frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened) condition ends on the creature when it leaves the room.

While [frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened) in this way, a creature takes 11 (`2d10`) psychic damage for every 5 feet it moves. After taking this damage, the creature can repeat the saving throw, ending the frightened condition on a itself on a success.

##### Piercing the Illusion

Creatures with [truesight](Sonstige/z_Content%20and%20Rules/senses.md#Truesight) see the room for what it is: an abandoned study. A dusty desk and empty bookcase line the east wall.
...
![Map 7.4: Vortex Bridge Puzzle](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/119-07-009-vortex-bridge-puzzle.webp#center)
...
When observed within the range of a [Detect Magic](Sonstige/z_Content%20and%20Rules/spells/detect-magic-xphb.md) spell or similar magic, the vortex radiates an aura of evocation and transmutation magic. A character who observes the vortex or witnesses the flight-inhibiting effect of the room's gravity well can make a DC 16 Intelligence ([Arcana](Sonstige/z_Content%20and%20Rules/skills.md#Arcana)) check, recalling the following facts on a success:

- The spell [Reverse Gravity](Sonstige/z_Content%20and%20Rules/spells/reverse-gravity-xphb.md) is a transmutation spell.  
...
This chamber bears the remnants of Acererak's endeavors to create empowered simulacra to guard his many tombs. A character who examines the cylinders and succeeds on a DC 20 Intelligence ([Arcana](Sonstige/z_Content%20and%20Rules/skills.md#Arcana)) check recognizes the snow and powdered ruby in each glass cylinder as components for creating a simulacrum.

##### Secret Desk Compartment

A character who searches the desk and succeeds on a DC 20 Intelligence ([Investigation](Sonstige/z_Content%20and%20Rules/skills.md#Investigation)) check discovers that one of its drawers contains a locked false bottom. Rerak (see area T26) carries the key to this compartment, but a character with thieves' tools can use them to try to unlock the compartment, doing so with a successful DC 20 Dexterity ([Sleight of Hand](Sonstige/z_Content%20and%20Rules/skills.md#Sleight%20of%20Hand)) check. A [Knock](Sonstige/z_Content%20and%20Rules/spells/knock-xphb.md) spell or similar magic also unlocks the compartment.

The secret compartment bears a magical trap. If the compartment is opened by any means other than using the key found on Rerak in area T26, magical lightning shoots from the drawer. Each creature in the room must make a DC 15 Dexterity saving throw, taking 26 (`4d12`) lightning damage on a failed save or half as much damage on a successful one. A [Detect Magic](Sonstige/z_Content%20and%20Rules/spells/detect-magic-xphb.md) spell or similar effect unveils the source of this trap: a tiny rune inscribed in the drawer. The trap can be disarmed by dispelling the rune with a [Dispel Magic](Sonstige/z_Content%20and%20Rules/spells/dispel-magic-xphb.md) spell (DC 17).

##### Treasure

Within the hidden desk compartment is a rose quartz [Crystal Ball](Sonstige/z_Content%20and%20Rules/items/crystal-ball-xdmg.md) and a stack of notes written in Common. The Crystal Ball is one of the treasures Laysa mentioned earlier in this chapter.
...
Characters standing outside this room can see that it is empty, but a [Detect Magic](Sonstige/z_Content%20and%20Rules/spells/detect-magic-xphb.md) spell reveals the presence of illusion magic throughout. When one or more characters enter the room, read the following:
...
A hostile [giant shark](Sonstige/z_Content%20and%20Rules/bestiary/beast/giant-shark-xmm.md) swims beneath the characters. The shark is part of the mirage, though it can harm characters who don't pierce the illusion. The shark can't harm anyone outside the room.

##### Piercing the Illusion

A creature that succeeds on a DC 18 Intelligence ([Investigation](Sonstige/z_Content%20and%20Rules/skills.md#Investigation)) check can see through the illusion, perceiving the empty room and its exits. A creature with [truesight](Sonstige/z_Content%20and%20Rules/senses.md#Truesight) can also see through the illusion.
...
If the double door is opened via any other means besides the correct combination, a cloud of sweet-smelling gas is released from the skull engraving. The gas fills the widened area immediately south of the double door. Each creature in that area must succeed on a DC 20 Constitution saving throw or have the [unconscious](Sonstige/z_Content%20and%20Rules/conditions.md#Unconscious) condition for `2d4 + 10` minutes. An [unconscious](Sonstige/z_Content%20and%20Rules/conditions.md#Unconscious) creature can repeat this saving throw each time it takes damage, ending the effect on itself on a successful save.
...
The figure sitting on the throne is Rerak, a [false lich](Sonstige/z_Content%20and%20Rules/bestiary/undead/false-lich-veor.md) (see appendix A). Although alert, Rerak remains motionless until he takes damage or a creature moves within 15 feet of him, at which point he becomes hostile and attacks.

##### Appeasing Rerak

Upon creation, Rerak was magically bound to Acererak's piece of the [Rod of Seven Parts](Sonstige/z_Content%20and%20Rules/items/rod-of-seven-parts-veor.md); as long as the rod piece remains within the tomb, so must Rerak. Rerak resents his creator for leaving him to languish within this tomb, and though he remains loyal to Acererak, he longs to experience the world beyond the tomb's walls.

Throughout the fight, Rerak commands the characters to flee. Each time Rerak does this, each character can make a DC 19 Wisdom ([Insight](Sonstige/z_Content%20and%20Rules/skills.md#Insight)) check without taking an action. On a successful check, the character discerns a melancholy tone to Rerak's words, as if he loathed that he must kill them.

During combat, a character can use an action to try to convince Rerak to turn against his creator. Have that character make a DC 23 Charisma ([Persuasion](Sonstige/z_Content%20and%20Rules/skills.md#Persuasion)) check. If the character mentions the mirages or Acererak's disdain toward his creations (found in the notes in area T23), this check is made with advantage. On a successful check, Rerak's loyalty to Acererak is shaken. After three successful checks, Rerak halts the battle and crushes his eye sockets' gems, severing his connection to Acererak and releasing any souls trapped within.
...
The items on the pedestals are false re-creations of treasures that can be found throughout the complex. A creature that touches one of these false treasures must immediately succeed on a DC 15 Constitution saving throw or take 10 (`3d6`) necrotic damage and have the [stunned](Sonstige/z_Content%20and%20Rules/conditions.md#Stunned) condition until the start of its next turn.
...
![The false lich Rerak is a terrifying sight to behold](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/120-07-008-rerak.webp#center)
...
The [sixth piece](Sonstige/z_Content%20and%20Rules/items/rod-of-seven-parts-veor.md) of the [Rod of Seven Parts](Sonstige/z_Content%20and%20Rules/items/rod-of-seven-parts-veor.md) rests on the pedestal.
...
For more about the [Rod of Seven Parts](Sonstige/z_Content%20and%20Rules/items/rod-of-seven-parts-veor.md), see this book's introduction.

##### Treasure

If a character shows the silk sash to Laysa, she identifies it as a garment given to her people that functions as a [Robe of Stars](Sonstige/z_Content%20and%20Rules/items/robe-of-stars-xdmg.md). The robe is one of the treasures Laysa mentioned earlier in this chapter.
