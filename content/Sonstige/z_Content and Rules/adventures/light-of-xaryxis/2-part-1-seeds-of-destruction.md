...
![](Sonstige/z_Content%20and%20Rules/adventures/light-of-xaryxis/img/004-09-001-part-one-splash.webp#center)
...
The friendly sailor, [Elaina Sartell](Sonstige/z_Content%20and%20Rules/bestiary/npc/elaina-sartell-lox.md), is described later in the chapter. She flees at once, leaving the characters to decide their own course of action.

The ambulatory vines are six [astral blights](Sonstige/z_Content%20and%20Rules/bestiary/plant/astral-blight-lox.md) (see the accompanying stat block). They focus their attacks on nearby commoners, ignoring the characters except for any who attack them. The blights' slow speed means the characters can evade them easily.
...
- **Head to the Docks.** If the characters heed [Elaina Sartell](Sonstige/z_Content%20and%20Rules/bestiary/npc/elaina-sartell-lox.md)'s advice and head to the docks, run the "Trouble at the Docks" encounter when they arrive.  
...
![Astral Blight](Sonstige/z_Content%20and%20Rules/adventures/light-of-xaryxis/img/005-637961800673014558.webp#center)

### Crystalline Vine

The vine growing in the center of the settlement sprouted after an astral seed fell from the sky, crashed into the bakery, and buried itself in the ground. The vine is 50 feet wide at its base, rises 1,000 feet into the air, and is still growing. It is made of an iridescent mineral that is impervious to the characters' spells and weapons. A character who makes a successful DC 10 Intelligence ([Nature](Sonstige/z_Content%20and%20Rules/skills.md#Nature)) check determines that the substance is a type of living crystal.

No astral blights congregate near the crystalline vine, which means the characters can approach and study it without being attacked. The vine is warm to the touch and pulses with light. Any character who succeeds on a DC 15 Intelligence ([Arcana](Sonstige/z_Content%20and%20Rules/skills.md#Arcana)) check realizes that the vine's roots extend deep into the earth and are feeding on the planet's thermal energy. There appears to be no way to stop this process.
...
Astral blights roam the streets. Members of the local militia (use the [guard](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/guard-xmm.md) stat block) try to hold the blights at bay long enough for unarmed civilians to flee the vicinity. If the characters stay in a single location for longer than 1 minute, `1d6` [astral blights](Sonstige/z_Content%20and%20Rules/bestiary/plant/astral-blight-lox.md) (see the accompanying stat block) converge on their location and attack them.
...
> 
> A woman steps out of the crowd and wipes blood from her chin. "Glad to see you again," she says with a smile. "I'm Captain [Elaina Sartell](Sonstige/z_Content%20and%20Rules/bestiary/npc/elaina-sartell-lox.md), and one of those ships is mine. Pity I can't reach it. Would you be good enough to help me? I promise to return the favor."
^013

Captain [Elaina Sartell](Sonstige/z_Content%20and%20Rules/bestiary/npc/elaina-sartell-lox.md), a chaotic good [bandit captain](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/bandit-captain-xmm.md), commands the galleon *Moondancer*. She is unflappable—an island of calm in a sea of chaos.

#### Traevus and His Gang

Captain Sartell identifies the red-haired man as a local crime lord named Traevus—a neutral evil [veteran](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/warrior-veteran-xmm.md). The ten [thugs](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/tough-xmm.md) blocking her path work for him.
...
Traevus is intent on saving himself and as much of his merchandise as possible. As an action, a character can try to convince him to take the party and Sartell on as crew, doing so with a successful DC 10 Charisma ([Persuasion](Sonstige/z_Content%20and%20Rules/skills.md#Persuasion)) check.
...
> [!readaloud] 
> 
> The crystalline vine coils upward, scraping the sky. From the harbor, you can see similar vines miles from the settlement, having burst out of the world and reaching skyward. As the *Moondancer* clears the harbor, Captain Sartell stamps her boot hard on the deck. "[Flapjack](Sonstige/z_Content%20and%20Rules/bestiary/npc/flapjack-lox.md)!" she yells. "Take us up!"
> 
...
![Captain Elaina Sartell](Sonstige/z_Content%20and%20Rules/adventures/light-of-xaryxis/img/006-09-002-captain-elaina-sartell.webp#center)
...
- Up to sixty [commoners](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/commoner-xmm.md) (six of whom are competent sailors)  
...
![Flapjack](Sonstige/z_Content%20and%20Rules/adventures/light-of-xaryxis/img/007-09-003-flapjack.webp#center)
...
One crew member stayed aboard the *Moondancer* while it was in port: a [flumph](Sonstige/z_Content%20and%20Rules/bestiary/aberration/flumph-xmm.md) named [Flapjack](Sonstige/z_Content%20and%20Rules/bestiary/npc/flapjack-lox.md), who serves as the ship's spelljammer. [Flapjack](Sonstige/z_Content%20and%20Rules/bestiary/npc/flapjack-lox.md) has the following additional action option:
...
> 
> At will: [mage hand](Sonstige/z_Content%20and%20Rules/spells/mage-hand-xphb.md), [minor illusion](Sonstige/z_Content%20and%20Rules/spells/minor-illusion-xphb.md)
> 
> 1/day each: [magic missile](Sonstige/z_Content%20and%20Rules/spells/magic-missile-xphb.md), [unseen servant](Sonstige/z_Content%20and%20Rules/spells/unseen-servant-xphb.md)
^022

#### Features of the Moondancer

> [!gallery]
> ![Moondancer Deck Plans](Sonstige/z_Content%20and%20Rules/adventures/light-of-xaryxis/img/008-map-2-11-space-galleon.webp#gallery)
> ![Player Version](Sonstige/z_Content%20and%20Rules/adventures/light-of-xaryxis/img/009-map-2-11-space-galleon-player.webp#gallery)
...
Captain's Quarters. Among Captain Sartell's possessions is a locked treasure chest, which she keeps in her cabin. Captain Sartell carries the only key to the chest. As an action, a character can pick the lock by making a successful DC 15 Dexterity check using thieves' tools, or break open the chest with a successful DC 15 Strength ([Athletics](Sonstige/z_Content%20and%20Rules/skills.md#Athletics)) check. The chest contains three bottles of fine wine (10 gp each), six gold bracelets (25 gp each), nine pearls (100 gp each) in a velvet pouch, and a [spell scroll](Sonstige/z_Content%20and%20Rules/items/spell-scroll-xdmg.md) of air bubble (see the "Astral Adventurer's Guide").

##### Area 5:

Spelljamming Helm. The ship's spelljamming helm looks like a floating, ornate silver chair with a purple seat cushion and no legs. Glowing blue crystals underneath the seat project a magic circle onto the floor, stabilizing the chair. [Flapjack the flumph](Sonstige/z_Content%20and%20Rules/bestiary/npc/flapjack-lox.md) sits in the chair while piloting the ship.

##### Area 12:

Upper Cargo Hold. The upper cargo hold contains a dozen healthy [mules](Sonstige/z_Content%20and%20Rules/items/mule-xphb.md) (which Sartell plans to sell as beasts of burden); sacks of food for the animals; and material placed here by Traevus and his gang (see chapter 1), which consists of twenty 40-pound crates of assorted martial weapons (2,000 gp total value) and five hundred bottles of brandy (3 gp each).
...
![The Dark Star](Sonstige/z_Content%20and%20Rules/adventures/light-of-xaryxis/img/010-09-004-the-dark-star.webp#center)
...
If the characters are defeated, the astral elves allow dying characters to be stabilized. The astral elves assume control of the *Moondancer* while keeping Captain Sartell hostage aboard the *Dark Star* to ensure [Flapjack](Sonstige/z_Content%20and%20Rules/bestiary/npc/flapjack-lox.md)'s compliance. The astral elf and plasmoid crew members are split between the two ships. The astral elves then start heading for the edge of the Wildspace system to rendezvous with the rest of Vael's fleet. En route, the two ships might encounter the derelict nautiloid, neogi raiders, or the Rock of Bral navy (all described in chapters 3 and 4), providing the characters with opportunities to escape.
...
During the voyage, the characters are free to ask Sartell or [Flapjack](Sonstige/z_Content%20and%20Rules/bestiary/npc/flapjack-lox.md) more about Wildspace, the Rock of Bral, or the duo's previous adventures. Captain Sartell enjoys telling of her encounters with various Wildspace creatures (among them a friendly solar dragon and some not-so-friendly space clowns), while [Flapjack](Sonstige/z_Content%20and%20Rules/bestiary/npc/flapjack-lox.md) explains the subtleties of astral navigation. If the party has any spellcasters, [Flapjack](Sonstige/z_Content%20and%20Rules/bestiary/npc/flapjack-lox.md) takes this opportunity to instruct them in the rudiments of spelljamming.
...
![Wreck of the Lucent Edict](Sonstige/z_Content%20and%20Rules/adventures/light-of-xaryxis/img/011-09-005-wreck-lucent-edict.webp#center)
...
The sensory input provided by the *Moondancer*'s spelljamming helm interfaces in a special way with [Flapjack](Sonstige/z_Content%20and%20Rules/bestiary/npc/flapjack-lox.md)'s Advanced Telepathy, enabling the flumph to sense the presence of telepathic activity on nearby vessels and making the flumph a sort of early warning system in advance of encounters with mind flayers and their ilk. The nautiloid makes [Flapjack](Sonstige/z_Content%20and%20Rules/bestiary/npc/flapjack-lox.md) uneasy, a feeling that stems from the presence of psurlons on board it. At the same time, the psurlons' Aberrant Mind trait confounds the [flumph's](Sonstige/z_Content%20and%20Rules/bestiary/npc/flapjack-lox.md) Advanced Telepathy. [Flapjack](Sonstige/z_Content%20and%20Rules/bestiary/npc/flapjack-lox.md) has the vague sense that something is aboard the derelict vessel but can't say what. He shares this information with Sartell and any characters with whom he has forged a close bond.

Captain Sartell orders [Flapjack](Sonstige/z_Content%20and%20Rules/bestiary/npc/flapjack-lox.md) to bring her ship alongside the vessel while she designates the characters as a boarding party, instructing them to kill any hostile creatures they encounter.

If the characters balk at exploring the nautiloid, Captain Sartell sarcastically apologizes for interrupting their "pleasure cruise" and wonders aloud whether they'd rather stay back and swab the decks while she does all the hard work. If the characters still refuse, Captain Sartell makes good on her threat and boards the vessel herself in search of salvage. When she doesn't return, [Flapjack](Sonstige/z_Content%20and%20Rules/bestiary/npc/flapjack-lox.md) urges the party to go and find her, refusing to leave the nautiloid behind until they do so.
...
> [!gallery]
> ![Nautiloid Deck Plans](Sonstige/z_Content%20and%20Rules/adventures/light-of-xaryxis/img/012-map-2-07-nautiloid.webp#gallery)
> ![Player Version](Sonstige/z_Content%20and%20Rules/adventures/light-of-xaryxis/img/013-map-2-07-nautiloid-player.webp#gallery)
...
Any character who disturbs the headless corpse causes the green, glowing maggots covering it to become a hostile [swarm of insects](Sonstige/z_Content%20and%20Rules/bestiary/beast/swarm-of-insects-xmm.md).

##### Treasure

A character who examines the captain's chair and succeeds on a DC 15 Intelligence ([Investigation](Sonstige/z_Content%20and%20Rules/skills.md#Investigation)) check finds a secret compartment in the left armrest. This compartment contains a black metal tube containing a [spell scroll](Sonstige/z_Content%20and%20Rules/items/spell-scroll-xdmg.md) of [wall of force](Sonstige/z_Content%20and%20Rules/spells/wall-of-force-xphb.md).
...
Lying on the deck near the dead mind flayer is an [Ioun stone (reserve)](Sonstige/z_Content%20and%20Rules/items/ioun-stone-reserve-xdmg.md). The stone currently holds a single casting of the [shield](Sonstige/z_Content%20and%20Rules/spells/shield-xphb.md) spell.

#### 4: Bridge Floor

![](Sonstige/z_Content%20and%20Rules/adventures/light-of-xaryxis/img/014-09-006-nehthalggu-splash.webp#center)
...
The mess hall contains a neh-thalggu (see "Boo's Astral Menagerie") that currently has eight brains. The neh-thalggu, kept as a pet by the mind flayers, evaded the githyanki by using its [invisibility](Sonstige/z_Content%20and%20Rules/spells/invisibility-xphb.md) spell, but it was later trapped here by the human pirates after it killed one of their number.
...
The cargo hold contains eleven human corpses. The arachnid form is a dead "neogi" (see "Boo's Astral Menagerie"). A character who examines the corpses and makes a successful DC 10 Intelligence ([Investigation](Sonstige/z_Content%20and%20Rules/skills.md#Investigation)) check discovers that all the bodies have circular bite marks on them, including the neogi. Although several scimitars and crossbows are scattered about the room, the corpses show no evidence of having been struck by them.

The bodies are in varying states of decay. With a successful DC 10 Wisdom ([Medicine](Sonstige/z_Content%20and%20Rules/skills.md#Medicine)) check, a character can determine that the neogi died within the last 24 hours, and that the freshest human corpses are at least three days old.
...
The beheaded mind flayer wears a [+1 breastplate](Sonstige/z_Content%20and%20Rules/items/1-armor-xdmg.md) embossed with tentacles.
...
A [quaggoth](Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/quaggoth-xmm.md) hides around the corner on the starboard side of the compartment, out of view of the doorway. Fearing capture, it attacks any creature that enters the compartment.
