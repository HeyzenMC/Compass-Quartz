...
- [[#Glossary of Terms|Glossary of Terms]]
	- [[#Glossary of Terms#Domains & Intrigue|Domains & Intrigue]]
	- [[#Glossary of Terms#Warfare|Warfare]]
- [[#The Core Assumptions|The Core Assumptions]]
- [[#Characters and Officers|Characters and Officers]]
- [[#What is an Organization?|What is an Organization?]]
- [[#Describing a Domain|Describing a Domain]]
- [[#Intrigue|Intrigue]]
- [[#Founding an Organization|Founding an Organization]]
	- [[#Founding an Organization#Choosing an Organization Type|Choosing an Organization Type]]
	- [[#Founding an Organization#Development Points|Development Points]]
	- [[#Founding an Organization#Raising an Army|Raising an Army]]
	- [[#Founding an Organization#Granting Titles|Granting Titles]]
- [[#Organizations and Warfare|Organizations and Warfare]]
- [[#Before Intrigue|Before Intrigue]]
- [[#Domain Skill Tests|Domain Skill Tests]]
	- [[#Domain Skill Tests#Using Domain Skills Outside of Intrigue|Using Domain Skills Outside of Intrigue]]
- [[#Running Intrigue|Running Intrigue]]
- [[#Domain Turns and Actions|Domain Turns and Actions]]
	- [[#Domain Turns and Actions#Choosing Actions|Choosing Actions]]
	- [[#Domain Turns and Actions#Who Knows What?|Who Knows What?]]
	- [[#Domain Turns and Actions#Taking Domain Turns|Taking Domain Turns]]
- [[#Domain Skills|Domain Skills]]
	- [[#Domain Skills#Adjusting Defense Levels|Adjusting Defense Levels]]
	- [[#Domain Skills#Other Uses for Domain Skills|Other Uses for Domain Skills]]
	- [[#Domain Skills#Diplomacy|Diplomacy]]
	- [[#Domain Skills#Espionage|Espionage]]
	- [[#Domain Skills#Lore|Lore]]
	- [[#Domain Skills#Operations|Operations]]
- [[#Domain Defenses|Domain Defenses]]
	- [[#Domain Defenses#Communications|Communications]]
		- [[#Communications#Communications Levels|Communications Levels]]
	- [[#Domain Defenses#Resolve|Resolve]]
		- [[#Resolve#Resolve Levels|Resolve Levels]]
	- [[#Domain Defenses#Resources|Resources]]
		- [[#Resources#Resolve Levels|Resolve Levels]]
- [[#Domain Size|Domain Size]]
		- [[#Resources#Domain Size|Domain Size]]
- [[#Domain Powers|Domain Powers]]
	- [[#Domain Powers#Power Dice|Power Dice]]
- [[#Villainous and NPC Realms|Villainous and NPC Realms]]
	- [[#Villainous and NPC Realms#Building a Villainous Realm|Building a Villainous Realm]]
	- [[#Villainous and NPC Realms#Building an NPC Realm|Building an NPC Realm]]
	- [[#Villainous and NPC Realms#Creating NPC Realms Together|Creating NPC Realms Together]]
- [[#Heroic Organizations|Heroic Organizations]]
- [[#Adventuring Party|Adventuring Party]]
	- [[#Adventuring Party#Domain Titles|Domain Titles]]
	- [[#Adventuring Party#Domain Power|Domain Power]]
	- [[#Adventuring Party#Domain Features|Domain Features]]
	- [[#Adventuring Party#Specialization|Specialization]]
	- [[#Adventuring Party#Disorganized Misfits|Disorganized Misfits]]
		- [[#Disorganized Misfits#Skill and Defense Bonuses- **Operations:** +1|Skill and Defense Bonuses- **Operations:** +1]]
	- [[#Adventuring Party#Domain Power|Domain Power]]
	- [[#Adventuring Party#Domain Features|Domain Features]]
	- [[#Adventuring Party#Explorers' Society|Explorers' Society]]
		- [[#Explorers' Society#Skill and Defense Bonuses- **Lore:** +2|Skill and Defense Bonuses- **Lore:** +2]]
	- [[#Adventuring Party#Domain Power|Domain Power]]
	- [[#Adventuring Party#Domain Features|Domain Features]]
	- [[#Adventuring Party#Mercenary Company|Mercenary Company]]
		- [[#Mercenary Company#Skill and Defense Bonuses- **Operations:** +1|Skill and Defense Bonuses- **Operations:** +1]]
	- [[#Adventuring Party#Domain Power|Domain Power]]
	- [[#Adventuring Party#Domain Features|Domain Features]]
- [[#Martial Regiment|Martial Regiment]]
	- [[#Martial Regiment#Domain Titles|Domain Titles]]
	- [[#Martial Regiment#Domain Power|Domain Power]]
	- [[#Martial Regiment#Domains Features|Domains Features]]
	- [[#Martial Regiment#Specialization|Specialization]]
	- [[#Martial Regiment#City Watch|City Watch]]
		- [[#City Watch#Skill and Defense Bonuses- **Communications:** +1|Skill and Defense Bonuses- **Communications:** +1]]
	- [[#Martial Regiment#Domain Power|Domain Power]]
	- [[#Martial Regiment#Domain Features|Domain Features]]
	- [[#Martial Regiment#Knightly Order|Knightly Order]]
		- [[#Knightly Order#Skill and Defense Bonuses- **Diplomacy:** +1|Skill and Defense Bonuses- **Diplomacy:** +1]]
	- [[#Martial Regiment#Domain Power|Domain Power]]
	- [[#Martial Regiment#Domain Features|Domain Features]]
	- [[#Martial Regiment#Military Squadron|Military Squadron]]
		- [[#Military Squadron#Skill and Defense Bonuses- **Espionage:** +1|Skill and Defense Bonuses- **Espionage:** +1]]
	- [[#Martial Regiment#Domain Power|Domain Power]]
	- [[#Martial Regiment#Domain Features|Domain Features]]
- [[#Mercantile Guild|Mercantile Guild]]
	- [[#Mercantile Guild#Domain Titles|Domain Titles]]
	- [[#Mercantile Guild#Domain Power|Domain Power]]
	- [[#Mercantile Guild#Domain Features|Domain Features]]
	- [[#Mercantile Guild#Specialization|Specialization]]
	- [[#Mercantile Guild#Monopoly|Monopoly]]
		- [[#Monopoly#Skill and Defense Bonuses- **Espionage:** +1|Skill and Defense Bonuses- **Espionage:** +1]]
	- [[#Mercantile Guild#Domain Power|Domain Power]]
	- [[#Mercantile Guild#Domain Features|Domain Features]]
	- [[#Mercantile Guild#Pirate Band|Pirate Band]]
		- [[#Pirate Band#Skill and Defense Bonuses- **Espionage:** +1|Skill and Defense Bonuses- **Espionage:** +1]]
	- [[#Mercantile Guild#Domain Power|Domain Power]]
	- [[#Mercantile Guild#Domain Features|Domain Features]]
	- [[#Mercantile Guild#Trade Guild|Trade Guild]]
		- [[#Trade Guild#Skill and Defense Bonuses- **Diplomacy:** +1|Skill and Defense Bonuses- **Diplomacy:** +1]]
	- [[#Mercantile Guild#Domain Power|Domain Power]]
	- [[#Mercantile Guild#Domain Features|Domain Features]]
- [[#Mystic Circle|Mystic Circle]]
	- [[#Mystic Circle#Domain Titles|Domain Titles]]
	- [[#Mystic Circle#Domain Power|Domain Power]]
	- [[#Mystic Circle#Domain Features|Domain Features]]
	- [[#Mystic Circle#Specialization|Specialization]]
	- [[#Mystic Circle#Arcane Order|Arcane Order]]
		- [[#Arcane Order#Skill and Defense Bonuses- **Lore:** +1|Skill and Defense Bonuses- **Lore:** +1]]
	- [[#Mystic Circle#Domain Power|Domain Power]]
	- [[#Mystic Circle#Domain Features|Domain Features]]
	- [[#Mystic Circle#Secret Cabal|Secret Cabal]]
		- [[#Secret Cabal#Skill and Defense Bonuses- **Espionage:** +1|Skill and Defense Bonuses- **Espionage:** +1]]
	- [[#Mystic Circle#Domain Power|Domain Power]]
	- [[#Mystic Circle#Domain Features|Domain Features]]
	- [[#Mystic Circle#Theatrical Troupe|Theatrical Troupe]]
		- [[#Theatrical Troupe#Skill and Defense Bonuses- **Diplomacy:** +1|Skill and Defense Bonuses- **Diplomacy:** +1]]
	- [[#Mystic Circle#Domain Power|Domain Power]]
	- [[#Mystic Circle#Domain Features|Domain Features]]
- [[#Nature Pact|Nature Pact]]
	- [[#Nature Pact#Domain Titles|Domain Titles]]
	- [[#Nature Pact#Domain Power|Domain Power]]
	- [[#Nature Pact#Domain Features|Domain Features]]
	- [[#Nature Pact#Spcialization|Spcialization]]
	- [[#Nature Pact#Barbarian Tribe|Barbarian Tribe]]
		- [[#Barbarian Tribe#Skill and Defense Bonuses- **Operations:** +1|Skill and Defense Bonuses- **Operations:** +1]]
	- [[#Nature Pact#Domain Power|Domain Power]]
	- [[#Nature Pact#Domain Features|Domain Features]]
	- [[#Nature Pact#Druid Circle|Druid Circle]]
		- [[#Druid Circle#Skill and Defense Bonuses- **Espionage:** +1|Skill and Defense Bonuses- **Espionage:** +1]]
	- [[#Nature Pact#Domain Power|Domain Power]]
	- [[#Nature Pact#Domain Features|Domain Features]]
	- [[#Nature Pact#Hunter Conclave|Hunter Conclave]]
		- [[#Hunter Conclave#Skill and Defense Bonuses- **Diplomacy:** +1|Skill and Defense Bonuses- **Diplomacy:** +1]]
	- [[#Nature Pact#Domain Power|Domain Power]]
	- [[#Nature Pact#Domain Features|Domain Features]]
- [[#Noble Court|Noble Court]]
	- [[#Noble Court#Domain Titles|Domain Titles]]
	- [[#Noble Court#Domain Power|Domain Power]]
	- [[#Noble Court#Domain Features|Domain Features]]
	- [[#Noble Court#Specialization|Specialization]]
	- [[#Noble Court#Court of War|Court of War]]
		- [[#Court of War#Skill and Defense Bonuses- **Operations:** +1|Skill and Defense Bonuses- **Operations:** +1]]
	- [[#Noble Court#Domain Power|Domain Power]]
	- [[#Noble Court#Domain Features|Domain Features]]
	- [[#Noble Court#Political Administration|Political Administration]]
		- [[#Political Administration#Skill and Defense Bonuses- **Diplomacy:** +2|Skill and Defense Bonuses- **Diplomacy:** +2]]
	- [[#Noble Court#Domain Power|Domain Power]]
	- [[#Noble Court#Domain Features|Domain Features]]
	- [[#Noble Court#Regent State|Regent State]]
		- [[#Regent State#Skill and Defense Bonuses- **Resolve:** +1|Skill and Defense Bonuses- **Resolve:** +1]]
	- [[#Noble Court#Domain Power|Domain Power]]
	- [[#Noble Court#Domain Features|Domain Features]]
- [[#Religious Order|Religious Order]]
	- [[#Religious Order#Domain Titles|Domain Titles]]
	- [[#Religious Order#Domain Power|Domain Power]]
	- [[#Religious Order#Domain Features|Domain Features]]
	- [[#Religious Order#Specialization|Specialization]]
	- [[#Religious Order#Hidden Cult|Hidden Cult]]
		- [[#Hidden Cult#Skill and Defense Bonuses- **Espionage:** +1|Skill and Defense Bonuses- **Espionage:** +1]]
	- [[#Religious Order#Domain Power|Domain Power]]
	- [[#Religious Order#Domain Features|Domain Features]]
	- [[#Religious Order#Holy Church|Holy Church]]
		- [[#Holy Church#Skill and Defense Bonuses- **Diplomacy:** +1|Skill and Defense Bonuses- **Diplomacy:** +1]]
	- [[#Religious Order#Domain Power|Domain Power]]
	- [[#Religious Order#Domain Features|Domain Features]]
	- [[#Religious Order#Monastic Order|Monastic Order]]
		- [[#Monastic Order#Skill and Defense Bonuses- **Lore:** +1|Skill and Defense Bonuses- **Lore:** +1]]
	- [[#Religious Order#Domain Power|Domain Power]]
	- [[#Religious Order#Domain Features|Domain Features]]
- [[#Underworld Syndicate|Underworld Syndicate]]
	- [[#Underworld Syndicate#Domain Titles|Domain Titles]]
	- [[#Underworld Syndicate#Domain Power|Domain Power]]
	- [[#Underworld Syndicate#Domain Features|Domain Features]]
	- [[#Underworld Syndicate#Specialization|Specialization]]
	- [[#Underworld Syndicate#Assassins' College|Assassins' College]]
		- [[#Assassins' College#Skill and Defense Bonuses- **Espionage:** +1|Skill and Defense Bonuses- **Espionage:** +1]]
	- [[#Underworld Syndicate#Domain Power|Domain Power]]
	- [[#Underworld Syndicate#Domain Features|Domain Features]]
	- [[#Underworld Syndicate#Spy Network|Spy Network]]
		- [[#Spy Network#Skill and Defense Bonuses- **Diplomacy:** +1|Skill and Defense Bonuses- **Diplomacy:** +1]]
	- [[#Underworld Syndicate#Domain Power|Domain Power]]
	- [[#Underworld Syndicate#Domain Features|Domain Features]]
	- [[#Underworld Syndicate#Thieves' Guild|Thieves' Guild]]
		- [[#Thieves' Guild#Skill and Defense Bonuses- **Espionage:** +1|Skill and Defense Bonuses- **Espionage:** +1]]
	- [[#Underworld Syndicate#Domain Power|Domain Power]]
	- [[#Underworld Syndicate#Domain Features|Domain Features]]
- [[#NPC Realms|NPC Realms]]
- [[#Despotic Regime|Despotic Regime]]
	- [[#Despotic Regime#Domain Title|Domain Title]]
	- [[#Despotic Regime#Domain Powers|Domain Powers]]
	- [[#Despotic Regime#Domain Features|Domain Features]]
- [[#Draconic Empire|Draconic Empire]]
	- [[#Draconic Empire#Domain Title|Domain Title]]
	- [[#Draconic Empire#Domain Powers|Domain Powers]]
	- [[#Draconic Empire#Domain Features|Domain Features]]
- [[#Dwarven Thanedom|Dwarven Thanedom]]
	- [[#Dwarven Thanedom#Domain Title|Domain Title]]
	- [[#Dwarven Thanedom#Domain Powers|Domain Powers]]
	- [[#Dwarven Thanedom#Domain Features|Domain Features]]
- [[#Fey Court|Fey Court]]
	- [[#Fey Court#Domain Title|Domain Title]]
	- [[#Fey Court#Domain Powers|Domain Powers]]
	- [[#Fey Court#Domain Features|Domain Features]]
- [[#Giant Jarldom|Giant Jarldom]]
	- [[#Giant Jarldom#Domain Title|Domain Title]]
	- [[#Giant Jarldom#Domain Powers|Domain Powers]]
	- [[#Giant Jarldom#Domain Features|Domain Features]]
- [[#Gnomish Kingdom|Gnomish Kingdom]]
	- [[#Gnomish Kingdom#Domain Title|Domain Title]]
	- [[#Gnomish Kingdom#Domain Powers|Domain Powers]]
	- [[#Gnomish Kingdom#Domain Features|Domain Features]]
- [[#Goblinoid Coalition|Goblinoid Coalition]]
	- [[#Goblinoid Coalition#Domain Title|Domain Title]]
	- [[#Goblinoid Coalition#Domain Powers|Domain Powers]]
	- [[#Goblinoid Coalition#Domain Features|Domain Features]]
- [[#Hag Coven|Hag Coven]]
	- [[#Hag Coven#Domain Title|Domain Title]]
	- [[#Hag Coven#Domain Powers|Domain Powers]]
	- [[#Hag Coven#Domain Features|Domain Features]]
- [[#Infernal Echelon|Infernal Echelon]]
	- [[#Infernal Echelon#Domain Titles|Domain Titles]]
	- [[#Infernal Echelon#Domain Powers|Domain Powers]]
	- [[#Infernal Echelon#Domain Features|Domain Features]]
- [[#Medusean Tyranny|Medusean Tyranny]]
	- [[#Medusean Tyranny#Domain Title|Domain Title]]
	- [[#Medusean Tyranny#Domain Powers|Domain Powers]]
	- [[#Medusean Tyranny#Domain Features|Domain Features]]
- [[#Orc Clan|Orc Clan]]
	- [[#Orc Clan#Domain Title|Domain Title]]
	- [[#Orc Clan#Domain Powers|Domain Powers]]
	- [[#Orc Clan#Domain Features|Domain Features]]
- [[#Planar Invaders|Planar Invaders]]
	- [[#Planar Invaders#Domain Title|Domain Title]]
	- [[#Planar Invaders#Domain Powers|Domain Powers]]
	- [[#Planar Invaders#Domain Features|Domain Features]]
- [[#Reptilian Band|Reptilian Band]]
	- [[#Reptilian Band#Domain Title|Domain Title]]
	- [[#Reptilian Band#Domain Powers|Domain Powers]]
	- [[#Reptilian Band#Domain Features|Domain Features]]
- [[#Undead Dominion|Undead Dominion]]
	- [[#Undead Dominion#Domain Title|Domain Title]]
	- [[#Undead Dominion#Domain Powers|Domain Powers]]
	- [[#Undead Dominion#Domain Features|Domain Features]]
- [[#Undersea Colony|Undersea Colony]]
	- [[#Undersea Colony#Domain Title|Domain Title]]
	- [[#Undersea Colony#Domain Powers|Domain Powers]]
	- [[#Undersea Colony#Domain Features|Domain Features]]
- [[#World Below City-State|World Below City-State]]
	- [[#World Below City-State#Domain Title|Domain Title]]
	- [[#World Below City-State#Domain Powers|Domain Powers]]
	- [[#World Below City-State#Domain Features|Domain Features]]
- [[#Using These Rules|Using These Rules]]
	- [[#Using These Rules#We're Adventuring!|We're Adventuring!]]
	- [[#Using These Rules#Downtime Warfare|Downtime Warfare]]
	- [[#Using These Rules#Epic Finale|Epic Finale]]
	- [[#Using These Rules#Bringing the Siege|Bringing the Siege]]
	- [[#Using These Rules#Seizing the Initiative|Seizing the Initiative]]
	- [[#Using These Rules#Using the Grid|Using the Grid]]
	- [[#Using These Rules#Making Tests|Making Tests]]
	- [[#Using These Rules#Starting Small|Starting Small]]
	- [[#Using These Rules#Larger Battlefields|Larger Battlefields]]
		- [[#Larger Battlefields#Expanding the Battlefield|Expanding the Battlefield]]
	- [[#Using These Rules#Domain Armies|Domain Armies]]
	- [[#Using These Rules#Units|Units]]
	- [[#Using These Rules#Anatomy of a Unit|Anatomy of a Unit]]
		- [[#Anatomy of a Unit#Unit Experience Bonuses|Unit Experience Bonuses]]
		- [[#Anatomy of a Unit#Unit Equipment Bonuses|Unit Equipment Bonuses]]
	- [[#Using These Rules#Building an Army|Building an Army]]
	- [[#Using These Rules#Unit Ancestry|Unit Ancestry]]
	- [[#Using These Rules#Unit Types|Unit Types]]
	- [[#Using These Rules#Unit Command and Dependencies|Unit Command and Dependencies]]
	- [[#Using These Rules#Improving Units|Improving Units]]
	- [[#Using These Rules#Voluntarily Disbanding Units|Voluntarily Disbanding Units]]
	- [[#Using These Rules#Warfare Feats|Warfare Feats]]
	- [[#Using These Rules#The Battlefield|The Battlefield]]
	- [[#Using These Rules#Setup|Setup]]
	- [[#Using These Rules#Casualty Dice|Casualty Dice]]
	- [[#Using These Rules#Collapsing Ranks|Collapsing Ranks]]
	- [[#Using These Rules#Deployment|Deployment]]
	- [[#Using These Rules#Stacking Units|Stacking Units]]
	- [[#Using These Rules#Activation|Activation]]
	- [[#Using These Rules#Attacking|Attacking]]
	- [[#Using These Rules#Movement|Movement]]
	- [[#Using These Rules#Bonus Movement|Bonus Movement]]
	- [[#Using These Rules#Actions, Reactions, and Bonus Actions|Actions, Reactions, and Bonus Actions]]
	- [[#Using These Rules#Resolving Multiple Reactions|Resolving Multiple Reactions]]
	- [[#Using These Rules#Exposed|Exposed]]
	- [[#Using These Rules#"Forward" and "Back"|"Forward" and "Back"]]
	- [[#Using These Rules#"Opposite"|"Opposite"]]
	- [[#Using These Rules#Morale Tests|Morale Tests]]
	- [[#Using These Rules#Tokens|Tokens]]
	- [[#Using These Rules#Diminished, Broken, and Disbanded|Diminished, Broken, and Disbanded]]
	- [[#Using These Rules#Defeat|Defeat]]
	- [[#Using These Rules#After the Battle|After the Battle]]
	- [[#Using These Rules#Ongoing Effects|Ongoing Effects]]
- [[#General Maneuvers|General Maneuvers]]
- [[#General Maneuvers#Feint|Feint]]
- [[#General Maneuvers#Find Cover|Find Cover]]
- [[#General Maneuvers#Follow Up|Follow Up]]
- [[#General Maneuvers#Mobility Trap|Mobility Trap]]
- [[#General Maneuvers#Rage Charge|Rage Charge]]
- [[#General Maneuvers#Rally|Rally]]
- [[#General Maneuvers#Retreat|Retreat]]
- [[#General Maneuvers#Set for Charge|Set for Charge]]
- [[#General Maneuvers#Strafe|Strafe]]
- [[#General Maneuvers#Volley|Volley]]
- [[#General Maneuvers#Withdraw|Withdraw]]
- [[#Martial Advantages|Martial Advantages]]
- [[#Martial Advantages#Battle Magic|Battle Magic]]
- [[#Martial Advantages#Barbarian Martial Advantages|Barbarian Martial Advantages]]
- [[#Martial Advantages#Bard Martial Advantages|Bard Martial Advantages]]
- [[#Martial Advantages#Cleric Martial Advantages|Cleric Martial Advantages]]
- [[#Martial Advantages#Druid Martial Advantages|Druid Martial Advantages]]
- [[#Martial Advantages#Fighter Martial Advantages|Fighter Martial Advantages]]
- [[#Martial Advantages#Illrigger Martial Advantages|Illrigger Martial Advantages]]
- [[#Martial Advantages#Monk Martial Advantages|Monk Martial Advantages]]
- [[#Martial Advantages#Paladin Martial Advantages|Paladin Martial Advantages]]
- [[#Martial Advantages#Ranger Martial Advantages|Ranger Martial Advantages]]
- [[#Martial Advantages#Rogue Martial Advantages|Rogue Martial Advantages]]
- [[#Martial Advantages#Sorcerer Martial Advantages|Sorcerer Martial Advantages]]
- [[#Martial Advantages#Warlock Martial Advantages|Warlock Martial Advantages]]
- [[#Martial Advantages#Wizard Martial Advantages|Wizard Martial Advantages]]
- [[#Opposing Commanders|Opposing Commanders]]
- [[#Opposing Commanders#Martial Advantages for Opposed Commanders|Martial Advantages for Opposed Commanders]]
	- [[#Martial Advantages for Opposed Commanders#Spellcasting Commander|Spellcasting Commander]]
	- [[#Martial Advantages for Opposed Commanders#Knight Commander|Knight Commander]]
	- [[#Martial Advantages for Opposed Commanders#Assassin Commander|Assassin Commander]]
	- [[#Martial Advantages for Opposed Commanders#Choosing Commander Roles|Choosing Commander Roles]]
	- [[#Martial Advantages for Opposed Commanders#Expanding Martial Advantages|Expanding Martial Advantages]]
- [[#Fortifications|Fortifications]]
		- [[#Expanding Martial Advantages#Basic Fortifications|Basic Fortifications]]
- [[#Fortifications#Moving|Moving]]
- [[#Fortifications#Damaging a Fortification|Damaging a Fortification]]
- [[#Fortifications#Contested Fortifications|Contested Fortifications]]
- [[#Fortifications#Hit Points and Siege Weapons|Hit Points and Siege Weapons]]
- [[#Fortifications#Placement|Placement]]
- [[#Fortifications#Types of Fortifications|Types of Fortifications]]
	- [[#Types of Fortifications#Stone Fence|Stone Fence]]
	- [[#Types of Fortifications#Guard Tower|Guard Tower]]
	- [[#Types of Fortifications#Town Walls|Town Walls]]
	- [[#Types of Fortifications#City Gates|City Gates]]
	- [[#Types of Fortifications#Keep|Keep]]
	- [[#Types of Fortifications#Castle|Castle]]
- [[#Terrain|Terrain]]
- [[#Terrain#Fog|Fog]]
...
- [[#Scenarios|Scenarios]]
- [[#Scenarios#Bridge|Bridge]]
- [[#Scenarios#Defend the Pass|Defend the Pass]]
- [[#Scenarios#Charge the Hill|Charge the Hill]]
- [[#Scenarios#Commanders on the Field|Commanders on the Field]]
	- [[#Commanders on the Field#Single Combat|Single Combat]]
- [[#Scenarios#Battle of Three Armies|Battle of Three Armies]]
- [[#Unit Traits|Unit Traits]]
- [[#Unit Traits#Recharge|Recharge]]
- [[#Unit Traits#Legal Target|Legal Target]]
- [[#Unit Traits#Unit Trait Descriptions|Unit Trait Descriptions]]
- [[#Ancestral Units|Ancestral Units]]
- [[#Ancestral Units#Units, Not Characters|Units, Not Characters]]
- [[#Ancestral Units#Humans|Humans]]
- [[#Ancestral Units#Elves|Elves]]
- [[#Ancestral Units#Dwarves|Dwarves]]
- [[#Ancestral Units#Orcs|Orcs]]
	- [[#Orcs#Proxying Other Steeds|Proxying Other Steeds]]
- [[#Ancestral Units#Goblinoids|Goblinoids]]
- [[#Ancestral Units#Undead|Undead]]
- [[#The Special Unit Deck|The Special Unit Deck]]
- [[#For the GM: Building the Villain's Army|For the GM: Building the Villain's Army]]
- [[#For the GM: Building the Villain's Army#When Should a Monster Be a Unit?|When Should a Monster Be a Unit?]]
- [[#For the GM: Building the Villain's Army#Reinforcements: The Secret Weapon|Reinforcements: The Secret Weapon]]
- [[#Monsters|Monsters]]
- [[#Action-Oriented|Action-Oriented]]
- [[#Action-Oriented#Villain Actions|Villain Actions]]
- [[#Court of Decay|Court of Decay]]
- [[#Court of Decay#Zaar Anathema, the Shackled King, the King in Gold|Zaar Anathema, the Shackled King, the King in Gold]]
- [[#Court of Decay#Khorak, Jarl of Drengrheim|Khorak, Jarl of Drengrheim]]
- [[#Court of Decay#Telcezalco XXVIII, the Blood River|Telcezalco XXVIII, the Blood River]]
- [[#Court of Decay#Máelodor Rhyllearnán, King of the Foxglove Court|Máelodor Rhyllearnán, King of the Foxglove Court]]
- [[#Court of Decay#Tristan Vaslor, the King Below|Tristan Vaslor, the King Below]]
- [[#Court of Decay#Khorsekef the Infinite|Khorsekef the Infinite]]
- [[#Court of the Deep|Court of the Deep]]
- [[#Court of the Deep#Devourers of Souls|Devourers of Souls]]
		- [[#Proxying Other Steeds#Soul Dice|Soul Dice]]
	- [[#Devourers of Souls#Soul-Fueled Power|Soul-Fueled Power]]
	- [[#Devourers of Souls#Soulsight|Soulsight]]
	- [[#Devourers of Souls#Lethe|Lethe]]
- [[#Court of the Deep#Groyle Fleshender|Groyle Fleshender]]
- [[#Court of the Deep#Hara'antar the Soulthief|Hara'antar the Soulthief]]
- [[#Court of the Deep#Zor'yal Lifeswallower|Zor'yal Lifeswallower]]
- [[#Court of the Deep#Vorg'aut Harrowfist, the Lady Blight|Vorg'aut Harrowfist, the Lady Blight]]
- [[#Court of the Deep#Trall the Mindbreaker|Trall the Mindbreaker]]
- [[#Court of the Deep#Sylt Bloodheat|Sylt Bloodheat]]
- [[#Court of Seven Cities|Court of Seven Cities]]
- [[#Court of Seven Cities#True Names|True Names]]
- [[#Court of Seven Cities#Hate Devil|Hate Devil]]
	- [[#Hate Devil#Rakat, Baron of Styx|Rakat, Baron of Styx]]
- [[#Court of Seven Cities#Stone Devil|Stone Devil]]
	- [[#Stone Devil#Moranon, Marquis of Acheron|Moranon, Marquis of Acheron]]
- [[#Court of Seven Cities#Steel Devil|Steel Devil]]
	- [[#Steel Devil#Sryz, Count of Naraka|Sryz, Count of Naraka]]
- [[#Court of Seven Cities#Lore Devil|Lore Devil]]
	- [[#Lore Devil#Indix, Earl of Sheol|Indix, Earl of Sheol]]
- [[#Court of Seven Cities#Fang Devil|Fang Devil]]
	- [[#Fang Devil#Horat, Duke of Kasyrgan|Horat, Duke of Kasyrgan]]
- [[#Court of Seven Cities#Eye Devil|Eye Devil]]
	- [[#Eye Devil#Pharyon, Prince of Dis|Pharyon, Prince of Dis]]
- [[#Gemstone Dragons|Gemstone Dragons]]
- [[#Gemstone Dragons#Psionics|Psionics]]
	- [[#Psionics#Manifestations|Manifestations]]
	- [[#Psionics#Auras|Auras]]
	- [[#Psionics#Crystal Hide|Crystal Hide]]
	- [[#Psionics#Sympathetic Vibrations|Sympathetic Vibrations]]
	- [[#Psionics#Mindspeech|Mindspeech]]
	- [[#Psionics#Matrix Mind|Matrix Mind]]
- [[#Gemstone Dragons#Trudy|Trudy]]
- [[#Gemstone Dragons#Cthrion Uroniziir|Cthrion Uroniziir]]
- [[#Relg, the Descender, the Lord in Corpulect|Relg, the Descender, the Lord in Corpulect]]
- [[#Magic Items|Magic Items]]
- [[#New Codices|New Codices]]
- [[#Encountering a Codex|Encountering a Codex]]
- [[#Attuning to a Codex|Attuning to a Codex]]
- [[#Sacrifice|Sacrifice]]
- [[#New Codex Descriptions|New Codex Descriptions]]


# Foreword

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/NnQw1uo.jpg)
...
**Intrigue** is conflict between two domains. A holy church versus a mystic circle. The Knights Templar against a dragon tyrant. A bunch of disorganized misfit adventurers against a nation of undead!

A **domain** is a pretty simple thing as a game concept. It's got four skills. It uses actions and reactions and bonus actions, just like characters and monsters. It has three defenses, but no hit points. The only way to "kill" a domain is to neutralize its officers—although some might escape and start a new domain for the sequel campaign! A domain could be a kingdom, thieves' guild, or druid circle!
...
The book also contains a handful of new items that can affect intrigue or warfare. And because they were popular in *Strongholds & Followers*, you get some new legendary artifacts called the codices. (Warning! They will unravel the fabric of reality!)
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/lCfWQLx.jpg)

"We sell it back to them," Narco said. "Hang on... then what are you gonna put on your bolts?"

Aurex nodded her head in agreement. "Need I remind you," the half-devil assassin said, "before your mind of chemicals and formulae overheats from its own cleverness, it took our people three weeks to steal those vials of *dreamtime*. And they managed to get in, get it, and get out without anyone noticing. Those resources could have been put to better use if that drug doesn't end up on a bolt in Castagan."
...
"And get him to talk?" Aurex said. "Under *dreamtime*, he'll talk while he sleeps—and we'll know it's the truth."
...
"Blackmail, intel, drugs." Garrote nodded at the three vials of *dreamtime*. "Just a day's work for us, boss."

Zarek finally caught up. "Heh. This is good, you guys. Oh yeah, this is gonna be fun. This is real thieves' guild shit."

### Glossary of Terms

This section collects the terminology underlying the domains, intrigue, and warfare systems at the heart of the book. As you read the rules for the first time, you might want to refer back here to check unfamiliar terms—or to flip forward to the *Heroic Organizations* and *NPC Realms* sections, and to the *Warfare* chapter, to see how these terms play out in the rules.
...
**Defense Levels:** A number that represents the strength and effectiveness of a domain's Communications, Resolve, and Resources. During intrigue, a domain wants to increase their own defense levels and decrease those of the opposed domain. Defense levels don't modify defense scores.

**Defense Score:** A number that represents the security of a domain's Communications, Resolve, and Resources.
...
**Domain:** A group of characters or creatures working together to further some long-term goal. The term "domain" encompasses the leaders of the domain, the agents and followers who work for them, and the territory they influence.
...
**Muster:** To raise new warfare units for a domain.

**Officer:** One of the player characters or NPCs in charge of a domain.
...
**Party Sheet:** The record of an organization's stats, defenses, and features.
...
**Resolve:** One of a domain's three defenses, representing how committed a domain's followers are to the cause of the domain's leaders.
...
**Activation:** The act of selecting a unit, determining its movement and actions, and resolving them. A unit's activation in battle is effectively equivalent to a character's turn in combat.
...
**Aerial:** Units that can fly.

**Allied Units:** All units that are part of an army or are friendly to that army.

**Artillery:** Siege engines and archers.

**Attack:** The bonus to a d20 roll representing a unit's ability to successfully execute an attack order and engage an opposed unit. Opposed by Defense.

**Battle:** Conflict between two armies.

**Battle Magic:** Magic items crafted by officers and given to units in an army.
...
**Broken:** A broken unit is removed from the battlefield, usually because it suffered its last casualty. Broken units can be reformed by rallying.

**Casualty:** The higher a unit's casualties, the more damage it can take. Think of casualties as hit points for units.

**Casualty Die:** The die placed on each unit card that tracks how many casualties the unit has remaining. A unit's casualty die is initially equal to its size.
...
**Defenseless:** Lacking an army in a battle.

**Deployment:** The placing of units in legal spaces on the battlefield. Usually the first thing that happens in a battle.
...
**Inflict Casualties:** To damage a unit. If a unit inflicts 1 casualty on another unit, the target loses 1 casualty.
...
**Rank:** A row on the battlefield.

**Rear:** The last rank on the battlefield, whose units defend the center rank from enemy cavalry. Usually populated by levies. (Wish them luck!)

**Reserve:** A well-protected rank on the battlefield where units can be stacked until needed.
...
**Suffer Casualties:** When a unit takes damage, it suffers casualties. If a unit suffers 1 casualty, it loses 1 casualty.

**Tier:** A measure of how powerful a unit is. Higher-tier units are more effective in battle, and harder to muster.
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/epw5QYs.jpg)
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/8G5Rlk1.jpg)
...
A domain has four **skills**: Diplomacy, Espionage, Lore, and Operations, each of which has a modifier. A domain's officers use these skills during intrigue.

A domain has three **defenses**: Communications, Resolve, and Resources. Each defense has a numerical value that provides a target number for tests made with domain skills during an intrigue. Each defense also has a level that can be raised or lowered. Any domains can gain bonuses or take penalties during battle or combat based on their domain defense levels.
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/AYBHLdv.jpg)
...
As a setup for using the warfare rules, when the characters found an organization, the players immediately muster four Tier I units of their choice to start up their army, from any ancestry the GM agrees the organization has access to. Each unit must be controlled by an officer of the organization, and each officer can command a number of units equal to their proficiency bonus. (The *Warfare* chapter has more information on all these things.)
...
#### Using Domain Skills Outside of Intrigue
...
How long it takes to resolve a domain skill test outside of intrigue is also up to the GM. A good rule of thumb is one domain skill test per week, but this is entirely dependent on the timeframe of the game and the campaign. If you don't track the passage of time closely in your game, it might be easier to tie domain skill tests to major narrative events, such as the awarding of XP to characters, the end of a session, or even the end of a major encounter. (See *Time and Domain Turns* below for more guidance in this area.)
...
Spies from both domains monitor each other, so almost all actions a domain takes and the results of those actions are public knowledge. The exception is mustering units and using domain skills to improve a domain's stats (its domain skills and defenses). Enemies know when units are mustered or when a domain's stats are improved, but knowing which units a domain has or what the domain's current stats are requires a successful Espionage test. See **Domain Skills** on page 18 for more information.
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/iANndu2.jpg)
...
*Associated Character Skills: Insight, Persuasion*
...
***Gaining Special Units.*** As a domain action, a domain can make a Diplomacy test to petition an NPC realm for military aid for an upcoming battle. The DC depends on the attitude of the NPC realm, as noted on the following table.
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/tcxG4gQ.jpg)
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/cbMxAnC.jpg)

#### Operations

*Associated Character Skills: Athletics, Insight*
...
***Mustering Units.*** A domain's officer can use a domain action during intrigue to muster a new unit. The Operations skill covers this activity, though an Operations test is normally not required unless the GM feels there's a chance that the mustering might fail. This new unit belongs to the officer who mustered it. An officer can control a number of units equal to their proficiency bonus.
...
***Beyond Intrigue.*** The Operations domain skill covers many mundane activities outside of intrigue, including building roads or watchtowers, sending out a unit of scouts to explore the local wilderness, and so forth. Anything a domain might reasonably be able to do but which isn't covered by another domain skill can be accomplished using Operations.
...
**Zealous (3).** During any combat against officers of an opposed domain, each of this domain's officers has advantage on attack rolls until the end of their first turn.
...
**Low (−1).** Each of this domain's artillery units has disadvantage on Morale and Command tests until the end of the first round of battle.
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/PBkX8QB.jpg)
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/mxGfUs2.jpg)

### Heroic Organizations

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/dWxXH2c.jpg)
...
To Arms, Fellow Adventurers (Special Unit)
...
##### Skill and Defense Bonuses- **Operations:** +1
- **Resolve:** +1
...
##### Skill and Defense Bonuses- **Lore:** +2
...
![Adventuring party sheet](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/Sptzxht.jpg)

### Martial Regiment

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/fLgrqGT.jpg)
...
The Professionals (Special Unit)
...
##### Skill and Defense Bonuses- **Communications:** +1
- **Resources:** +1
...
They Will Not Breach This Wall
...
##### Skill and Defense Bonuses- **Diplomacy:** +1
- **Resolve:** +1
...
##### Skill and Defense Bonuses- **Espionage:** +1
- **Operations:** +1
...
The War Room Where It Happens

![Martial regiment party sheet](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/s3RGaYI.jpg)

### Mercantile Guild

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/KoH5m9O.jpg)
...
Soldiers of Fortune (Special Unit)
...
![Mercantile guild party sheet](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/orZacWg.jpg)

### Mystic Circle

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/vze6NP1.jpg)
...
Forgotten Rite of Animation (Special Unit)
...
##### Skill and Defense Bonuses- **Lore:** +1
- **Resources:** +1
...
Wards of Protection Against Missiles
...
![Mystic Circle party sheet](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/wFxP5KQ.jpg)

### Nature Pact

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/TGa1PlE.jpg)
...
![Nature Pact party sheet](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/H32Ct9Q.jpg)

### Noble Court

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/QaZyxjD.jpg)
...
Prepare the Steeds (Special Unit)
...
##### Skill and Defense Bonuses- **Diplomacy:** +2
...
##### Skill and Defense Bonuses- **Resolve:** +1
- **Resources:** +1
...
![Noble Court party sheet](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/MK4Lc2z.jpg)

### Religious Order

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/bFXj9c9.jpg)
...
Spread the Holy Word (Special Unit)
...
![Religious Order party sheet](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/qc1PLTr.jpg)

### Underworld Syndicate

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/vBycJFQ.jpg)
...
They're Going to Have a Hard Time Making Payroll This Week

![Underworld Syndicate party sheet](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/NXf1vGW.jpg)

### NPC Realms

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/HlxdCwF.jpg)
...
The Crimson Guard (Special Unit)

Work the Prisoners to the Bone
...
Furnishings of the Hoard

Praetores Draconis (Special Unit)

### Dwarven Thanedom

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/kXusLtz.jpg)
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/Ba0Fltp.jpg)
...
There Are Giants in the Sky (Special Unit)

### Gnomish Kingdom

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/SkzUtgz.jpg)
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/vktB8Vt.jpg)
...
The Red Howl (Special Unit)

### Hag Coven

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/FKbN8Eq.jpg)
...
Summon the Pale Riders (Special Unit)

### Medusean Tyranny

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/KFKz7ZQ.jpg)
...
Tales of Clan Heroes Past

The Unbreakable (Special Unit)
...
Recall the Fleet (Special Unit)

Spatial Anchor

We Will Take What We Need from Your Mind...Directly

### Reptilian Band

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/HW4GKa8.jpg)
...
Prehistoric Wrath (Special Unit)
...
Mass Animate Dead (Special Unit)
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/NYlPVj6.jpg)
...
Salt Golems (Special Unit)

### World Below City-State

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/60p6l9V.jpg)
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/Q2U9E6J.jpg)
...
**Morale (MOR)** measures a unit's ability to maintain discipline in the face of overwhelming odds, powerful magic, exotic enemies, and death. Failing a Morale test inflicts casualties just as Attack tests and Power tests can, since a soldier who is terrified and flees is just as ineffective as a dead soldier. Morale is improved by experience.

**Command (COM)** is a unit's ability to correctly interpret complex orders and execute them successfully. Command is improved by experience.
...
**Movement** is another of a unit's battle statistics, but does not appear on the card because all units have a movement of 1.

***Casualties.*** During warfare, the number of casualties a unit can suffer but still keep on fighting is represented by the **casualty die**. A casualty die is based on a unit's size, and is placed on the unit card during battle with the number of casualties the unit has remaining facing up. For example, a size 6 unit would begin with a d6 casualty die, with the 6 facing up.
...
***Type.*** A unit's type is represented by a weapon symbol. Type determines what a unit can do in battle, who it can attack, and who it can be attacked by. There are four types of basic unit: infantry, artillery (including siege weapons), cavalry, and aerial. For the purpose of improving experience and equipment (see below), cavalry and aerial units use the same tables.

| Type              |                                           Symbol                                           | Type            |                                           Symbol                                           |   |
|-------------------|:------------------------------------------------------------------------------------------:|-----------------|:------------------------------------------------------------------------------------------:|---|
| Aerial            | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/9YFLBe6.png) | Cavalry         | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/CGQScAa.png) |   |
| Artillery         | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/HjXkiVE.png) | Infantry        | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/Pd42pUG.png) |   |
| Artillery (Siege) | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/HtJQVSh.png) | Infantry (Levy) | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/ll2Gsva.png) |   |

***Experience.*** Experience is a combination of how much training a unit has and how much fighting it's seen. More experienced units gain bonuses to Attack, Defense, Morale, and Command, as well as additional attacks, as indicated on the Unit Experience Bonuses table. But different types of units learn different lessons in battle.

Units gain experience by surviving battles, according to how experienced they already are (see *Improving Units* on page 104). Each section of the table starts with the lowest level of experience at the top, with each subsequent level below indicating the next improvement.
...
***Ancestry.*** Ancestry affects all of a unit's stats, and in many ways is the defining attribute of a unit. Ancestry also determines what traits a unit has.

| Ancestry   |                                           Symbol                                           | Ancestry   |                                           Symbol                                           |   |
|------------|:------------------------------------------------------------------------------------------:|------------|:------------------------------------------------------------------------------------------:|---|
| Dragonborn | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/aHzlxGK.png) | Human      | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/F5vLaiq.png) |   |
| Dwarf      | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/KDWZq6n.png) | Kobold     | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/PBE9xaI.png) |   |
| Elf        | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/0yhTq0c.png) | Lizardfolk | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/oicKWo9.png) |   |
| Fiend      | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/zbfv7a0.png) | Monstrous  | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/J88CmDC.png) |   |
| Giant      | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/dUd2twT.png) | Orc        | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/Bl5BaL2.png) |   |
| Gnoll      | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/wYDAEIW.png) | Special    | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/j7ImXrY.png) |   |
| Gnome      | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/raAuy64.png) | Undead     | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/GX2yltr.png) |   |
| Goblinoid  | ![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/RvqC5fX.png) |            |                                                                                            |   |
...
***Tier.*** A unit's tier, represented by a Roman numeral on its card, is a measure of the unit's overall power or nastiness. Tier I units are the least powerful (and thus the easiest to put onto the battlefield), while Tier V units are the most powerful.
...
***Traits.*** Each unit also has a collection of traits—maneuvers or special features that it can employ in battle. The names of each unit's traits are listed on its unit card, keying to the descriptions in the *Unit Traits* section on page 126 in this chapter. This keeps the unit cards small and useful in battle, and means players don't have to constantly pick each card up to read what its traits can do in the middle of a battle.
...
There are four types of units—infantry, artillery, cavalry, and aerial. Each has different base stats, and because of the rules governing which units can attack other units (see **Attacking**) and the rules for deployment, each has a specific role to play in warfare.

***Infantry Units.*** Infantry are the meat-and-potatoes troops for any domain. They are not as flashy as artillery or cavalry, but they are harder to kill, having higher Toughness than other units of the same tier and ancestry. Infantry are often used to protect artillery units.
...
***Artillery Units.*** Artillery units include both archers and siege engines. Mostly archers.
...
***Cavalry Units.*** Cavalry units move fast and hit hard. They are so mobile that they belong to no specific rank, ranging across the battlefield to attack other cavalry, and pick off those infantry and artillery units foolish enough to leave themselves exposed.
...
***Unit Command.*** An officer can command a number of units equal to their proficiency bonus. Every unit a domain fields—both regular units and special units, no matter how those units are gained—must have a commander.
...
***Unit Dependencies.*** Each unit's tier represents not only its power level relative to other units. It represents the relationship wherein higher-tier units require many lower-tier units to support them, as follows:
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/emHcVmb.png)
...
***Improving Experience.*** The only way to improve a unit's experience is through battle, as follows:
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/iDCQQ7B.png)
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/sFbyR5P.png)
...
As a unit suffers casualties, its casualty die is **decremented**. This means the number on the die is decreased by 1, so that a 6 becomes a 5, a 5 becomes a 4, and so forth. Under certain circumstances, the die is **incremented**—increased by 1—to indicate that a unit's battle readiness is being restored. A unit that has its casualty die decremented from 1, indicating that it has lost its last casualty, is **broken** and removed from the field.
...
- **Artillery and aerial units** can attack any unit.
- **Cavalry units** can attack other cavalry units, and any infantry or artillery units that are exposed (see **Unit Conditions** on page 107).
...
>
>**Disoriented.** A disoriented unit can either take an action or move, but not both. Unless otherwise stated, this unit condition lasts until the end of the unit's next activation.
>
>**Exposed.** A unit is exposed if there are no units between it and the leftmost or rightmost battlefield edge, or if there are no units in any rank to the rear of the unit. Units in the center and reserve of an army's ranks cannot be exposed as long as that army has its own units in both its rear rank and anywhere in its front. (See **Exposed** below for more information.)
>
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/XCigfAV.png)
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/qdz41T7.png)
...
At the end of each round of battle, after all officers on both sides have activated all their units, each side determines the current **point value** of their army. This total is based on the tier of each unit in the army, with Tier I units (including levies) worth 1 point, Tier II units worth 2, Tier III units worth 3, and so on.

At the end of any round, if one side has **more than twice the point value** of the other, that side has won the battle. Each commander on the losing side must immediately attempt the Retreat maneuver for each of their units (see **General Maneuvers** below).
...
*Prerequisite: Rogue martial advantage*
...
*Prerequisite: Ranger martial advantage*
...
*Prerequisite: Barbarian or monk martial advanage*
...
*Prerequisite: Barbarian martial advantage*
...
*Prerequisite: Fighter martial advantage*
...
*Prerequisite: Artillery or infantry*
...
**Furious Assault.** Each light infantry unit this commander controls has +1 to movement and inflicts 1 additional casualty on a successful Attack test.
...
**Song of Battles Won.** An opposed unit has disadvantage on Attack tests against any unit this commander controls if that defending unit has fewer casualties than the attacker.
...
**Divine Rally.** At the beginning of this commander's turn, a broken unit the commander controls that has not already been rallied can make a DC 13 Morale test. On a success, it gains 1d4 casualties and is returned to the battlefield according to normal deployment rules. Additionally, the unit has +2 to Defense and Toughness until the end of the battle.
**Wand of Healing.** As an action, the unit with this wand chooses any unit. The target unit's casualty die is incremented by 2.
...
**Nature's Boon.** Each unit this commander controls has +2 to size, to a maximum of size 12. This bonus is only active while this commander controls the unit.
...
**Bark and Root.** Each infantry and artillery unit this commander controls has +2 to Toughness. Additionally, each time any unit this commander controls ends its activation, roll a d4. On a 4, that unit's casualty die is incremented by 1.
...
**Volley.** Each artillery and cavalry unit this commander controls has the *Volley* maneuver (page 110).
...
### Illrigger Martial Advantages

The illrigger is a fighting hellknight whose soldiers call upon fell powers to terrify their enemies. (A PDF containing the Illrigger class is available on the MCDM store at [https://shop.mcdmproductions.com/products/illrigger-class](shop.mcdmproductions.com).)
...
**Death Commandos.** When any infantry unit this commander controls succeeds on a Power test as part of an attack, the target unit must succeed on a DC 13 Morale test or suffer 1 additional casualty.
...
**Scroll of Hellfire.** As an action, the unit with this scroll chooses a target unit, which must make a Power test (DC = 13 + DS). The unit gains 4 fire tokens on a failure, or 2 fire tokens on a success. Each fire token inflicts 1 casualty.
**Execution.** As an action, a unit controlled by this commander chooses an allied unit with 1 casualty. That unit disbands, and one unit this commander controls has advantage on Attack tests and Power tests until the end of the battle.
...
**Hidden Reserves.** A reaction to breaking, an artillery or infantry unit this commander controls can roll a d4. The unit does not break, and remains in its space with casualties equal to the result of the roll. Each unit can use this martial advantage once per battle.
...
**Righteous.** When any unit this commander controls succeeds on a Morale test, it can use a reaction to gain advantage on its next Attack test. Additionally, any opposed unit diminished by a unit this commander controls has disadvantage on the Morale test.
...
**Archery Training.** Each artillery unit this commander controls has advantage on Power tests.
...
**Rough Terrain Training.** Any unit this commander controls cannot become disorganized. Additionally, each unit this commander controls ignores terrain penalties, and has +1 to movement in normal terrain.
...
**Scroll of Translocation.** As an action, the unit with this scroll chooses a unit in any rank and moves it into any empty space on the battlefield. If this unit is an opposed unit, it can succeed on a Power test (DC = 11 + DS) to avoid being moved.
...
**Sorcerous Training.** As an action, the unit with this scroll chooses a rank on the battlefield. Each unit in that rank must succeed on a Power test (DC = 13 + DS) or suffer 2 casualties and become disorganized.

### Warlock Martial Advantages
...
**Flaming Hooves.** Whenever a cavalry unit this commander controls succeeds on a Power test made as part of an attack, add a fire token to the unit targeted by the test. The fire token inflicts 1 casualty.
...
**Arrows of Dancing Lights.** When any artillery unit this commander controls succeeds on an Attack test against an opposed unit, each allied unit attacking that opposed unit has advantage on Attack tests until the end of the opposed unit's next activation.
...
### Martial Advantages for Opposed Commanders
...
**Death Commandos.** When any infantry unit this commander controls succeeds on a Power test as part of an attack, that target unit must succeed on a DC 13 Morale test or suffer 1 additional casualty.
**Heavy Training.** Each medium, heavy, and super-heavy infantry unit this commander controls inflicts 1 additional casualty on a successful Power test.
**Cavaliers.** Each cavalry unit this commander controls has advantage on Attack tests and +1 to damage.
...
* All allied units in the battle** All allied units in the fortification*** Artillery units in the fortification
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/c28E59F.png)
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/DOx2dYZ.png)

#### Town Walls

This larger version of the stone fence offers protection for even more units.

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/AtHIyMx.png)
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/1kBxyzw.png)
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/31AHFUa.png)
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/QQoP344.png)
...
![Bridge scenario battlefield](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/zVQMUhz.png)

*Converter's Note: Same issue here as with the fortifications, this one just isn't as intrusive so I left it alone.*

![Defend the Pass scenario battlefield](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/lVJ4XEX.png)

![Battle of Three Armies scenario battlefield](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/Fd5wX6y.png)
...
**Consume.** As an action, this unit targets an opposed unit with lower casualties than it that it can attack. The target must succeed on a DC 15 Power test or break. Recharge 5–6.
...
**Corrosive Breath.** As an action, choose three adjacent opposed units. Each unit must succeed on a Power test (DC = 8 + this unit's size) or suffer 2 casualties and gain one acid token. The acid token inflicts 1 casualty. Recharge 5–6.
**Create Dead.** If this unit causes an opposed unit to break, replace that unit with a Ghoul Infantry unit under the command of this unit's commander. The new unit can act on the commander's next turn.
...
**Fire Breath.** As an action, this unit forces three adjacent opposed units to each make a Power test (DC = 8 + this unit's size). On a failure, a unit suffers 2 casualties and gains a fire token. The fire token inflicts 1 casualty. Recharge 5–6.
**Fire Immunity.** This unit does not suffer casualties from traits or other effects with "burning," "fire," or "flame" in their names, or from fire tokens.
**Flaming Weapons.** When this unit makes a successful Power test as part of an attack, it adds a fire token to the target in addition to the normal effects of the test. The fire token inflicts 1 casualty.
...
**Into the Breach.** When this unit successfully executes the Follow Up maneuver, it has +2 bonus to Defense until the beginning of its next activation.
...
**Maneuver: "Fire!!"** As a reaction to a successful Power test made against a target unit, add a fire token to the target. The fire token inflicts 1 casualty. Recharge 4–6.
...
**Maneuver: "Land and Charge!"** While this unit has the aerial type, it can use a bonus action to make a DC 11 Command test. On a success, this unit's Power tests have +2 damage on this activation, but the unit's type becomes cavalry. At the end of its next activation, the unit regains the aerial type. Recharge 4–6.
...
**Noxious Fog.** As an action, this unit places two poison tokens in each of 4 adjacent spaces. Any unit that moves into a space with one or more of these poison tokens or that activates there suffers 1 casualty per token. Each space loses one poison token at the end of this unit's subsequent activations. Recharge 5–6.
**Pack Tactics.** When an adjacent unit that also has this trait successfully uses the Follow Up maneuver (page 109), this unit can move into any empty space adjacent to this unit's current position.
**Pike Training.** This unit automatically succeeds on Command test for the Set for Charge manuever.
...
**Pool of Soul's Blood.** Any opposed infantryor artillery unit adjacent to this unit cannot leave its space.
...
**Ram Riders.** When this unit succeeds on a Power test as part of an attack, the target unit must succeed on a followup DC 10 Power test or become dioriented until the end of its next activation.
...
**Spike Shot.** As an action, this unit forces a target unit to succeed on a DC 12 Power test or suffer 2 casualties and become weakened. An affected unit can repeat this power test at the end of each of its activations to lose the weakened unit condition. Recharge 5–6.
**Split.** When this unit is diminished, place an identical unit with the same current battle statistics and casualties in an empty adjacent space.
...
**Strength in Numbers.** This unit begins the battle with 1 additional casualty for each other undead unit in its army (up to a maximum of 12 casualties).
...
**To the Death.** If this unit breaks as a result of an opposed infantry, cavalry, or aerial unit's Attack or Power test, the attacking unit suffers 1 casualty.
...
![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/J5aNqHs.png)

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/Qd1CEDX.png)

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/fIqiUrL.png)

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/75M50MH.png)

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/fQMrxzz.png)

![](https://raw.githubusercontent.com/TheGiddyLimit/homebrew-img/main/img/KaW/aHAPY0j.png)
...
- Once an opposing side's front is broken, the attacking side's units can move around more. This opens up many different strategies, and lets cavalry and artillery units become more flexible.
...
### When Should a Monster Be a Unit?
...
### Reinforcements: The Secret Weapon
...
The Court of Decay and the Court of the Deep maintain a taut, uneasy truce. The Deathless have no souls, so they yield no power to the demons of the depths. But they do not fall into *lethe* (page 165) and therefore pose a constant threat.
...
And gripped tightly in his hand, exhumed from the depths of the earth, was the *Tellac Oranic*, a stone that radiated death and turned the living into shadows.
...
*"Men will be the end of this world.*— Máelodor RhyllearnánLong before the first empire of man, Máelodor Rhyllearnán watched the Gol spread across the land. Where once only elves, dwarves, and dragons lived, now a fourth mortal people walked among them.
...
Unique among monsters, demons of the Court of the Deep feast not upon food and water, but upon **souls**. Souls fuel their bloodthirsty powers; while starved for souls, a demon can scarcely even think.
...
- It can't cast spells.
- On its turn, the demon automatically moves toward the nearest creature it can see with its soulsight, regardless of the terrain in its way. If the demon is still able to take an action that turn, it uses its action to attack that creature (or any obstacle in its way).
...
Lord Indix is composed of the burning pages of the once-powerful *codex mutabilis*, the Book of Change. When the arcane tome was thrown into the caldera of Mount Vor, the book was incinerated, and deep within Sheol, the City of Death, Lord Indix was created.
...
Pharyon carries the *Omega Toll*, the Bell of Light's End. When it sounds its thunderous knell, the old epoch ends. What comes after...even Prince Pharyon can't see.
...
Though manifestations may seem like magic, they are an entirely different discipline and power. Spells such as *antimagic field* and *dispel magic* have no effect on psionic manifestations.
...
*Ad infinitum, quod erat demonstrandum!*

**Trudy**

### Cthrion Uroniziir

Known to the elves as the Würm of the World's End, Cthrion Uroniziir, Lord of the Neutral Evil Dragons rises from her slumber to collapse the myriad manifolds of the timescape into one partition. If she succeeds, worlds will be annihilated. Collapsed together into one singular *universe*.
...
- *Coat of the Crimson Guard*
- *Counterpoint*
- *Fate's Needle*
- *Grandmaster's Quiver*
- *Helmet of Dual Fates*
- *Heroic Soul's Chasuble*
- *Maethelgas*
- *Omega Toll*
- *Staff of Providence*
- *Tellac Oranic*
...
The new codices are presented in alphabetical order. If you like these magic items, you can find more in *Strongholds & Followers*.
