...
"actions":
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 12 (3d6 + 2) Acid damage."
    "name": "Pseudopod"
"reactions":
  - "desc": "Trigger: While the jelly is Large or Medium and has 10+ [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md),\
      ...
      \ jelly and acts on its [Initiative](Sonstige/z_Content%20and%20Rules/variant-rules/initiative-xphb.md).\
      \ The original jelly's [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
      \ are divided evenly between the new jellies (round down)."
    "name": "Split"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/ooze/token/ochre-jelly-xmm.webp"
```
^statblock
