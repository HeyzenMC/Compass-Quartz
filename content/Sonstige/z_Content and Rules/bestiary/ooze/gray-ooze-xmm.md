...
"traits":
  ...
  - "desc": "Nonmagical ammunition is destroyed immediately after hitting the ooze\
      ...
      \ can be removed by casting the [Mending](Sonstige/z_Content%20and%20Rules/spells/mending-xphb.md)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/ooze/token/gray-ooze-xmm.webp"
```
^statblock
