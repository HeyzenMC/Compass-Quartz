...
"traits":
  - "desc": "The cube fills its entire space and is transparent. Other creatures can\
      ...
      \ and has [Disadvantage](Sonstige/z_Content%20and%20Rules/variant-rules/disadvantage-xphb.md)\
      \ on the saving throw.\n\nCreatures inside the cube have [Total Cover](Sonstige/z_Content%20and%20Rules/variant-rules/cover-xphb.md),\
      ...
      \ 12 Strength ([Athletics](Sonstige/z_Content%20and%20Rules/skills.md#Athletics))\
      \ check, and the puller takes 10 (3d6) Acid damage."
    "name": "Ooze Cube"
  - "desc": "Even when the cube is in plain sight, a creature must succeed on a DC\
      \ 15 Wisdom ([Perception](Sonstige/z_Content%20and%20Rules/skills.md#Perception))\
...
"actions":
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 12 (3d6 + 2) Acid damage."
    "name": "Pseudopod"
  - "desc": "The cube moves up to its [Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md)\
      ...
      \ room inside itself to contain them (see the Ooze [Cube](Sonstige/z_Content%20and%20Rules/variant-rules/cube-area-of-effect-xphb.md)\
      ...
      \ spells with a Verbal component, has the [Restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained)\
      ...
      \ target can try to escape by taking an action to make a DC 12 Strength ([Athletics](Sonstige/z_Content%20and%20Rules/skills.md#Athletics))\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/ooze/token/gelatinous-cube-xmm.webp"
```
^statblock
