...
- "Vegepygmy"
---
# [Vegepygmy](Sonstige/z_Content%20and%20Rules/bestiary/plant/vegepygmy-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 252, Volo's Guide to Monsters p. 196*  

Typical vegepygmies originate from the remains left behind when a Humanoid or a Giant is killed by [russet mold](Sonstige/z_Content%20and%20Rules/traps-hazards/russet-mold-vgm.md). One or more vegepygmies emerge from the corpse a day later.
...
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/plant/token/vegepygmy-mpmm.webp"
```
^statblock
