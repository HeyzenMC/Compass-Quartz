...
"actions":
  ...
  - "desc": "The blight casts the [Entangle](Sonstige/z_Content%20and%20Rules/spells/entangle-xphb.md)\
      \ spell, using Constitution as the spellcasting ability (spell save DC 12).\n"
    "name": "Entangling Plants (Recharge 5-6)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/plant/token/vine-blight-xmm.webp"
```
^statblock
