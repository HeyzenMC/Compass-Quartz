...
- **Imprisoning Force.** The dragon casts the [forcecage](Sonstige/z_Content%20and%20Rules/spells/forcecage-xphb.md) spell, using its spell save DC and requiring no spell components. The spell ends early if the dragon uses this lair action again or dies.  
...
- **Background Check.** Once per day, the dragon can cast the [legend lore](Sonstige/z_Content%20and%20Rules/spells/legend-lore-xphb.md) spell, requiring no spell components, naming any person, place, or object within 1 mile of the lair as the spell's subject.  
...
- **Watery Sight.** Water within 6 miles of the lair is a conduit for the dragon's psionic presence. As an action, the dragon can cast the [clairvoyance](Sonstige/z_Content%20and%20Rules/spells/clairvoyance-xphb.md) spell, requiring no spell components and targeting any body of water in that region.  
