...
"actions":
  - "desc": "*Melee Attack Roll:* +3, reach 5 ft. *Hit:* 3 (1d4 + 1) Piercing\
      ...
      \ *Constitution Saving Throw:* DC 11. *1St Failure:* The target has the [Restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained)\
      \ condition. The target repeats the save at the end of its next turn if it is\
      \ still [Restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained),\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/token/cockatrice-xmm.webp"
```
^statblock
