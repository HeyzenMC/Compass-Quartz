...
"traits":
  - "desc": "The dreadnought's eye creates an area of antimagic, as in the [antimagic\
      ...
      \ the dreadnought is [blinded](Sonstige/z_Content%20and%20Rules/conditions.md#Blinded)."
    "name": "Antimagic Cone"
  ...
  - "desc": "Anything the dreadnought swallows is transported to a demiplane that\
      \ can be entered by no other means except a [wish](Sonstige/z_Content%20and%20Rules/spells/wish-xphb.md)\
      ...
      \ shift](Sonstige/z_Content%20and%20Rules/spells/plane-shift-xphb.md) spell.\
      \ The demiplane resembles a stone cave roughly 1,000 feet in diameter with a\
      \ ceiling 100 feet high. Like a stomach, it contains the remains of past meals.\
  ...
  - "desc": "If the dreadnought scores a critical hit against a creature traveling\
      \ by means of the [astral projection](Sonstige/z_Content%20and%20Rules/spells/astral-projection-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +16 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ and this damage reduces it to 0 hit points or it is [incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated),\
...
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/token/astral-dreadnought-mpmm.webp"
```
^statblock