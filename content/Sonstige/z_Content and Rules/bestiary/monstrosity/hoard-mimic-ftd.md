...
- "Hoard Mimic"
---
# [Hoard Mimic](Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/hoard-mimic-ftd.md)
...
"traits":
  - "desc": "If the mimic is motionless at the start of combat, it has advantage on\
      ...
      \ or act, that creature must succeed on a DC 18 Intelligence ([Investigation](Sonstige/z_Content%20and%20Rules/skills.md#Investigation))\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ creature adhered to the mimic is also [grappled](Sonstige/z_Content%20and%20Rules/conditions.md#Grappled)\
      \ by it (escape DC 16). Until this grapple ends, the target is [restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained).\
  ...
  - "desc": "The mimic sprays a fine mist of acid in a 30-foot cone. Each creature\
      ...
      \ creature takes 27 (6d8) acid damage and is [blinded](Sonstige/z_Content%20and%20Rules/conditions.md#Blinded)\
      \ until the end of its next turn. On a successful save, the creature takes half\
      \ as much damage and isn't [blinded](Sonstige/z_Content%20and%20Rules/conditions.md#Blinded)."
...
"source":
  - "FTD"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/token/hoard-mimic-ftd.webp"
```
^statblock