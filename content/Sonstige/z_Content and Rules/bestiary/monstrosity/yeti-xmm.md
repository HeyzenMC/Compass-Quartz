...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 13, one creature the yeti can see within\
      \ 30 feet. *Failure:* 5 (2d4) Cold damage, and the target has the [Paralyzed](Sonstige/z_Content%20and%20Rules/conditions.md#Paralyzed)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/token/yeti-xmm.webp"
```
^statblock
