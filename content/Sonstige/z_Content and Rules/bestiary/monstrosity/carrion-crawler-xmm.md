...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 12, one creature the carrion crawler\
      \ can see within 10 feet. *Failure:* The target has the [Poisoned](Sonstige/z_Content%20and%20Rules/conditions.md#Poisoned)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/token/carrion-crawler-xmm.webp"
```
^statblock
