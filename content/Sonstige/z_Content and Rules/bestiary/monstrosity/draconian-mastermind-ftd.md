...
---
# [Draconian Mastermind](Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/draconian-mastermind-ftd.md)
...
"traits":
  - "desc": "When the draconian is reduced to 0 hit points, its magical essence lashes\
      ...
      \ takes 9 (2d8) lightning damage and is [stunned](Sonstige/z_Content%20and%20Rules/conditions.md#Stunned)\
      \ until the end of its next turn. On a successful save, the creature takes half\
      \ as much damage and isn't [stunned](Sonstige/z_Content%20and%20Rules/conditions.md#Stunned)."
    "name": "Death Throes"
"actions":
  ...
  - "desc": "The draconian exhales a 15-foot cone of noxious gas. Each creature in\
      ...
      \ creature takes 21 (6d6) poison damage and gains 1 level of [exhaustion](Sonstige/z_Content%20and%20Rules/conditions.md#Exhaustion).\
      \ On a successful save, the creature takes half as much damage, doesn't gain\
      \ [exhaustion](Sonstige/z_Content%20and%20Rules/conditions.md#Exhaustion), and\
  ...
  - "desc": "The draconian casts one of the following spells, requiring no material\
      ...
      \n**At will:** [invisibility](Sonstige/z_Content%20and%20Rules/spells/invisibility-xphb.md),\
    ...
    "name": "Spellcasting"
"reactions":
  - "desc": "When the draconian is hit by an attack roll, it can create an [invisible](Sonstige/z_Content%20and%20Rules/conditions.md#Invisible)\
...
"source":
  - "FTD"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/token/draconian-mastermind-ftd.webp"
```
^statblock