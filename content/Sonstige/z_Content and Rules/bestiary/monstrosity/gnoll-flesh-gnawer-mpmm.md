...
- "Gnoll Flesh Gnawer"
---
# [Gnoll Flesh Gnawer](Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/gnoll-flesh-gnawer-mpmm.md)
...
"actions":
  ...
  - "desc": "Until the end of the turn, the gnoll's speed increases by 60 feet and\
      \ it doesn't provoke [opportunity attacks](Sonstige/z_Content%20and%20Rules/actions.md#Opportunity%20Attack)."
    "name": "Sudden Rush"
"bonus_actions":
...
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/token/gnoll-flesh-gnawer-mpmm.webp"
```
^statblock
