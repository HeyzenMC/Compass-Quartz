...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 8 (1d10 + 3) Piercing\
      ...
      \ 0 [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md),\
      \ the target becomes [Stable](Sonstige/z_Content%20and%20Rules/variant-rules/stable-xphb.md),\
      \ and it has the [Poisoned](Sonstige/z_Content%20and%20Rules/conditions.md#Poisoned)\
      \ condition for 1 hour. While [Poisoned](Sonstige/z_Content%20and%20Rules/conditions.md#Poisoned),\
      \ the target also has the [Paralyzed](Sonstige/z_Content%20and%20Rules/conditions.md#Paralyzed)\
      \ condition."
    "name": "Bite"
"bonus_actions":
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/token/phase-spider-xmm.webp"
```
^statblock
