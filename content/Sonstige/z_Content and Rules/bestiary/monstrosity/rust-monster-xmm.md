...
"actions":
  ...
  - "desc": "The rust monster targets one nonmagical metal object—armor or a weapon—\
      ...
      \ reaches -5. The penalty can be removed by casting the [Mending](Sonstige/z_Content%20and%20Rules/spells/mending-xphb.md)\
      \ spell on the armor or weapon."
    "name": "Antennae"
  - "desc": "The rust monster touches a nonmagical metal object within 5 feet of itself\
      \ that isn't being worn or carried. The touch destroys a 1-foot [Cube](Sonstige/z_Content%20and%20Rules/variant-rules/cube-area-of-effect-xphb.md)\
      \ of the object."
    "name": "Destroy Metal"
"reactions":
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/token/rust-monster-xmm.webp"
```
^statblock
