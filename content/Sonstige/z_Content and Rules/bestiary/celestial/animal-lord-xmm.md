...
"traits":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 20, any enemy that starts its turn in a 30-foot\
      ...
      \ until the end of its next turn. While [Charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed),\
      \ the target has the [Incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated)\
      \ condition.  \n- **Fearful (Hunter Only).** The target has the [Frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened)\
...
"actions":
  ...
  - "desc": "The animal lord conjures an animal spirit that strikes at a creature\
      ...
      - **Fortify (Forager Only).** The animal lord gains 20 [Temporary Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/temporary-hit-points-xphb.md).\
      \  \n- **Marked as Prey (Hunter Only).** The animal lord has [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md)\
      \ on attack rolls against the target until the start of the animal lord's next\
      \ turn.  \n- **Pesky Swarm (Sage Only).** The target has [Disadvantage](Sonstige/z_Content%20and%20Rules/variant-rules/disadvantage-xphb.md)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/celestial/token/animal-lord-xmm.webp"
```
^statblock
