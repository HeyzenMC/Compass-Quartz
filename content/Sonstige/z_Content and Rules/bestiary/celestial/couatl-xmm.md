...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 15, one Medium or smaller creature the couatl\
      ...
      \ condition (escape DC 13), and it has the [Restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained)\
  ...
  - "desc": "The couatl casts one of the following spells, requiring no spell components\
      ...
      \ required to maintain the spell)\n\n**1/day each:** [Create Food and Water](Sonstige/z_Content%20and%20Rules/spells/create-food-and-water-xphb.md),\
      \ [Dream](Sonstige/z_Content%20and%20Rules/spells/dream-xphb.md), [Greater Restoration](Sonstige/z_Content%20and%20Rules/spells/greater-restoration-xphb.md),\
      \ [Scrying](Sonstige/z_Content%20and%20Rules/spells/scrying-xphb.md), [Sleep](Sonstige/z_Content%20and%20Rules/spells/sleep-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The couatl casts [Bless](Sonstige/z_Content%20and%20Rules/spells/bless-xphb.md),\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/celestial/token/couatl-xmm.webp"
```
^statblock
