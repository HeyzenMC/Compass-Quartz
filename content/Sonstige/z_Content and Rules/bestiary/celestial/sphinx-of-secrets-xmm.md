...
"traits":
  - "desc": "No magic can observe the sphinx remotely or detect its thoughts without\
    ...
    "name": "Inscrutable"
  - "desc": "The sphinx has [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md)\
      \ on saving throws against spells and other magical effects."
    "name": "Magic Resistance"
"actions":
  - "desc": "The sphinx makes three Claw attacks. It can replace one attack with a\
      \ use of [Curse](Sonstige/z_Content%20and%20Rules/variant-rules/curses-xphb.md)\
      \ of the Riddle."
    "name": "Multiattack"
  ...
  - "desc": "*Intelligence Saving Throw:* DC 15, one creature the sphinx can see within\
      ...
      \ a riddle. The cursed target has [Disadvantage](Sonstige/z_Content%20and%20Rules/variant-rules/disadvantage-xphb.md)\
      \ on ability checks and attack rolls. In addition, if it takes the [Magic](Sonstige/z_Content%20and%20Rules/actions.md#Magic)\
      \ action, it must succeed on a DC 15 Intelligence saving throw or that action\
      \ is wasted. The cursed target can take a [Study](Sonstige/z_Content%20and%20Rules/actions.md#Study)\
  ...
  - "desc": "The sphinx casts one of the following spells, requiring no Material components\
      ...
      **At will:** [Detect Magic](Sonstige/z_Content%20and%20Rules/spells/detect-magic-xphb.md),\
      \ [Identify](Sonstige/z_Content%20and%20Rules/spells/identify-xphb.md), [Prestidigitation](Sonstige/z_Content%20and%20Rules/spells/prestidigitation-xphb.md)\n\
      \n**1/day each:** [Locate Object](Sonstige/z_Content%20and%20Rules/spells/locate-object-xphb.md),\
      \ [Remove Curse](Sonstige/z_Content%20and%20Rules/spells/remove-curse-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/celestial/token/sphinx-of-secrets-xmm.webp"
```
^statblock
