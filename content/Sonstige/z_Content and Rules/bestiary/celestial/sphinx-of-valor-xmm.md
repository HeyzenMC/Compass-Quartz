...
"traits":
  - "desc": "No magic can observe the sphinx remotely or detect its thoughts without\
      \ its permission. Wisdom ([Insight](Sonstige/z_Content%20and%20Rules/skills.md#Insight))\
      \ checks made to ascertain its intentions or sincerity are made with [Disadvantage](Sonstige/z_Content%20and%20Rules/variant-rules/disadvantage-xphb.md)."
    "name": "Inscrutable"
...
"actions":
  ...
  - "desc": "The sphinx emits a magical roar. Whenever it roars, the roar has a different\
      \ effect, as detailed below (the sequence resets when it takes a [Long Rest](Sonstige/z_Content%20and%20Rules/variant-rules/long-rest-xphb.md)):\n\
      \n- **First Roar.** *Wisdom Saving Throw:* DC 20, each enemy in a 500-foot [Emanation](Sonstige/z_Content%20and%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the sphinx. *Failure:* The target has the [Frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened)\
      \ condition for 1 minute.  \n- **Second Roar.** *Wisdom Saving Throw:* DC 20,\
      \ each enemy in a 500-foot [Emanation](Sonstige/z_Content%20and%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the sphinx. *Failure:* The target has the [Paralyzed](Sonstige/z_Content%20and%20Rules/conditions.md#Paralyzed)\
  ...
  - "desc": "The sphinx casts one of the following spells, requiring no Material components\
      ...
      \n**1/day each:** [Detect Magic](Sonstige/z_Content%20and%20Rules/spells/detect-magic-xphb.md),\
...
"regional_effects":
  - "desc": "The region containing a sphinx of lore's or sphinx of valor's lair is\
      ...
      \ While in its lair, the sphinx can cast [Clairvoyance](Sonstige/z_Content%20and%20Rules/spells/clairvoyance-xphb.md),\
      ...
      \ a [Study](Sonstige/z_Content%20and%20Rules/actions.md#Study) action while\
      \ within 1 mile of the lair, it adds 1d6 to any ability check it makes for\
      \ that action.  \n\nIf the sphinx dies or moves its lair elsewhere, these effects\
      \ end immediately."
    "name": ""
...
"legendary_actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 16, one creature the sphinx can see within\
      \ 120 feet. *Failure:* The target gains 1 [Exhaustion](Sonstige/z_Content%20and%20Rules/conditions.md#Exhaustion)\
      \ level. While the target has any [Exhaustion](Sonstige/z_Content%20and%20Rules/conditions.md#Exhaustion)\
      \ levels, it appears 3d10 years older. *Failure or Success:* The sphinx can't\
      \ take this action again until the start of its next turn."
    "name": "Weight of Years"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/celestial/token/sphinx-of-valor-xmm.webp"
```
^statblock
