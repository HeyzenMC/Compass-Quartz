...
"actions":
  ...
  - "desc": "The naga casts one of the following spells, requiring no Somatic or Material\
      ...
      \ (level 3 version), [Lightning Bolt](Sonstige/z_Content%20and%20Rules/spells/lightning-bolt-xphb.md)\
      \ (level 4 version)"
    "name": "Spellcasting"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fiend/token/spirit-naga-xmm.webp"
```
^statblock
