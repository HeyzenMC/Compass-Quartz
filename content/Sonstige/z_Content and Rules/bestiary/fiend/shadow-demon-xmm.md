...
"traits":
  ...
  - "desc": "While in [Bright Light](Sonstige/z_Content%20and%20Rules/variant-rules/bright-light-xphb.md),\
      \ the demon has [Disadvantage](Sonstige/z_Content%20and%20Rules/variant-rules/disadvantage-xphb.md)\
...
"bonus_actions":
  - "desc": "While in [Dim Light](Sonstige/z_Content%20and%20Rules/variant-rules/dim-light-xphb.md)\
      ...
      \ the demon takes the [Hide](Sonstige/z_Content%20and%20Rules/actions.md#Hide)\
      \ action."
    "name": "Shadow Stealth"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fiend/token/shadow-demon-xmm.webp"
```
^statblock
