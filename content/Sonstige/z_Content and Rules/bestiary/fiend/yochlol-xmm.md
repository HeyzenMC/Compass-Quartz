...
"traits":
  - "desc": "If the yochlol dies outside the Abyss, its body dissolves, and it gains\
      \ a new body instantly, reviving with all its [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
      \ in the Abyss."
    "name": "Demonic Restoration"
  - "desc": "The yochlol has [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md)\
...
"actions":
  - "desc": "The yochlol makes two Caustic Lash attacks, and it can use Spellcasting\
      \ to cast [Web](Sonstige/z_Content%20and%20Rules/spells/web-xphb.md) or [Dominate\
      \ Person](Sonstige/z_Content%20and%20Rules/spells/dominate-person-xphb.md) if\
      \ available."
    "name": "Multiattack"
  ...
  - "desc": "The yochlol casts one of the following spells, requiring no Material\
      ...
      \ (self only), [Web](Sonstige/z_Content%20and%20Rules/spells/web-xphb.md)\n\n\
      **1/day:** [Dominate Person](Sonstige/z_Content%20and%20Rules/spells/dominate-person-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
...
"reactions":
  - "desc": "Trigger: The yochlol is hit by an attack roll. _Response:_ The yochlol\
      ...
      \ it has the [Incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated)\
      \ condition."
    "name": "Toxic Escape"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fiend/token/yochlol-xmm.webp"
```
^statblock
