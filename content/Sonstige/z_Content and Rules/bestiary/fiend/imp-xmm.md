...
"cr": "1"
"traits":
  - "desc": "The imp has [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md)\
...
"actions":
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 6 (1d6 + 3) Piercing\
    ...
    "name": "Sting"
  - "desc": "The imp shape-shifts to resemble a rat ([Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md)\
      ...
      \ except for its [Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md).\
      \ Any equipment it is wearing or carrying isn't transformed."
    "name": "Shape-Shift"
  - "desc": "The imp casts [Invisibility](Sonstige/z_Content%20and%20Rules/spells/invisibility-xphb.md)\
...
"source":
  - "XMM"
  - "XPHB"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fiend/token/imp-xmm.webp"
```
^statblock
