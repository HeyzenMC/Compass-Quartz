...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 13, one creature the lamia can see within 5\
      ...
      \ hour. Until the curse ends, the target has the [Charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
  ...
  - "desc": "The lamia casts one of the following spells, requiring no Material components\
      ...
      \ (can appear as a Large or Medium biped), [Minor Illusion](Sonstige/z_Content%20and%20Rules/spells/minor-illusion-xphb.md)\n\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fiend/token/lamia-xmm.webp"
```
^statblock
