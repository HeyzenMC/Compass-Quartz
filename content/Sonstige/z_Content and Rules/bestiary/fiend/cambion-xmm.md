...
"actions":
  ...
  - "desc": "The cambion casts one of the following spells, requiring no Material\
      ...
      \n**2/day each:** [Alter Self](Sonstige/z_Content%20and%20Rules/spells/alter-self-xphb.md),\
      \ [Command](Sonstige/z_Content%20and%20Rules/spells/command-xphb.md) (level\
      \ 3 version), [Detect Magic](Sonstige/z_Content%20and%20Rules/spells/detect-magic-xphb.md)\n\
      \n**1/day each:** [Dominate Person](Sonstige/z_Content%20and%20Rules/spells/dominate-person-xphb.md)\
      \ (level 8 version), [Plane Shift](Sonstige/z_Content%20and%20Rules/spells/plane-shift-xphb.md)\
      \ (self only)"
    "name": "Spellcasting"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fiend/token/cambion-xmm.webp"
```
^statblock
