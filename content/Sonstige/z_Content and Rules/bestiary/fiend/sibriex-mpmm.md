...
- "Sibriex"
---
# [Sibriex](Sonstige/z_Content%20and%20Rules/bestiary/fiend/sibriex-mpmm.md)
...
"actions":
  ...
  - "desc": "The sibriex targets up to three creatures it can see within 120 feet\
      ...
      \ save, the target is [poisoned](Sonstige/z_Content%20and%20Rules/conditions.md#Poisoned),\
      \ which causes it to also gain 1 level of [exhaustion](Sonstige/z_Content%20and%20Rules/conditions.md#Exhaustion).\
      ...
      \ the poison removes any levels of [exhaustion](Sonstige/z_Content%20and%20Rules/conditions.md#Exhaustion)\
      \ caused by it. Each failed save causes the target to gain another level of\
      \ [exhaustion](Sonstige/z_Content%20and%20Rules/conditions.md#Exhaustion). Once\
      \ the target reaches 6 levels of [exhaustion](Sonstige/z_Content%20and%20Rules/conditions.md#Exhaustion),\
      \ it dies and instantly transforms into a living [manes](Sonstige/z_Content%20and%20Rules/bestiary/fiend/manes-xmm.md)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fiend/token/sibriex-mpmm.webp"
```
^statblock
