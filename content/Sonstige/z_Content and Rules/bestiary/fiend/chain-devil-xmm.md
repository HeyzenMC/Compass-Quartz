...
"traits":
  ...
  - "desc": "The devil has [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 10 ft. *Hit:* 11 (2d6 + 4) Slashing\
      ...
      \ condition (escape DC 14) from one of two chains, and it has the [Restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained)\
  ...
  - "desc": "The devil conjures a fiery chain to bind a creature. *Dexterity Saving\
      ...
      \ (2d4 + 4) Fire damage, and the target has the [Restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained)\
...
"reactions":
  - "desc": "Trigger: A creature the devil can see starts its turn within 30 feet\
      ...
      \ the triggering creature. *Failure:* The target has the [Frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened)\
      \ condition until the end of its turn. *Success:* The target is immune to this\
      \ devil's Unnerving Gaze for 24 hours."
    "name": "Unnerving Gaze"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fiend/token/chain-devil-xmm.webp"
```
^statblock
