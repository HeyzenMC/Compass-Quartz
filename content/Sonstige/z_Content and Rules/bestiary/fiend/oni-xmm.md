...
"cr": "7"
"traits":
  - "desc": "The oni regains 10 [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
...
"actions":
  ...
  - "desc": "The oni casts one of the following spells, requiring no Material components\
      ...
      \ each:** [Charm Person](Sonstige/z_Content%20and%20Rules/spells/charm-person-xphb.md)\
      \ (level 2 version), [Darkness](Sonstige/z_Content%20and%20Rules/spells/darkness-xphb.md),\
    ...
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The oni casts [Invisibility](Sonstige/z_Content%20and%20Rules/spells/invisibility-xphb.md)\
      \ on itself, requiring no spell components and using the same spellcasting ability\
      \ as Spellcasting.\n"
    "name": "Invisibility"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fiend/token/oni-xmm.webp"
```
^statblock
