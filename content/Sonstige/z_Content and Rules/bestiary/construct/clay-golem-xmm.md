...
"traits":
  - "desc": "Whenever the golem is subjected to Acid damage, it takes no damage and\
      \ instead regains a number of [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
  ...
  - "desc": "Whenever the golem starts its turn [Bloodied](Sonstige/z_Content%20and%20Rules/conditions.md#Bloodied),\
      ...
      \ longer [Bloodied](Sonstige/z_Content%20and%20Rules/conditions.md#Bloodied)."
    "name": "Berserk"
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 5 ft. *Hit:* 10 (1d10 + 5) Bludgeoning\
      \ damage plus 6 (1d12) Acid damage, and the target's [Hit Point](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
      \ maximum decreases by an amount equal to the Acid damage taken."
    "name": "Slam"
"bonus_actions":
  - "desc": "The golem takes the [Dash](Sonstige/z_Content%20and%20Rules/actions.md#Dash)\
      \ and [Disengage](Sonstige/z_Content%20and%20Rules/actions.md#Disengage) actions."
    "name": "Hasten (Recharge 5-6)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/construct/token/clay-golem-xmm.webp"
```
^statblock
