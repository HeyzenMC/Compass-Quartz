...
Even though a creature transformed into a stone cursed is long dead, a vague whisper of their memories lives on in the obsidian skull embedded within the stone cursed's body. At the end of a short rest, a character can make a DC 20 Intelligence ([Arcana](Sonstige/z_Content%20and%20Rules/skills.md#Arcana)) check to attempt to extract a memory from the skull that is a response to a verbal question posed to the skull by the character. Once this check is made, whether it succeeds or fails, the skull can't be used in this manner again.
...
"cr": "1"
"traits":
  - "desc": "The stone cursed has advantage on the attack rolls of [opportunity attacks](Sonstige/z_Content%20and%20Rules/actions.md#Opportunity%20Attack)."
  ...
  - "desc": "If the stone cursed is motionless at the start of combat, it has advantage\
      ...
      \ cursed move or act, that creature must succeed on a DC 18 Intelligence ([Investigation](Sonstige/z_Content%20and%20Rules/skills.md#Investigation))\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 12\
      ...
      \ [restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained) until\
      \ the end of its next turn, when it must repeat the saving throw. The effect\
      \ ends if the second save is successful; otherwise the target is [petrified](Sonstige/z_Content%20and%20Rules/conditions.md#Petrified)\
      \ for 24 hours."
    "name": "Petrifying Claws"
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/construct/token/stone-cursed-mpmm.webp"
```
^statblock
