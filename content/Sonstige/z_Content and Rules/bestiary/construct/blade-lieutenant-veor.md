...
"traits":
  - "desc": "The lieutenant has advantage on an attack roll against a creature if\
      ...
      \ the ally doesn't have the [incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated)\
      \ condition."
    "name": "Pack Tactics"
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +8 to hit, range 30/120 ft., one target. *Hit:*\
      \ 14 (3d6 + 4) piercing damage, and the target has the [prone](Sonstige/z_Content%20and%20Rules/conditions.md#Prone)\
      \ condition."
...
"bonus_actions":
  - "desc": "The lieutenant targets one ally it can see within 30 feet of itself.\
    ...
    "name": "Command Ally"
  - "desc": "The lieutenant ends the [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
...
"source":
  - "VEoR"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/construct/token/blade-lieutenant-veor.webp"
```
^statblock