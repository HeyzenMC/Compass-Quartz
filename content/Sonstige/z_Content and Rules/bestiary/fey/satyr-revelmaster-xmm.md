...
"cr": "6"
"traits":
  - "desc": "The satyr has [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "The satyr conjures a charming or frightening song. *Wisdom Saving Throw:*\
      \ DC 14, each enemy in a 60-foot [Emanation](Sonstige/z_Content%20and%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the satyr. *Failure:* The target is subjected to the song's\
      \ effect:\n\n- **Charming.** The target has the [Charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
      \ condition for 1 minute. While [Charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed),\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fey/token/satyr-revelmaster-xmm.webp"
```
^statblock
