...
"actions":
  ...
  - "desc": "*Melee  or Ranged Weapon Attack:* +8 to hit, reach 5 ft. or range 120\
      ...
      \ saving throw or have the [poisoned](Sonstige/z_Content%20and%20Rules/conditions.md#Poisoned)\
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 30 ft., one target. *Hit:*\
      \ The target has the [grappled](Sonstige/z_Content%20and%20Rules/conditions.md#Grappled)\
      \ condition (escape DC 16). Until the grapple ends, the target has the [restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained)\
      \ condition, and the dryad can't use the same vine on another target. A creature\
      \ [restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained) in\
      \ this way takes 13 (3d8) necrotic damage at the start of its turn.\n\nThe\
      \ dryad has six vines. Each vine can be attacked (AC 20; 10 hit points; immunity\
      \ to poison and psychic damage). Destroying a vine deals no damage to the dryad,\
      \ but any creature [grappled](Sonstige/z_Content%20and%20Rules/conditions.md#Grappled)\
      \ by that vine no longer has the [grappled](Sonstige/z_Content%20and%20Rules/conditions.md#Grappled)\
  ...
  - "desc": "The dryad casts one of the following spells, requiring no material components\
      ...
      \ will:** [Druidcraft](Sonstige/z_Content%20and%20Rules/spells/druidcraft-xphb.md)\n\
      \n**2/day each:** [Pass without Trace](Sonstige/z_Content%20and%20Rules/spells/pass-without-trace-xphb.md),\
      \ [Spike Growth](Sonstige/z_Content%20and%20Rules/spells/spike-growth-xphb.md)\n\
      \n**1/day:** [Dispel Magic](Sonstige/z_Content%20and%20Rules/spells/dispel-magic-xphb.md)"
    "name": "Spellcasting"
"source":
  - "VEoR"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fey/token/deadbark-dryad-veor.webp"
```
^statblock