...
Korreds prefer to keep their own company but occasionally consort with creatures of elemental earth such as [galeb duhr](Sonstige/z_Content%20and%20Rules/bestiary/elemental/galeb-duhr-xmm.md). They often gather with other korreds to perform ceremonial dances, beating out rhythms on stone with their hooves and clubs. In the depths of the Material Plane, korreds typically flee from other creatures, but they become aggressive when they feel insulted or are annoyed by the sounds of mining.
...
"gear":
  - "[greatclub](Sonstige/z_Content%20and%20Rules/items/greatclub-xphb.md)"
"senses": "[darkvision](Sonstige/z_Content%20and%20Rules/senses.md#Darkvision) 120\
  \ ft., tremorsense 120 ft., passive Perception 15"
"languages": "Dwarvish, Gnomish, Sylvan, Terran, Undercommon"
"cr": "7"
"traits":
  - "desc": "The korred has advantage on Dexterity ([Stealth](Sonstige/z_Content%20and%20Rules/skills.md#Stealth))\
...
"actions":
  ...
  - "desc": "The korred casts one of the following spells, requiring no spell components\
      ...
      \ (as an action), [meld into stone](Sonstige/z_Content%20and%20Rules/spells/meld-into-stone-xphb.md),\
      \ [stone shape](Sonstige/z_Content%20and%20Rules/spells/stone-shape-xphb.md)\n\
      \n**1/day:** [Otto's irresistible dance](Sonstige/z_Content%20and%20Rules/spells/ottos-irresistible-dance-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The korred has at least one 50-foot-long rope woven out of its hair.\
      ...
      \ must succeed on a DC 13 Dexterity saving throw or become [grappled](Sonstige/z_Content%20and%20Rules/conditions.md#Grappled)\
      \ by the rope (escape DC 13). Until this grapple ends, the target is [restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained).\
      \ The korred can use a bonus action to release the target, which is also freed\
      \ if the korred dies or becomes [incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated).\n\
...
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fey/token/korred-mpmm.webp"
```
^statblock
