...
- "Nilbog"
---
# [Nilbog](Sonstige/z_Content%20and%20Rules/bestiary/fey/nilbog-mpmm.md)
...
"traits":
  - "desc": "Any creature that attempts to damage the nilbog must first succeed on\
      \ a DC 12 Charisma saving throw or be [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
      \ until the end of the creature's next turn. A creature [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
...
"actions":
  ...
  - "desc": "The nilbog casts one of the following spells, using Charisma as the spellcasting\
    ...
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The nilbog takes the [Disengage](Sonstige/z_Content%20and%20Rules/actions.md#Disengage)\
...
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fey/token/nilbog-mpmm.webp"
```
^statblock
