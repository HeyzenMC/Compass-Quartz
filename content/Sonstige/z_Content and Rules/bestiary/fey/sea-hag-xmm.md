...
"traits":
  - "desc": "While within 30 feet of at least two hag allies, the hag can cast one\
      ...
      \ save DC 11): [Augury](Sonstige/z_Content%20and%20Rules/spells/augury-xphb.md),\
  ...
  - "desc": "*Wisdom Saving Throw:* DC 11, any Beast or Humanoid that starts its turn\
      ...
      \ target has the [Frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened)\
...
"actions":
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 10 (2d6 + 3) Slashing\
      \ damage."
    "name": "Claw"
  - "desc": "*Wisdom Saving Throw:* DC 11, one [Frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened)\
      ...
      \ or fewer, it drops to 0 [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md).\
      \ Otherwise, the target takes 13 (3d8) Psychic damage."
    "name": "Death Glare (Recharge 5-6)"
  - "desc": "The hag casts [Disguise Self](Sonstige/z_Content%20and%20Rules/spells/disguise-self-xphb.md),\
      \ using Constitution as the spellcasting ability (spell save DC 13). The spell's\
      \ duration is 24 hours.\n"
    "name": "Illusory Appearance"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fey/token/sea-hag-xmm.webp"
```
^statblock
