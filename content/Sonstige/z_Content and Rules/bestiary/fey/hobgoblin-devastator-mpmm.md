...
---
# [Hobgoblin Devastator](Sonstige/z_Content%20and%20Rules/bestiary/fey/hobgoblin-devastator-mpmm.md)
...
"actions":
  ...
  - "desc": "*Ranged Spell Attack:* +5 to hit, range 60 ft., one target. *Hit:*\
      \ 21 (4d8 + 3) force damage, and the target is knocked [prone](Sonstige/z_Content%20and%20Rules/conditions.md#Prone)."
  ...
  - "desc": "The hobgoblin casts one of the following spells, using Intelligence as\
      ...
      \ [fly](Sonstige/z_Content%20and%20Rules/spells/fly-xphb.md), [fog cloud](Sonstige/z_Content%20and%20Rules/spells/fog-cloud-xphb.md),\
...
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fey/token/hobgoblin-devastator-mpmm.webp"
```
^statblock
