...
"traits":
  - "desc": "While within 30 feet of at least two hag allies, the hag can cast one\
      ...
      \ save DC 19): [Augury](Sonstige/z_Content%20and%20Rules/spells/augury-xphb.md),\
  ...
  - "desc": "When the hag drops to 0 [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md),\
      \ it dies only if it is within 30 feet of its anathema (a thing the DM chooses\
      \ as the hag's most hated thing). Otherwise, the hag drops to 1 [Hit Point](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +14, reach 10 ft. or range 60 ft. *Hit:*\
      ...
      \ it has the [Prone](Sonstige/z_Content%20and%20Rules/conditions.md#Prone) condition."
    "name": "Spectral Claw"
  - "desc": "*Dexterity Saving Throw:* DC 22, each creature in a 60-foot [Cone](Sonstige/z_Content%20and%20Rules/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "The hag casts one of the following spells, requiring no Material components\
      ...
      \ will:** [Detect Thoughts](Sonstige/z_Content%20and%20Rules/spells/detect-thoughts-xphb.md),\
      ...
      \n**2/day each:** [Mass Suggestion](Sonstige/z_Content%20and%20Rules/spells/mass-suggestion-xphb.md),\
...
"bonus_actions":
  - "desc": "Each creature cursed by the hag and within 60 feet of it takes 14 (4d6)\
    ...
    "name": "Witch Strike"
"reactions":
  - "desc": "The hag casts [Counterspell](Sonstige/z_Content%20and%20Rules/spells/counterspell-xphb.md)\
...
"regional_effects":
  - "desc": "The region containing an arch-hag's lair is altered by its presence,\
      ...
      \ ability check they make when they take the [Influence](Sonstige/z_Content%20and%20Rules/actions.md#Influence)\
      \ action.  \n- **Meddlesome Magic.** Whenever a creature other than the hag\
      \ or its allies finishes a [Long Rest](Sonstige/z_Content%20and%20Rules/variant-rules/long-rest-xphb.md)\
      \ while within 1 mile of the lair, the next time that creature casts a spell\
      \ using a spell slot, it also casts [Confusion](Sonstige/z_Content%20and%20Rules/spells/confusion-xphb.md)\
      \ centered on itself. The spell uses the creature's spellcasting ability and\
      \ doesn't require [Concentration](Sonstige/z_Content%20and%20Rules/conditions.md#Concentration).\
...
"legendary_actions":
  - "desc": "The hag makes one Spectral Claw attack."
    "name": "Hag's Swipe"
  - "desc": "The hag uses Spellcasting to cast [Dimension Door](Sonstige/z_Content%20and%20Rules/spells/dimension-door-xphb.md)\
      \ or [Hypnotic Pattern](Sonstige/z_Content%20and%20Rules/spells/hypnotic-pattern-xphb.md).\
      \ The hag can't take this action again until the start of its next turn."
    "name": "Malicious Magic"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/fey/token/arch-hag-xmm.webp"
```
^statblock
