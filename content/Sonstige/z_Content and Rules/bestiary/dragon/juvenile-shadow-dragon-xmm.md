...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 10 ft. *Hit:* 7 (1d8 + 3) Slashing\
    ...
    "name": "Rend"
  - "desc": "*Dexterity Saving Throw:* DC 13, each creature in a 30-foot [Cone](Sonstige/z_Content%20and%20Rules/variant-rules/cone-area-of-effect-xphb.md).\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/dragon/token/juvenile-shadow-dragon-xmm.webp"
```
^statblock
