...
---
# [Ancient Sapphire Dragon](Sonstige/z_Content%20and%20Rules/bestiary/dragon/ancient-sapphire-dragon-ftd.md)
...
"actions":
  ...
  - "desc": "The dragon exhales a pulse of high-pitched, nearly inaudible sound in\
      ...
      \ and is [incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated)\
      \ until the end of its next turn. On a successful save, the creature takes half\
      \ as much damage and isn't [incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated)."
    "name": "Debilitating Breath (Recharge 5-6)"
  - "desc": "The dragon casts one of the following spells, requiring no spell components\
      \ and using Intelligence as the spellcasting ability (spell save DC 20):\n\n\
      **1/day each:** [dissonant whispers](Sonstige/z_Content%20and%20Rules/spells/dissonant-whispers-xphb.md),\
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), the dragon can take\
      ...
      \ saving throw or take 13 (3d8) thunder damage and be [stunned](Sonstige/z_Content%20and%20Rules/conditions.md#Stunned)\
      ...
      \ must succeed on a DC 15 Wisdom saving throw or be [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
      \ by the dragon until initiative count 20 on the next round. A creature [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
...
"regional_effects":
  - "desc": "The region surrounding a legendary sapphire dragon's lair is altered\
      ...
      \ for the dragon's psionic presence. As an action, the dragon can cast the [clairvoyance](Sonstige/z_Content%20and%20Rules/spells/clairvoyance-xphb.md)\
      ...
      \ the [Rary's telepathic bond](Sonstige/z_Content%20and%20Rules/spells/rarys-telepathic-bond-xphb.md)\
      \ spell.  \n- **Thriving Wildlife.** [Giant spiders](Sonstige/z_Content%20and%20Rules/bestiary/beast/giant-spider-xmm.md)\
...
"source":
  - "FTD"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/dragon/token/ancient-sapphire-dragon-ftd.webp"
```
^statblock