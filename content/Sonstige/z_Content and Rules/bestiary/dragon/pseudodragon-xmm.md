...
"cr": "1/4"
"traits":
  - "desc": "The pseudodragon has [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 12, one creature the pseudodragon can\
      ...
      \ for 1 hour. While [Poisoned](Sonstige/z_Content%20and%20Rules/conditions.md#Poisoned),\
      \ the target also has the [Unconscious](Sonstige/z_Content%20and%20Rules/conditions.md#Unconscious)\
...
"source":
  - "XMM"
  - "XPHB"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/dragon/token/pseudodragon-xmm.webp"
```
^statblock
