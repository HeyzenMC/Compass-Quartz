...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of Spellcasting to cast [Mind Spike](Sonstige/z_Content%20and%20Rules/spells/mind-spike-xphb.md)\
      \ (level 5 version)."
    "name": "Multiattack"
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ 5 version)\n\n**1/day each:** [Geas](Sonstige/z_Content%20and%20Rules/spells/geas-xphb.md),\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/dragon/token/ancient-green-dragon-xmm.webp"
```
^statblock
