...
---
# [Topaz Dragon Wyrmling](Sonstige/z_Content%20and%20Rules/bestiary/dragon/topaz-dragon-wyrmling-ftd.md)
...
| 3 | A topaz dragon wyrmling has developed a taste for crab meat and persistently hunts a giant crab that always manages to evade the wyrmling. (The crab might have been the recipient of a druid's [awaken](Sonstige/z_Content%20and%20Rules/spells/awaken-xphb.md) spell.) |
...
"source":
  - "FTD"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/dragon/token/topaz-dragon-wyrmling-ftd.webp"
```
^statblock