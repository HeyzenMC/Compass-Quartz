...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of Spellcasting to cast [Scorching Ray](Sonstige/z_Content%20and%20Rules/spells/scorching-ray-xphb.md)\
      \ (level 3 version)."
    "name": "Multiattack"
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ (level 2 version), [Detect Magic](Sonstige/z_Content%20and%20Rules/spells/detect-magic-xphb.md),\
      ...
      \ (level 6 version), [Scrying](Sonstige/z_Content%20and%20Rules/spells/scrying-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The region containing an adult or ancient red dragon's lair is warped\
      ...
      \ allies finishes a [Long Rest](Sonstige/z_Content%20and%20Rules/variant-rules/long-rest-xphb.md)\
      \ in that area, that creature must succeed on a DC 15 Constitution saving throw\
      \ or have the [Poisoned](Sonstige/z_Content%20and%20Rules/conditions.md#Poisoned)\
...
"legendary_actions":
  - "desc": "The dragon uses Spellcasting to cast [Command](Sonstige/z_Content%20and%20Rules/spells/command-xphb.md)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/dragon/token/ancient-red-dragon-xmm.webp"
```
^statblock
