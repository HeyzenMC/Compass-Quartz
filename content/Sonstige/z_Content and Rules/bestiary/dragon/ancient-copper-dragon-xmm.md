...
"actions":
  - "desc": "The dragon makes three Rend attacks. It can replace one attack with a\
      \ use of (A) Slowing Breath or (B) Spellcasting to cast [Mind Spike](Sonstige/z_Content%20and%20Rules/spells/mind-spike-xphb.md)\
      \ (level 5 version)."
    "name": "Multiattack"
  ...
  - "desc": "*Constitution Saving Throw:* DC 22, each creature in a 90-foot [Cone](Sonstige/z_Content%20and%20Rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* The target can't take Reactions; its [Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md)\
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ [Mind Spike](Sonstige/z_Content%20and%20Rules/spells/mind-spike-xphb.md) (level\
      \ 5 version), [Minor Illusion](Sonstige/z_Content%20and%20Rules/spells/minor-illusion-xphb.md),\
...
"regional_effects":
  - "desc": "The region containing an adult or ancient copper dragon's lair is changed\
      ...
      \ on a [D20 Test](Sonstige/z_Content%20and%20Rules/variant-rules/d20-test-xphb.md),\
      \ it must succeed on a DC 15 Wisdom saving throw or have the [Incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated)\
...
"legendary_actions":
  - "desc": "*Charisma Saving Throw:* DC 21, one creature the dragon can see within\
      ...
      \ roll and subtracts the number rolled from the [D20 Test](Sonstige/z_Content%20and%20Rules/variant-rules/d20-test-xphb.md).\
      \ *Failure or Success:* The dragon can't take this action again until the start\
      \ of its next turn."
    "name": "Giggling Magic"
  - "desc": "The dragon uses Spellcasting to cast [Mind Spike](Sonstige/z_Content%20and%20Rules/spells/mind-spike-xphb.md)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/dragon/token/ancient-copper-dragon-xmm.webp"
```
^statblock
