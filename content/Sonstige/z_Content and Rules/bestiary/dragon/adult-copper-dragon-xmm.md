...
"actions":
  ...
  - "desc": "The dragon casts one of the following spells, requiring no Material components\
      ...
      \ 4 version), [Minor Illusion](Sonstige/z_Content%20and%20Rules/spells/minor-illusion-xphb.md),\
...
"legendary_actions":
  - "desc": "*Charisma Saving Throw:* DC 17, one creature the dragon can see within\
      ...
      \ subtracts the number rolled from the [D20 Test](Sonstige/z_Content%20and%20Rules/variant-rules/d20-test-xphb.md).\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/dragon/token/adult-copper-dragon-xmm.webp"
```
^statblock
