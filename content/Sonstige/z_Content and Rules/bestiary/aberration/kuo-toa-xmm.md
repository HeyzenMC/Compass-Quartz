...
"traits":
  - "desc": "The kuo-toa can breathe air and water."
    "name": "Amphibious"
  - "desc": "While in sunlight, the kuo-toa has [Disadvantage](Sonstige/z_Content%20and%20Rules/variant-rules/disadvantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 10, one Large or smaller creature the kuo-toa\
      \ can see within 15 feet. *Failure:* The target has the [Restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained)\
      \ condition until the net is destroyed (AC 10; HP 5; [Immunity](Sonstige/z_Content%20and%20Rules/variant-rules/immunity-xphb.md)\
      \ to Bludgeoning, Poison, and Psychic damage). A creature can take an action\
      \ to make a DC 10 Strength ([Athletics](Sonstige/z_Content%20and%20Rules/skills.md#Athletics))\
...
"reactions":
  - "desc": "Trigger: A creature misses the kuo-toa with a melee attack roll using\
      ...
      \ doesn't let go of the weapon, the target has the [Grappled](Sonstige/z_Content%20and%20Rules/conditions.md#Grappled)\
      \ condition while the weapon is stuck (escape DC 11). While stuck, the weapon\
      \ can't be used. The target can take an action to make a DC 11 Strength ([Athletics](Sonstige/z_Content%20and%20Rules/skills.md#Athletics))\
      \ check, freeing the weapon on a success."
    "name": "Sticky Shield"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/aberration/token/kuo-toa-xmm.webp"
```
^statblock
