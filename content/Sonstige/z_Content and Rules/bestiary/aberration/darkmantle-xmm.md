...
"actions":
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 6 (1d6 + 3) Bludgeoning\
      ...
      \ or smaller creature and the darkmantle had [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md)\
      \ on the attack roll, it covers the target, which has the [Blinded](Sonstige/z_Content%20and%20Rules/conditions.md#Blinded)\
      ...
      \ has [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md)\
      \ on its attack rolls. Its [Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md)\
      \ becomes 0, it can't benefit from any bonus to its [Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md),\
      \ and it moves with the target.\n\nA creature can take an action to try to detach\
      \ the darkmantle from itself, doing so with a successful DC 13 Strength ([Athletics](Sonstige/z_Content%20and%20Rules/skills.md#Athletics))\
      \ check. On its turn, the darkmantle can detach itself by using 5 feet of movement."
    "name": "Crush"
  - "desc": "Magical [Darkness](Sonstige/z_Content%20and%20Rules/variant-rules/darkness-xphb.md)\
      \ fills a 15-foot [Emanation](Sonstige/z_Content%20and%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/aberration/token/darkmantle-xmm.webp"
```
^statblock
