...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 90-foot [Cone](Sonstige/z_Content%20and%20Rules/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "The githyanki casts one of the following spells, requiring no spell components\
      ...
      \ (self only), [Plane Shift](Sonstige/z_Content%20and%20Rules/spells/plane-shift-xphb.md),\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/aberration/token/githyanki-dracomancer-xmm.webp"
```
^statblock
