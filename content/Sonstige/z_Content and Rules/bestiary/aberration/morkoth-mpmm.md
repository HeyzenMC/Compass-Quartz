...
- "Morkoth"
---
# [Morkoth](Sonstige/z_Content%20and%20Rules/bestiary/aberration/morkoth-mpmm.md)
...
The first morkoths arose in the Astral Plane when the [petrified](Sonstige/z_Content%20and%20Rules/conditions.md#Petrified) body of a deity of greed and strife collided with a remnant of celestial matter imbued with life-giving magic. The collision released a storm of chaotic energy and sent countless islands spinning away into the void. Within some of them, bits of the god's [petrified](Sonstige/z_Content%20and%20Rules/conditions.md#Petrified) flesh came back to life as morkoths: tentacled monstrosities brimming with malice and greed.
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 15 ft., one target. *Hit:*\
      \ 15 (3d8 + 2) bludgeoning damage, and the target is [grappled](Sonstige/z_Content%20and%20Rules/conditions.md#Grappled)\
  ...
  - "desc": "The morkoth projects a 30-foot cone of magical energy. Each creature\
      ...
      \ creature is [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
      \ by the morkoth for 1 minute. While [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
      \ in this way, the target tries to get as close to the morkoth as possible,\
      \ using its actions to [Dash](Sonstige/z_Content%20and%20Rules/actions.md#Dash)\
      \ until it is within 5 feet of the morkoth. A [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
...
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/aberration/token/morkoth-mpmm.webp"
```
^statblock
