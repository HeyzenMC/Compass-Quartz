...
"actions":
  - "desc": "The githyanki makes three Silver Sword attacks. It can replace one attack\
      \ with a use of Spellcasting to cast [Telekinesis](Sonstige/z_Content%20and%20Rules/spells/telekinesis-xphb.md)\
      \ if available."
    "name": "Multiattack"
  - "desc": "*Melee Attack Roll:* +6, reach 5 ft. *Hit:* 10 (2d6 + 3) Slashing\
      ...
      \ an astral body (as with the [Astral Projection](Sonstige/z_Content%20and%20Rules/spells/astral-projection-xphb.md)\
  ...
  - "desc": "The githyanki casts one of the following spells, requiring no spell components\
      ...
      **At will:** [Mage Hand](Sonstige/z_Content%20and%20Rules/spells/mage-hand-xphb.md)\
      ...
      \n**2/day each:** [Nondetection](Sonstige/z_Content%20and%20Rules/spells/nondetection-xphb.md)\
    ...
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The githyanki casts [Misty Step](Sonstige/z_Content%20and%20Rules/spells/misty-step-xphb.md),\
      \ requiring no spell components and using the same spellcasting ability as Spellcasting.\n"
    "name": "Misty Step (2/Day)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/aberration/token/githyanki-knight-xmm.webp"
```
^statblock
