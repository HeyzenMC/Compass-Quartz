...
"traits":
  - "desc": "If the assassin is subjected to an effect that allows it to make a Dexterity\
      ...
      \ this trait if it has the [Incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated)\
      \ condition."
    "name": "Evasion"
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 7 (1d6 + 4) Piercing\
      \ damage plus 17 (5d6) Poison damage, and the target has the [Poisoned](Sonstige/z_Content%20and%20Rules/conditions.md#Poisoned)\
  ...
  - "desc": "*Ranged Attack Roll:* +7, range 80/320 ft. *Hit:* 8 (1d8 + 4) Piercing\
    ...
    "name": "Light Crossbow"
"bonus_actions":
  - "desc": "The assassin takes the [Dash](Sonstige/z_Content%20and%20Rules/actions.md#Dash),\
      \ [Disengage](Sonstige/z_Content%20and%20Rules/actions.md#Disengage), or [Hide](Sonstige/z_Content%20and%20Rules/actions.md#Hide)\
      \ action."
    "name": "Cunning Action"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/humanoid/token/assassin-xmm.webp"
```
^statblock
