...
- "Master Thief"
---
# [Master Thief](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/master-thief-mpmm.md)
...
"traits":
  - "desc": "If the thief is subjected to an effect that allows it to make a Dexterity\
      ...
      \ the thief isn't [incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated)."
    "name": "Evasion"
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +7 to hit, range 80/320 ft., one target. *Hit:*\
    ...
    "name": "Shortbow"
"bonus_actions":
  - "desc": "The thief takes the [Dash](Sonstige/z_Content%20and%20Rules/actions.md#Dash),\
...
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/humanoid/token/master-thief-mpmm.webp"
```
^statblock
