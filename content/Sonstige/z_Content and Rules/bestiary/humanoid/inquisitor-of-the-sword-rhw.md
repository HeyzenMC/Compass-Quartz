...
---
# [Inquisitor of the Sword](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/inquisitor-of-the-sword-rhw.md)
*Source: RHW p. 273*  
...
"traits":
  - "desc": "At the start of each of its turns, if the inquisitor has at least 1 [Hit\
      \ Point](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md),\
      \ it regains 10 [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
...
"actions":
  ...
  - "desc": "The inquisitor casts one of the following spells, requiring no spell\
      ...
      \ [Fly](Sonstige/z_Content%20and%20Rules/spells/fly-xphb.md), [Greater Invisibility](Sonstige/z_Content%20and%20Rules/spells/greater-invisibility-xphb.md)"
    "name": "Spellcasting"
"source":
  - "RHW"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/humanoid/token/inquisitor-of-the-sword-rhw.webp"
```
^statblock
