...
"reactions":
  - "desc": "Trigger: A creature hits the performer with an attack roll. _Response—\
      ...
      \ roll misses the performer, and the target has the [Charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
      \ condition until the end of the performer's next turn."
    "name": "Warding Charm"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/humanoid/token/performer-legend-xmm.webp"
```
^statblock
