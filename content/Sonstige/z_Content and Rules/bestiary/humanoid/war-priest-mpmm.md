...
- "War Priest"
---
# [War Priest](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/war-priest-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 254, Volo's Guide to Monsters p. 218*  

War priests worship deities of war, protection, and strategy. They plan tactics, lead soldiers into battle, confront enemy spellcasters, and tend to casualties. A war priest might command an army or serve as the right hand of a [warlord](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/warlord-mpmm.md) (appears in "this book") on the battlefield.
...
| 4 | Clay figurine of a [ki-rin](Sonstige/z_Content%20and%20Rules/bestiary/celestial/ki-rin-mpmm.md) or another Celestial |
| 5 | [Torch](Sonstige/z_Content%20and%20Rules/items/torch-xphb.md) carved so that a hand appears to be holding the flame |
| 6 | Circlet of woven reeds |
| 7 | Scrimshawed bone |
| 8 | Vessel such as a cup, a [jug](Sonstige/z_Content%20and%20Rules/items/jug-xphb.md), an urn, or an amphora |
^war-priest-holy-symbols
...
"ac": !!int "18"
"ac_class": "[plate](Sonstige/z_Content%20and%20Rules/items/plate-armor-xphb.md)"
"hp": !!int "117"
"hit_dice": "18d8 + 36"
"modifier": !!int "0"
"stats":
...
"actions":
  ...
  - "desc": "The war priest targets one creature it can see within 60 feet of it.\
      ...
      \ takes 12 (2d8 + 3) radiant damage, and it is [blinded](Sonstige/z_Content%20and%20Rules/conditions.md#Blinded)\
      \ until the start of the war priest's next turn. On a successful save, the target\
      \ takes half as much damage and isn't [blinded](Sonstige/z_Content%20and%20Rules/conditions.md#Blinded)."
    "name": "Holy Fire"
  - "desc": "The war priest casts one of the following spells, using Wisdom as the\
      ...
      \ [command](Sonstige/z_Content%20and%20Rules/spells/command-xphb.md), [dispel\
      \ magic](Sonstige/z_Content%20and%20Rules/spells/dispel-magic-xphb.md), [flame\
      \ strike](Sonstige/z_Content%20and%20Rules/spells/flame-strike-xphb.md), [guardian\
      \ of faith](Sonstige/z_Content%20and%20Rules/spells/guardian-of-faith-xphb.md),\
...
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/humanoid/token/war-priest-mpmm.webp"
```
^statblock
