...
"actions":
  ...
  - "desc": "The mage casts one of the following spells, using Intelligence as the\
      ...
      \n**1/day each:** [Disguise Self](Sonstige/z_Content%20and%20Rules/spells/disguise-self-xphb.md),\
      \ [Ice Knife](Sonstige/z_Content%20and%20Rules/spells/ice-knife-xphb.md), [Mage\
      \ Armor](Sonstige/z_Content%20and%20Rules/spells/mage-armor-xphb.md) (included\
      \ in AC), [Thunderwave](Sonstige/z_Content%20and%20Rules/spells/thunderwave-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/humanoid/token/mage-apprentice-xmm.webp"
```
^statblock
