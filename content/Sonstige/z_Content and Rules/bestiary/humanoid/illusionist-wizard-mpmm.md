...
- "Illusionist Wizard"
---
# [Illusionist Wizard](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/illusionist-wizard-mpmm.md)
...
"actions":
  ...
  - "desc": "The illusionist casts one of the following spells, using Intelligence\
      ...
      \n**2/day each:** [disguise self](Sonstige/z_Content%20and%20Rules/spells/disguise-self-xphb.md),\
...
"bonus_actions":
  - "desc": "The illusionist projects an illusion that makes the illusionist appear\
      ...
      \ if it is [incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated),\
      \ or if its speed becomes 0."
    "name": "Displacement (Recharge 5-6)"
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/humanoid/token/illusionist-wizard-mpmm.webp"
```
^statblock
