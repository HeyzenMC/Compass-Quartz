...
- "Giff"
---
# [Giff](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/giff-mpmm.md)
...
"gear":
  ...
  - "[musket](Sonstige/z_Content%20and%20Rules/items/musket-xphb.md)"
  - "[pistol](Sonstige/z_Content%20and%20Rules/items/pistol-xphb.md)"
...
"traits":
  ...
  - "desc": "The giff can try to knock a creature over; if the giff moves at least\
      ...
      \ bludgeoning damage and be knocked [prone](Sonstige/z_Content%20and%20Rules/conditions.md#Prone)."
...
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/humanoid/token/giff-mpmm.webp"
```
^statblock
