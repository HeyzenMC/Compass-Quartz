...
---
# [Shadar-kai Gloom Weaver](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/shadar-kai-gloom-weaver-mpmm.md)
...
"traits":
  - "desc": "Beasts and Humanoids (except elves) have disadvantage on saving throws\
    ...
    "name": "Burden of Time"
  - "desc": "The shadar-kai has advantage on saving throws against being [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed),\
...
"actions":
  ...
  - "desc": "The shadar-kai casts one of the following spells, requiring no material\
      ...
      \n**At will:** [arcane eye](Sonstige/z_Content%20and%20Rules/spells/arcane-eye-xphb.md),\
      ...
      \ [bane](Sonstige/z_Content%20and%20Rules/spells/bane-xphb.md), [confusion](Sonstige/z_Content%20and%20Rules/spells/confusion-xphb.md),\
      \ [darkness](Sonstige/z_Content%20and%20Rules/spells/darkness-xphb.md), [fear](Sonstige/z_Content%20and%20Rules/spells/fear-xphb.md),\
    ...
    "name": "Spellcasting"
"reactions":
  - "desc": "When the shadar-kai takes damage, it turns [invisible](Sonstige/z_Content%20and%20Rules/conditions.md#Invisible)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/humanoid/token/shadar-kai-gloom-weaver-mpmm.webp"
```
^statblock
