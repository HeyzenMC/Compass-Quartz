...
- "Duergar Mind Master"
---
# [Duergar Mind Master](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/duergar-mind-master-mpmm.md)
...
"actions":
  ...
  - "desc": "The duergar targets one creature it can see within 60 feet of it. The\
      ...
      \ of the duergar's choice. Creatures that can't be [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
...
"bonus_actions":
  - "desc": "For 1 minute, the duergar magically decreases in size, along with anything\
      ...
      \ ([Stealth](Sonstige/z_Content%20and%20Rules/skills.md#Stealth)) checks and\
      \ a +5 bonus to its AC. It can also take a bonus action on each of its turns\
      \ to take the [Hide](Sonstige/z_Content%20and%20Rules/actions.md#Hide) action."
    "name": "Reduce (Recharges after a Short or Long Rest)"
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/humanoid/token/duergar-mind-master-mpmm.webp"
```
^statblock
