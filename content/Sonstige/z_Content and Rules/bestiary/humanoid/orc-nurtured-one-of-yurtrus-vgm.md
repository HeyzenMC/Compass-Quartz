...
---
# [Orc Nurtured One of Yurtrus](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/orc-nurtured-one-of-yurtrus-vgm.md)
...
"traits":
  ...
  - "desc": "When the orc is reduced to 0 hit points, it explodes, and any creature\
      ...
      \ save, the creature takes 14 (4d6) poison damage and becomes [poisoned](Sonstige/z_Content%20and%20Rules/conditions.md#Poisoned).\
      \ On a success, the creature takes half as much damage and isn't [poisoned](Sonstige/z_Content%20and%20Rules/conditions.md#Poisoned).\
      \ A creature [poisoned](Sonstige/z_Content%20and%20Rules/conditions.md#Poisoned)\
      \ by this effect can repeat the save at the end of each of its turn, ending\
      \ the effect on itself on a success. While [poisoned](Sonstige/z_Content%20and%20Rules/conditions.md#Poisoned)\
...
"source":
  - "VGM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/humanoid/token/orc-nurtured-one-of-yurtrus-vgm.webp"
```
^statblock
