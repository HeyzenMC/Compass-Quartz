...
- "Enchanter Wizard"
---
# [Enchanter Wizard](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/enchanter-wizard-mpmm.md)
...
"actions":
  ...
  - "desc": "The enchanter casts one of the following spells, using Intelligence as\
      \ the spellcasting ability (spell save DC 14):\n\n**At will:** [friends](Sonstige/z_Content%20and%20Rules/spells/friends-xphb.md),\
...
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/humanoid/token/enchanter-wizard-mpmm.webp"
```
^statblock
