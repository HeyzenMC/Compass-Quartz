...
"actions":
  ...
  - "desc": "The druid casts one of the following spells, using Wisdom as the spellcasting\
      ...
      \n**2/day each:** [Entangle](Sonstige/z_Content%20and%20Rules/spells/entangle-xphb.md),\
      \ [Thunderwave](Sonstige/z_Content%20and%20Rules/spells/thunderwave-xphb.md)\n\
      \n**1/day each:** [Animal Messenger](Sonstige/z_Content%20and%20Rules/spells/animal-messenger-xphb.md),\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/humanoid/token/druid-xmm.webp"
```
^statblock
