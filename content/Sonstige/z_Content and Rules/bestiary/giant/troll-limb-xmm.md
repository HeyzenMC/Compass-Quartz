...
"cr": "1/2"
"traits":
  - "desc": "The limb regains 5 [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
      ...
      \ it starts its turn with 0 [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
  ...
  - "desc": "The limb uncannily has the same senses as a whole troll. If the limb\
      ...
      \ a [Troll](Sonstige/z_Content%20and%20Rules/bestiary/giant/troll-xmm.md). Otherwise,\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/giant/token/troll-limb-xmm.webp"
```
^statblock
