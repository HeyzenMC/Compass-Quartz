...
---
# [Stone Giant Dreamwalker](Sonstige/z_Content%20and%20Rules/bestiary/giant/stone-giant-dreamwalker-mpmm.md)
...
"traits":
  - "desc": "An enemy that starts its turn within 30 feet of the giant must make a\
      \ DC 13 Charisma saving throw, provided that the giant isn't [incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated).\
      \ On a failed save, the creature is [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
      \ by the giant. A creature [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
...
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +10 to hit, range 60/240 ft., one target. *Hit:*\
      ...
      \ on a DC 17 Strength saving throw or be knocked [prone](Sonstige/z_Content%20and%20Rules/conditions.md#Prone)."
    "name": "Rock"
  - "desc": "The giant touches one Medium or smaller creature within 10 feet of it\
      \ that is [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
      \ by it. The target must make a DC 17 Constitution saving throw. On a failed\
      \ save, the target becomes [petrified](Sonstige/z_Content%20and%20Rules/conditions.md#Petrified),\
      \ and the giant can adhere the target to its stony body. [greater restoration](Sonstige/z_Content%20and%20Rules/spells/greater-restoration-xphb.md)\
      \ spells and other magic that can undo petrification have no effect on a [petrified](Sonstige/z_Content%20and%20Rules/conditions.md#Petrified)\
      \ creature adhered to the giant unless the giant is dead, in which case the\
      \ magic works normally, freeing the [petrified](Sonstige/z_Content%20and%20Rules/conditions.md#Petrified)\
      \ creature as well as ending the [petrified](Sonstige/z_Content%20and%20Rules/conditions.md#Petrified)\
      \ condition on it."
    "name": "Petrifying Touch"
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/giant/token/stone-giant-dreamwalker-mpmm.webp"
```
^statblock
