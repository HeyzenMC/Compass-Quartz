...
---
# [Storm Giant Quintessent](Sonstige/z_Content%20and%20Rules/bestiary/giant/storm-giant-quintessent-mpmm.md)
...
"legendary_actions":
  ...
  - "desc": "The giant vanishes, dispersing itself into the storm surrounding its\
      ...
      \ creature is using a [control weather](Sonstige/z_Content%20and%20Rules/spells/control-weather-xphb.md)\
      \ spell or similar magic to quell the storm."
    "name": "One with the Storm (Costs 3 Actions)"
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/giant/token/storm-giant-quintessent-mpmm.webp"
```
^statblock
