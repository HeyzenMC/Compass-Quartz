...
"actions":
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 10 (2d6 + 3) Piercing\
    ...
    "name": "Bite"
"bonus_actions":
  - "desc": "Immediately after dealing damage to a creature that was already [Bloodied](Sonstige/z_Content%20and%20Rules/conditions.md#Bloodied),\
      \ the hyena can move up to half its [Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md),\
      \ and it makes one Bite attack."
    "name": "Rampage (1/Day)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/beast/token/giant-hyena-xmm.webp"
```
^statblock
