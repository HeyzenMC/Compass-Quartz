...
"actions":
  - "desc": "*Melee Attack Roll:* +5 (with [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md)\
      \ if the target doesn't have all its [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)),\
      \ reach 5 ft. *Hit:* 8 (2d4 + 3) Piercing damage, or 5 (1d4 + 3) Piercing\
      \ damage if the swarm is [Bloodied](Sonstige/z_Content%20and%20Rules/conditions.md#Bloodied)."
    "name": "Bites"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/beast/token/swarm-of-piranhas-xmm.webp"
```
^statblock
