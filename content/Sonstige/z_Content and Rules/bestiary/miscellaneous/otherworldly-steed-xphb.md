...
- "Otherworldly Steed"
---
# [Otherworldly Steed](Sonstige/z_Content%20and%20Rules/bestiary/miscellaneous/otherworldly-steed-xphb.md)
...
"traits":
  - "desc": "When you regain [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
      \ from a level 1+ spell, the steed regains the same number of [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
...
"bonus_actions":
  - "desc": "*Wisdom Saving Throw:* DC equals your spell save DC, one creature within\
      \ 60 feet the steed can see. *Failure:* The target has the [Frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened)\
  ...
  - "desc": "One creature within 5 feet of the steed regains a number of [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
      \ equal to 2d8 + the spell's level."
    "name": "Healing Touch (Celestial Only; Recharges after a Long Rest)"
"source":
  - "XPHB"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/miscellaneous/token/otherworldly-steed-xphb.webp"
```
^statblock