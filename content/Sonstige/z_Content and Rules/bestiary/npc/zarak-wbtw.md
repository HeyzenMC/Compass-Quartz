...
- "Zarak"
---
# [Zarak](Sonstige/z_Content%20and%20Rules/bestiary/npc/zarak-wbtw.md)
...
"cr": "2"
"traits":
  - "desc": "Zarak carries a [potion of invisibility](Sonstige/z_Content%20and%20Rules/items/potion-of-invisibility-xdmg.md)."
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one Humanoid. *Hit:*\
      \ 8 (2d4 + 3) slashing damage, and the target is [grappled](Sonstige/z_Content%20and%20Rules/conditions.md#Grappled)\
    ...
    "name": "Garrote"
"bonus_actions":
  - "desc": "Zarak takes the [Dash](Sonstige/z_Content%20and%20Rules/actions.md#Dash),\
...
"source":
  - "WBtW"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/npc/token/zarak-wbtw.webp"
```
^statblock