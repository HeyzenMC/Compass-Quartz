...
- "Yeenoghu"
---
# [Yeenoghu](Sonstige/z_Content%20and%20Rules/bestiary/npc/yeenoghu-mpmm.md)
...
"actions":
  ...
  - "desc": "Yeenoghu casts one of the following spells, requiring no material components\
      ...
      \ [fear](Sonstige/z_Content%20and%20Rules/spells/fear-xphb.md), [invisibility](Sonstige/z_Content%20and%20Rules/spells/invisibility-xphb.md)\n\
...
"legendary_actions":
  ...
  - "desc": "Yeenoghu makes one Flail attack. If the attack hits, the target must\
      ...
      \ is also knocked [prone](Sonstige/z_Content%20and%20Rules/conditions.md#Prone)."
    "name": "Swat Away"
...
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/npc/token/yeenoghu-mpmm.webp"
```
^statblock