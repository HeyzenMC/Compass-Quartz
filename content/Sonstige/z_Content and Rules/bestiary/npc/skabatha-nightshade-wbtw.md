...
- "Skabatha Nightshade"
---
# [Skabatha Nightshade](Sonstige/z_Content%20and%20Rules/bestiary/npc/skabatha-nightshade-wbtw.md)
...
"traits":
  ...
  - "desc": "The first creature that Skabatha sees after she finishes a long rest\
      \ is [invisible](Sonstige/z_Content%20and%20Rules/conditions.md#Invisible) to\
...
"actions":
  ...
  - "desc": "Skabatha casts one of the following spells, requiring no material components\
      ...
      \n**2/day each:** [polymorph](Sonstige/z_Content%20and%20Rules/spells/polymorph-xphb.md),\
      ...
      \n**1/day:** [awaken](Sonstige/z_Content%20and%20Rules/spells/awaken-xphb.md)\
      \ (as an action), [plane shift](Sonstige/z_Content%20and%20Rules/spells/plane-shift-xphb.md)\
      \ (self only)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "Skabatha magically shrinks herself to Tiny size (between 4 and 8 inches\
      ...
      \ attack. She has advantage on Dexterity ([Stealth](Sonstige/z_Content%20and%20Rules/skills.md#Stealth))\
      \ checks, and disadvantage on Strength checks and Strength saving throws. Her\
      \ statistics otherwise remain unchanged."
    "name": "Alter Size"
"source":
  - "WBtW"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/npc/token/skabatha-nightshade-wbtw.webp"
```
^statblock