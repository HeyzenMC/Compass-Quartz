...
---
# [Clapperclaw the Scarecrow](Sonstige/z_Content%20and%20Rules/bestiary/npc/clapperclaw-the-scarecrow-wbtw.md)
...
"bonus_actions":
  - "desc": "Clapperclaw targets one creature it can see within 15 feet of it. The\
      \ target must succeed on a DC 11 Wisdom saving throw or be magically [frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened)\
      \ until the end of Clapperclaw's next turn."
    "name": "Unsettling Presence (Recharge 6)"
"source":
  - "WBtW"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/npc/token/clapperclaw-the-scarecrow-wbtw.webp"
```
^statblock