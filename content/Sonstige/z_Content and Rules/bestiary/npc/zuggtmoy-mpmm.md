...
- "Zuggtmoy"
---
# [Zuggtmoy](Sonstige/z_Content%20and%20Rules/bestiary/npc/zuggtmoy-mpmm.md)
...
"actions":
  ...
  - "desc": "Zuggtmoy casts one of the following spells, requiring no material components\
      ...
      \ [entangle](Sonstige/z_Content%20and%20Rules/spells/entangle-xphb.md), [plant\
      \ growth](Sonstige/z_Content%20and%20Rules/spells/plant-growth-xphb.md)\n\n\
      **1/day each:** [etherealness](Sonstige/z_Content%20and%20Rules/spells/etherealness-xphb.md),\
...
"bonus_actions":
  - "desc": "Zuggtmoy releases spores that burst out in a cloud that fills a 20-foot-radius\
      ...
      \ is reanimated as a [spore servant](Sonstige/z_Content%20and%20Rules/bestiary/plant/myconid-spore-servant-xmm.md)\
  ...
  - "desc": "Zuggtmoy releases spores that burst out in a cloud that fills a 20-foot-radius\
      ...
      \ the creature is [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
...
"reactions":
  - "desc": "When Zuggtmoy is hit by an attack roll, one creature within 10 feet of\
      \ her that is [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
...
"legendary_actions":
  - "desc": "Zuggtmoy makes one Pseudopod attack."
    "name": "Attack"
  - "desc": "One creature [charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/npc/token/zuggtmoy-mpmm.webp"
```
^statblock