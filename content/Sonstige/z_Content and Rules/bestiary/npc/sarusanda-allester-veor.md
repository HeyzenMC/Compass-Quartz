...
- "Sarusanda Allester"
---
# [Sarusanda Allester](Sonstige/z_Content%20and%20Rules/bestiary/npc/sarusanda-allester-veor.md)
...
"actions":
  ...
  - "desc": "Each creature in a 20-foot-radius sphere centered on a point Sarusanda\
      ...
      \ throw or take 31 (6d8 + 4) force damage and be knocked [prone](Sonstige/z_Content%20and%20Rules/conditions.md#Prone)\
  ...
  - "desc": "Sarusanda casts one of the following spells, requiring no components\
      ...
      **At will:** [detect magic](Sonstige/z_Content%20and%20Rules/spells/detect-magic-xphb.md),\
      ...
      \ [levitate](Sonstige/z_Content%20and%20Rules/spells/levitate-xphb.md), [mage\
      \ armor](Sonstige/z_Content%20and%20Rules/spells/mage-armor-xphb.md), [mage\
      \ hand](Sonstige/z_Content%20and%20Rules/spells/mage-hand-xphb.md), [sending](Sonstige/z_Content%20and%20Rules/spells/sending-xphb.md),\
      \ [speak with dead](Sonstige/z_Content%20and%20Rules/spells/speak-with-dead-xphb.md)\n\
      \n**1/day each:** [Otiluke's resilient sphere](Sonstige/z_Content%20and%20Rules/spells/otilukes-resilient-sphere-xphb.md),\
...
"source":
  - "VEoR"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/npc/token/sarusanda-allester-veor.webp"
```
^statblock