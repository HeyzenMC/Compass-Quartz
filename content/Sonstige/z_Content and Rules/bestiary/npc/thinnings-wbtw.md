...
- "Thinnings"
---
# [Thinnings](Sonstige/z_Content%20and%20Rules/bestiary/npc/thinnings-wbtw.md)
...
"cr": "1"
"traits":
  - "desc": "On each of its turns, Thinnings can use a bonus action to take the [Dash](Sonstige/z_Content%20and%20Rules/actions.md#Dash),\
      \ [Disengage](Sonstige/z_Content%20and%20Rules/actions.md#Disengage), or [Hide](Sonstige/z_Content%20and%20Rules/actions.md#Hide)\
      \ action."
    "name": "Cunning Action"
  - "desc": "Thinnings deals an extra 7 (2d6) damage when it hits a target with\
      \ a weapon attack and has advantage on the attack roll, or when the target is\
      \ within 5 feet of an ally of Thinnings that isn't [incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated)\
...
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +4 to hit, range 30/120 ft., one target. *Hit:*\
    ...
    "name": "Hand Crossbow"
  - "desc": "Thinnings can make himself as flat as a piece of parchment or revert\
      \ to his normal thickness. In his flattened form, he can slide under doors,\
      \ roll himself up, or even fold himself into the pages of a book."
    "name": "Change Shape"
"source":
  - "WBtW"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/npc/token/thinnings-wbtw.webp"
```
^statblock