...
- "Envy"
---
# [Envy](Sonstige/z_Content%20and%20Rules/bestiary/npc/envy-wbtw.md)
...
"traits":
  - "desc": "If Envy moves at least 20 feet straight toward a creature and then hits\
      ...
      \ Strength saving throw or be knocked [prone](Sonstige/z_Content%20and%20Rules/conditions.md#Prone).\
      \ If the target is [prone](Sonstige/z_Content%20and%20Rules/conditions.md#Prone),\
...
"actions":
  ...
  - "desc": "Envy exhales petrifying gas in a 30-foot cone. Each creature in that\
      ...
      \ a target begins to turn to stone and is [restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained).\
      ...
      \ the effect ends on the target. On a failure, the target is [petrified](Sonstige/z_Content%20and%20Rules/conditions.md#Petrified)\
      \ until freed by the [greater restoration](Sonstige/z_Content%20and%20Rules/spells/greater-restoration-xphb.md)\
      \ spell or other magic."
    "name": "Petrifying Breath (Recharge 5-6)"
"source":
  - "WBtW"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/npc/token/envy-wbtw.webp"
```
^statblock