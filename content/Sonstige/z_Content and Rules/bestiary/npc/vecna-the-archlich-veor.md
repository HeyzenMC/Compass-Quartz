...
- "Vecna the Archlich"
---
# [Vecna the Archlich](Sonstige/z_Content%20and%20Rules/bestiary/npc/vecna-the-archlich-veor.md)
...
"traits":
  ...
  - "desc": "Vecna carries a magic dagger named Afterthought. In the hands of anyone\
      \ other than Vecna, Afterthought is a [+2 Dagger](Sonstige/z_Content%20and%20Rules/items/2-weapon-xdmg.md)."
...
"actions":
  ...
  - "desc": "Vecna conjures a torrent of flying, spectral entities that fill a 120-foot\
      ...
      \ save, the creature takes 36 (8d8) necrotic damage and has the [frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened)\
      \ condition for 1 minute. On a successful save, the creature takes half as much\
      \ damage only. A [frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened)\
  ...
  - "desc": "Vecna casts one of the following spells, requiring no material components\
      ...
      **At will:** [Animate Dead](Sonstige/z_Content%20and%20Rules/spells/animate-dead-xphb.md)\
      \ (as an action), [Detect Magic](Sonstige/z_Content%20and%20Rules/spells/detect-magic-xphb.md),\
      ...
      \n**2/day each:** [Dimension Door](Sonstige/z_Content%20and%20Rules/spells/dimension-door-xphb.md),\
      \ [Invisibility](Sonstige/z_Content%20and%20Rules/spells/invisibility-xphb.md),\
      \ [Scrying](Sonstige/z_Content%20and%20Rules/spells/scrying-xphb.md) (as an\
...
"source":
  - "VEoR"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/npc/token/vecna-the-archlich-veor.webp"
```
^statblock