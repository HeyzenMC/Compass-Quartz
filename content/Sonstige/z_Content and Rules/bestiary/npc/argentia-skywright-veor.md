...
- "Argentia Skywright"
---
# [Argentia Skywright](Sonstige/z_Content%20and%20Rules/bestiary/npc/argentia-skywright-veor.md)
...
"traits":
  - "desc": "Argentia can use its action to polymorph into a wolf-humanoid hybrid\
    ...
    "name": "Shapechanger"
  - "desc": "Argentia has advantage on Wisdom ([Perception](Sonstige/z_Content%20and%20Rules/skills.md#Perception))\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 6\
      ...
      \ on a DC 12 Constitution saving throw or be cursed with werewolf [lycanthropy](Sonstige/z_Content%20and%20Rules/variant-rules/player-characters-as-lycanthropes-mm.md)."
...
"source":
  - "VEoR"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/npc/token/argentia-skywright-veor.webp"
```
^statblock