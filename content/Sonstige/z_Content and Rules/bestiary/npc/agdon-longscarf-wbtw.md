...
- "Agdon Longscarf"
---
# [Agdon Longscarf](Sonstige/z_Content%20and%20Rules/bestiary/npc/agdon-longscarf-wbtw.md)
...
"traits":
  - "desc": "If Agdon is subjected to an effect that allows him to make a Dexterity\
      ...
      \ on the saving throw and only half damage if he fails, provided he isn't [incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated)."
    "name": "Evasion"
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 5 ft., one target. *Hit:* 10\
      \ (3d6) fire damage, and the target is magically branded. Agdon is [invisible](Sonstige/z_Content%20and%20Rules/conditions.md#Invisible)\
...
"bonus_actions":
  - "desc": "Agdon targets one creature within 5 feet of him that he can see and makes\
      \ a Dexterity ([Sleight of Hand](Sonstige/z_Content%20and%20Rules/skills.md#Sleight%20of%20Hand))\
      \ check, with a DC equal to 1 + the target's passive Wisdom ([Perception](Sonstige/z_Content%20and%20Rules/skills.md#Perception))\
...
"source":
  - "WBtW"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/npc/token/agdon-longscarf-wbtw.webp"
```
^statblock