...
- "Endelyn Moongrave"
---
# [Endelyn Moongrave](Sonstige/z_Content%20and%20Rules/bestiary/npc/endelyn-moongrave-wbtw.md)
...
"traits":
  ...
  - "desc": "Endelyn can be killed only if she is reduced to 0 hit points during a\
    ...
    "name": "Eclipsed Doom"
  - "desc": "Endelyn can't be [surprised](Sonstige/z_Content%20and%20Rules/conditions.md#Surprised)."
...
"actions":
  ...
  - "desc": "Endelyn casts one of the following spells, requiring no material components\
      ...
      **2/day each:** [augury](Sonstige/z_Content%20and%20Rules/spells/augury-xphb.md),\
...
"source":
  - "WBtW"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/npc/token/endelyn-moongrave-wbtw.webp"
```
^statblock