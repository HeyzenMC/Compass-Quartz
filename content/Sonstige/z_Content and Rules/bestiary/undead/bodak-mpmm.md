...
- "Bodak"
---
# [Bodak](Sonstige/z_Content%20and%20Rules/bestiary/undead/bodak-mpmm.md)
...
"traits":
  - "desc": "When a creature that can see the bodak's eyes starts its turn within\
      ...
      \ saving throw if the bodak isn't [incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated)\
      \ and can see the creature. If the saving throw fails by 5 or more, the creature\
      \ is reduced to 0 hit points unless it is immune to the [frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened)\
...
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/undead/token/bodak-mpmm.webp"
```
^statblock
