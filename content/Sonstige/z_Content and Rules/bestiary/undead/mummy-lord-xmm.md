...
"traits":
  ...
  - "desc": "The mummy has [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md)\
      \ on saving throws against spells and other magical effects."
    "name": "Magic Resistance"
  - "desc": "If destroyed, the mummy gains a new body in 24 hours if its heart is\
      \ intact, reviving with all its [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md).\
      \ The new body appears in an unoccupied space within the mummy's lair. The heart\
      \ is a Tiny object that has AC 17, HP 10, and [Immunity](Sonstige/z_Content%20and%20Rules/variant-rules/immunity-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 5 ft. *Hit:* 15 (2d10 + 4) Bludgeoning\
      ...
      \ cursed. While cursed, the target can't regain [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md),\
      \ it gains no benefit from finishing a [Long Rest](Sonstige/z_Content%20and%20Rules/variant-rules/long-rest-xphb.md),\
      ...
      \ and turns to dust if reduced to 0 [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
      \ by this attack."
    "name": "Rotting Fist"
  ...
  - "desc": "*Wisdom Saving Throw:* DC 17, one creature the mummy can see within 60\
      \ feet. *Failure:* 25 (6d6 + 4) Psychic damage, and the target has the [Paralyzed](Sonstige/z_Content%20and%20Rules/conditions.md#Paralyzed)\
  ...
  - "desc": "The mummy casts one of the following spells, requiring no Material components\
      ...
      \ with spell attacks):\n\n**At will:** [Dispel Magic](Sonstige/z_Content%20and%20Rules/spells/dispel-magic-xphb.md),\
      ...
      \ [Harm](Sonstige/z_Content%20and%20Rules/spells/harm-xphb.md), [Insect Plague](Sonstige/z_Content%20and%20Rules/spells/insect-plague-xphb.md)\
      \ (level 7 version)"
    "name": "Spellcasting"
"reactions":
  - "desc": "Trigger: The mummy is hit by an attack roll. _Response:_ The mummy adds\
      ...
      \ [Blinded](Sonstige/z_Content%20and%20Rules/conditions.md#Blinded) condition\
...
"regional_effects":
  - "desc": "The region containing a mummy lord's lair is warped by its presence,\
      ...
      \ Action](Sonstige/z_Content%20and%20Rules/variant-rules/bonus-action-xphb.md),\
      \ or [Reaction](Sonstige/z_Content%20and%20Rules/variant-rules/reaction-xphb.md)\
...
"legendary_actions":
  ...
  - "desc": "The mummy casts [Command](Sonstige/z_Content%20and%20Rules/spells/command-xphb.md)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/undead/token/mummy-lord-xmm.webp"
```
^statblock
