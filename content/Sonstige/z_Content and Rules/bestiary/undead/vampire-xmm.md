...
"traits":
  ...
  - "desc": "If the vampire drops to 0 [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
      ...
      \ to its vampire form and has the [Paralyzed](Sonstige/z_Content%20and%20Rules/conditions.md#Paralyzed)\
      \ condition until it regains any [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md),\
      \ and it regains 1 [Hit Point](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
  ...
  - "desc": "The vampire has these weaknesses:\n\n- **Forbiddance.** The vampire can't\
      ...
      \ the vampire's heart while the vampire has the [Incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated)\
      \ condition in its resting place, the vampire has the [Paralyzed](Sonstige/z_Content%20and%20Rules/conditions.md#Paralyzed)\
      ...
      \ has [Disadvantage](Sonstige/z_Content%20and%20Rules/variant-rules/disadvantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 17, one creature within 5 feet that is\
      ...
      \ vampire regains [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
      ...
      \ by this damage and then buried rises the following sunset as a [Vampire Spawn](Sonstige/z_Content%20and%20Rules/bestiary/undead/vampire-spawn-xmm.md)\
      \ under the vampire's control."
    "name": "Bite (Bat or Vampire Form Only)"
"bonus_actions":
  - "desc": "If the vampire isn't in sunlight or running water, it shape-shifts into\
      \ a Tiny bat ([Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md)\
      \ 5 ft., [Fly Speed](Sonstige/z_Content%20and%20Rules/variant-rules/fly-speed-xphb.md)\
      \ 30 ft.) or a Medium cloud of mist ([Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md)\
      \ 5 ft., [Fly Speed](Sonstige/z_Content%20and%20Rules/variant-rules/fly-speed-xphb.md)\
      \ 20 ft. [hover]), or it returns to its vampire form. Anything it is wearing\
      \ transforms with it.\n\nWhile in bat form, the vampire can't speak. Its game\
      \ statistics, other than its size and [Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md),\
      ...
      \ can't pass through liquid. It has [Resistance](Sonstige/z_Content%20and%20Rules/variant-rules/resistance-xphb.md)\
      \ to all damage, except the damage it takes from sunlight."
    "name": "Shape-Shift"
  - "desc": "The vampire casts [Charm Person](Sonstige/z_Content%20and%20Rules/spells/charm-person-xphb.md),\
      \ requiring no spell components and using Charisma as the spellcasting ability\
      \ (spell save DC 17), and the duration is 24 hours. The [Charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
...
"regional_effects":
  - "desc": "The region containing a vampire's lair is warped by its presence, creating\
      ...
      \ smaller Beasts have the [Charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
      ...
      \ the vampire and its allies) that finishes a [Short Rest](Sonstige/z_Content%20and%20Rules/variant-rules/short-rest-xphb.md)\
      ...
      \ of the lair is [Lightly Obscured](Sonstige/z_Content%20and%20Rules/variant-rules/lightly-obscured-xphb.md)\
...
"legendary_actions":
  - "desc": "The vampire moves up to half its [Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md),\
      \ and it makes one Grave Strike attack."
    "name": "Deathless Strike"
  - "desc": "The vampire casts [Command](Sonstige/z_Content%20and%20Rules/spells/command-xphb.md),\
      \ requiring no spell components and using Charisma as the spellcasting ability\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/undead/token/vampire-xmm.webp"
```
^statblock
