...
"actions":
  ...
  - "desc": "The death tyrant randomly shoots one of the following magical rays at\
      ...
      \ target has the [Charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed)\
      ...
      \ take Reactions; its [Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md)\
      \ is halved; and it can take either an action or a [Bonus Action](Sonstige/z_Content%20and%20Rules/variant-rules/bonus-action-xphb.md)\
      ...
      \ has the [Restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained)\
      \ condition until the start of the death tyrant's next turn or until the death\
      \ tyrant has the [Incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated)\
      ...
      \ if it is a Construct or an Undead). *Failure:* The target has the [Unconscious](Sonstige/z_Content%20and%20Rules/conditions.md#Unconscious)\
...
"bonus_actions":
  - "desc": "The death tyrant's central eye emits an imperceptible, magical wave of\
      \ negative energy in a 150-foot [Cone](Sonstige/z_Content%20and%20Rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ Creatures in that area can't regain [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
      \ until the start of the death tyrant's next turn. An intact Humanoid corpse\
      \ there instantly rises as a [Zombie](Sonstige/z_Content%20and%20Rules/bestiary/undead/zombie-xmm.md)\
...
"regional_effects":
  - "desc": "The region containing a death tyrant's lair is warped by its presence,\
      ...
      \ from a spell, it subtracts 1d10 from the number of [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
      ...
      \ allies) that finishes a [Short Rest](Sonstige/z_Content%20and%20Rules/variant-rules/short-rest-xphb.md)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/undead/token/death-tyrant-xmm.webp"
```
^statblock
