...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +10 to hit, reach 5 ft., one target. *Hit:*\
      ...
      \ throws against the [frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened)\
      \ condition. This curse lasts until removed by the [Remove Curse](Sonstige/z_Content%20and%20Rules/spells/remove-curse-xphb.md)\
  ...
  - "desc": "The deathwolf creates a terrifying phantom of itself in the mind of a\
      ...
      \ on a DC 17 Intelligence saving throw or have the [frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened)\
      \ condition for 1 minute.\n\nWhile the target is [frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened),\
      \ the phantom deals 21 (6d6) psychic damage to the target at the start of\
      \ each of the target's turns. A [frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened)\
...
"source":
  - "VEoR"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/undead/token/deathwolf-veor.webp"
```
^statblock