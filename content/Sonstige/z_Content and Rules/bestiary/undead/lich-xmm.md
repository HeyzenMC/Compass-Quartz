...
"traits":
  ...
  - "desc": "If destroyed, the lich reforms in 1d10 days if it has a spirit jar,\
      \ reviving with all its [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md).\
...
"actions":
  ...
  - "desc": "The lich casts one of the following spells, using Intelligence as the\
      ...
      \ 5 version), [Invisibility](Sonstige/z_Content%20and%20Rules/spells/invisibility-xphb.md),\
      ...
      \n**1/day each:** [Chain Lightning](Sonstige/z_Content%20and%20Rules/spells/chain-lightning-xphb.md),\
    ...
    "name": "Spellcasting"
"reactions":
  - "desc": "The lich casts [Counterspell](Sonstige/z_Content%20and%20Rules/spells/counterspell-xphb.md)\
...
"regional_effects":
  - "desc": "The region containing a lich's lair is warped by its presence, creating\
      ...
      \ cast [Clairvoyance](Sonstige/z_Content%20and%20Rules/spells/clairvoyance-xphb.md),\
      ...
      \ by a True Resurrection or [Wish](Sonstige/z_Content%20and%20Rules/spells/wish-xphb.md)\
...
"legendary_actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 20, each creature that isn't an Undead\
      \ in a 20-foot [Emanation](Sonstige/z_Content%20and%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
    ...
    "name": "Disrupt Life"
  - "desc": "The lich casts [Fear](Sonstige/z_Content%20and%20Rules/spells/fear-xphb.md),\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/undead/token/lich-xmm.webp"
```
^statblock
