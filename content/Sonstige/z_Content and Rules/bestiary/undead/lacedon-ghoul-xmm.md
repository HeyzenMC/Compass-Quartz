...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 9 (2d6 + 2) Cold damage,\
      \ and the target's [Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md)\
  ...
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 4 (1d4 + 2) Slashing\
      ...
      \ target has the [Paralyzed](Sonstige/z_Content%20and%20Rules/conditions.md#Paralyzed)\
      \ condition until the end of its next turn."
    "name": "Claw"
"bonus_actions":
  - "desc": "While underwater, the ghoul moves up to half its [Swim Speed](Sonstige/z_Content%20and%20Rules/variant-rules/swim-speed-xphb.md)\
      \ without provoking [Opportunity Attacks](Sonstige/z_Content%20and%20Rules/actions.md#Opportunity%20Attack)."
    "name": "Watery Rush"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/undead/token/lacedon-ghoul-xmm.webp"
```
^statblock
