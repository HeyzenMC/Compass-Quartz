...
"traits":
  ...
  - "desc": "Creatures within 60 feet of the dracolich can't regain [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)."
    "name": "Life Suppression"
  - "desc": "The dracolich has [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md)\
  ...
  - "desc": "The dracolich has a magical gem. If the dracolich is destroyed while\
      ...
      \ body in 1d20 days, regaining all its [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
      \ and appearing within 5 feet of the gem.\n\nThe gem is a Tiny object that has\
      \ AC 20; HP 50; and [Immunity](Sonstige/z_Content%20and%20Rules/variant-rules/immunity-xphb.md)\
      \ to Necrotic, Poison, and Psychic damage. The gem regains all its [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md)\
      \ at the end of every turn, but it turns to dust if reduced to 0 [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md).\
...
"actions":
  - "desc": "The dracolich makes three Rend attacks. It can replace one attack with\
      \ a use of Spellcasting to cast [Ray of Sickness](Sonstige/z_Content%20and%20Rules/spells/ray-of-sickness-xphb.md)\
      \ (level 2 version)."
    "name": "Multiattack"
  - "desc": "*Melee Attack Roll:* +13, reach 10 ft. *Hit:* 18 (2d10 + 7) Slashing\
      \ damage plus 4 (1d8) Necrotic damage."
    "name": "Rend"
  - "desc": "*Constitution Saving Throw:* DC 20, each creature in a 60-foot [Cone](Sonstige/z_Content%20and%20Rules/variant-rules/cone-area-of-effect-xphb.md).\
  ...
  - "desc": "The dracolich casts one of the following spells, requiring no Material\
      ...
      \ (level 2 version)\n\n**1/day each:** [Create Undead](Sonstige/z_Content%20and%20Rules/spells/create-undead-xphb.md)\
      \ (level 8 version), [Finger of Death](Sonstige/z_Content%20and%20Rules/spells/finger-of-death-xphb.md)"
    "name": "Spellcasting"
"regional_effects":
  - "desc": "The region containing a dracolich's lair is warped by its presence, creating\
      ...
      \ lair is [Lightly Obscured](Sonstige/z_Content%20and%20Rules/variant-rules/lightly-obscured-xphb.md)\
      \ by pale fog. Whenever a creature other than the dracolich or one of its allies\
      \ finishes a [Long Rest](Sonstige/z_Content%20and%20Rules/variant-rules/long-rest-xphb.md)\
      \ in that area, it must succeed on a DC 15 Constitution saving throw or gain\
      \ 1 [Exhaustion](Sonstige/z_Content%20and%20Rules/conditions.md#Exhaustion)\
      \ level.  \n- **Soul Drain.** Creatures within 1 mile of the lair have [Disadvantage](Sonstige/z_Content%20and%20Rules/variant-rules/disadvantage-xphb.md)\
      \ on [Death Saving Throws](Sonstige/z_Content%20and%20Rules/variant-rules/death-saving-throw-xphb.md).\
...
"legendary_actions":
  - "desc": "The dracolich moves up to half its [Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md),\
      \ and it makes one Rend attack."
    "name": "Pounce"
  - "desc": "The dracolich uses Spellcasting to cast [Ray of Sickness](Sonstige/z_Content%20and%20Rules/spells/ray-of-sickness-xphb.md)\
      \ (level 2 version). The dracolich can't take this action again until the start\
      \ of its next turn."
    "name": "Sickening Ray"
  - "desc": "*Wisdom Saving Throw:* DC 19, each creature in a 30-foot [Emanation](Sonstige/z_Content%20and%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the dracolich. *Failure:* 11 (2d10) Psychic damage, and\
      \ the target has the [Frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened)\
      \ condition until the end of its next turn. *Failure or Success:* The dracolich\
      \ can't take this action again until the start of its next turn."
    "name": "Terrifying Presence"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/undead/token/dracolich-xmm.webp"
```
^statblock
