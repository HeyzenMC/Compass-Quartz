...
"traits":
  - "desc": "Whenever the bearer takes damage or makes a Strength or Dexterity saving\
      ...
      \ while berserk, the bearer has advantage on melee attack rolls, it can [Dash](Sonstige/z_Content%20and%20Rules/actions.md#Dash)\
...
"source":
  - "VEoR"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/undead/token/black-rose-bearer-veor.webp"
```
^statblock