...
"actions":
  ...
  - "desc": "*Constitution Saving Throw:* DC 12, each creature in a 20-foot-radius,\
      \ 40-foot-high [Cylinder](Sonstige/z_Content%20and%20Rules/variant-rules/cylinder-area-of-effect-xphb.md)\
  ...
  - "desc": "The lizardfolk casts one of the following spells, requiring no Material\
      ...
      \n**1/day each:** [Meld into Stone](Sonstige/z_Content%20and%20Rules/spells/meld-into-stone-xphb.md),\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/elemental/token/lizardfolk-geomancer-xmm.webp"
```
^statblock
