...
"actions":
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 4 (1d4 + 2) Slashing\
      \ damage."
    "name": "Claw"
  - "desc": "*Dexterity Saving Throw:* DC 10, each creature in a 15-foot [Cone](Sonstige/z_Content%20and%20Rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* The target has the [Blinded](Sonstige/z_Content%20and%20Rules/conditions.md#Blinded)\
      \ condition until the end of the mephit's next turn."
    "name": "Blinding Breath (Recharge 6)"
  - "desc": "The mephit casts the [Sleep](Sonstige/z_Content%20and%20Rules/spells/sleep-xphb.md)\
      \ spell, requiring no spell components and using Charisma as the spellcasting\
      \ ability (spell save DC 10).\n"
    "name": "Sleep (1/Day)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/elemental/token/dust-mephit-xmm.webp"
```
^statblock
