...
"cr": "5"
"traits":
  - "desc": "If the elemental takes Cold damage, its [Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md)\
...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 15, each creature in the elemental's space.\
      ...
      \ smaller creature, it has the [Grappled](Sonstige/z_Content%20and%20Rules/conditions.md#Grappled)\
      \ condition (escape DC 14). Until the grapple ends, the target has the [Restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained)\
      ...
      \ can pull a creature out of it by succeeding on a DC 14 Strength ([Athletics](Sonstige/z_Content%20and%20Rules/skills.md#Athletics))\
      \ check. *Success:* Half damage only."
    "name": "Whelm (Recharge 4-6)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/elemental/token/water-elemental-xmm.webp"
```
^statblock
