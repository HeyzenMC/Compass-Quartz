...
"cr": "1/4"
"traits":
  - "desc": "Attack rolls against the mephit are made with [Disadvantage](Sonstige/z_Content%20and%20Rules/variant-rules/disadvantage-xphb.md)\
      \ unless the mephit has the [Incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated)\
      \ condition."
    "name": "Blurred Form"
  - "desc": "The mephit explodes when it dies. *Dexterity Saving Throw:* DC 10, each\
      \ creature in a 5-foot [Emanation](Sonstige/z_Content%20and%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
"actions":
  - "desc": "*Melee Attack Roll:* +2, reach 5 ft. *Hit:* 2 (1d4) Slashing damage\
    ...
    "name": "Claw"
  - "desc": "*Constitution Saving Throw:* DC 10, each creature in a 15-foot [Cone](Sonstige/z_Content%20and%20Rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 5 (2d4) Fire damage, and the target's [Speed](Sonstige/z_Content%20and%20Rules/variant-rules/speed-xphb.md)\
      \ decreases by 10 feet until the end of the mephit's next turn. *Success:* Half\
      \ damage only. *Failure or Success:* Being underwater doesn't grant [Resistance](Sonstige/z_Content%20and%20Rules/variant-rules/resistance-xphb.md)\
      \ to this Fire damage."
    "name": "Steam Breath (Recharge 6)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/elemental/token/steam-mephit-xmm.webp"
```
^statblock
