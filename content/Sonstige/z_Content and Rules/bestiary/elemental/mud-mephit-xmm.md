...
"traits":
  - "desc": "The mephit explodes when it dies. *Dexterity Saving Throw:* DC 11, each\
      ...
      \ originating from the mephit. *Failure:* The target has the [Restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained)\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 11, one creature the mephit can see within\
      \ 15 feet. *Failure:* The target has the [Restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained)\
      \ condition until the end of the mephit's next turn."
    "name": "Mud Breath (Recharge 6)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/elemental/token/mud-mephit-xmm.webp"
```
^statblock
