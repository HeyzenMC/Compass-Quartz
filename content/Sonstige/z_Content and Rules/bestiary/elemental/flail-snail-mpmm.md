...
- "Flail Snail"
---
# [Flail Snail](Sonstige/z_Content%20and%20Rules/bestiary/elemental/flail-snail-mpmm.md)
...
Many hunters seek the shell for its antimagic properties. A skilled armorer can make three shields from one shell. For 1 month, each shield gives its wielder the snail's Antimagic Shell trait. When the shield's magic fades, it becomes an exotic shield that is the perfect item from which to make a [spellguard shield](Sonstige/z_Content%20and%20Rules/items/spellguard-shield-xdmg.md).

A flail snail shell can also be used to make a [robe of scintillating colors](Sonstige/z_Content%20and%20Rules/items/robe-of-scintillating-colors-xdmg.md). The shell is ground and added to the dye applied to the fabric. The powder is also a material component of the ritual that enchants the robe.
...
"actions":
  ...
  - "desc": "The snail's shell emits dazzling, colored light until the end of the\
      ...
      \ must succeed on a DC 15 Wisdom saving throw or be [stunned](Sonstige/z_Content%20and%20Rules/conditions.md#Stunned)\
  ...
  - "desc": "The flail snail withdraws into its shell. Until it emerges, it gains\
      \ a +4 bonus to its AC and is [restrained](Sonstige/z_Content%20and%20Rules/conditions.md#Restrained).\
      \ It can emerge from its shell as a bonus action on its turn."
    "name": "Shell Defense"
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/elemental/token/flail-snail-mpmm.webp"
```
^statblock
