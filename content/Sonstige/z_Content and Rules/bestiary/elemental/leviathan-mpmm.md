...
- "Leviathan"
---
# [Leviathan](Sonstige/z_Content%20and%20Rules/bestiary/elemental/leviathan-mpmm.md)
...
"actions":
  ...
  - "desc": "The leviathan magically creates a wave of water that extends from a point\
      ...
      \ bludgeoning damage and is knocked [prone](Sonstige/z_Content%20and%20Rules/conditions.md#Prone).\
      \ On a successful save, a creature takes half as much damage and isn't knocked\
      \ [prone](Sonstige/z_Content%20and%20Rules/conditions.md#Prone). The water spreads\
...
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20and%20Rules/bestiary/elemental/token/leviathan-mpmm.webp"
```
^statblock
