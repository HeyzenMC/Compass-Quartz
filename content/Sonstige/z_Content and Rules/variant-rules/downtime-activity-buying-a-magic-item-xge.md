...
|-------------|----------------|
| 1–5 | Roll `1d6` times on [Magic Item Table A](Sonstige/z_Content%20and%20Rules/tables/magic-item-table-a.md). |
| 6–10 | Roll `1d4` times on [Magic Item Table B](Sonstige/z_Content%20and%20Rules/tables/magic-item-table-b.md). |
| 11–15 | Roll `1d4` times on [Magic Item Table C](Sonstige/z_Content%20and%20Rules/tables/magic-item-table-c.md). |
| 16–20 | Roll `1d4` times on [Magic Item Table D](Sonstige/z_Content%20and%20Rules/tables/magic-item-table-d.md). |
| 21–25 | Roll `1d4` times on [Magic Item Table E](Sonstige/z_Content%20and%20Rules/tables/magic-item-table-e.md). |
| 26–30 | Roll `1d4` times on [Magic Item Table F](Sonstige/z_Content%20and%20Rules/tables/magic-item-table-f.md). |
| 31–35 | Roll `1d4` times on [Magic Item Table G](Sonstige/z_Content%20and%20Rules/tables/magic-item-table-g.md). |
| 36–40 | Roll `1d4` times on [Magic Item Table H](Sonstige/z_Content%20and%20Rules/tables/magic-item-table-h.md). |
| 41+ | Roll `1d4` times on [Magic Item Table I](Sonstige/z_Content%20and%20Rules/tables/magic-item-table-i.md). |
^buying-magic-items
...
![Magic Item Purchase Complications](Sonstige/z_Content%20and%20Rules/tables/magic-item-purchase-complications-xge.md)