...
The character makes three checks: Wisdom ([Insight](Sonstige/z_Content%20and%20Rules/skills.md#Insight)), Charisma ([Deception](Sonstige/z_Content%20and%20Rules/skills.md#Deception)), and Charisma ([Intimidation](Sonstige/z_Content%20and%20Rules/skills.md#Intimidation)). If the character has proficiency with an appropriate [gaming set](Sonstige/z_Content%20and%20Rules/items/gaming-set-xphb.md), that tool proficiency can replace the relevant skill in any of the checks. The DC for each of the checks is `5 + 2d10`; generate a separate DC for each one. Consult the Gambling Results table to see how the character did.

![Gambling Results](Sonstige/z_Content%20and%20Rules/tables/gambling-results-xge.md)
...
![Gambling Complications](Sonstige/z_Content%20and%20Rules/tables/gambling-complications-xge.md)