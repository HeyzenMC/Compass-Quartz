...
A condition doesn't stack with itself; a recipient either has a condition or doesn't. The [Exhaustion](Sonstige/z_Content%20and%20Rules/conditions.md#Exhaustion) condition is an exception to that rule.