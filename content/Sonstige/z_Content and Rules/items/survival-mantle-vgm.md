...
A creature wearing a survival mantle can breathe normally in any environment (including a vacuum) and has advantage on saving throws against harmful gases (such as those created by a [cloudkill](Sonstige/z_Content%20and%20Rules/spells/cloudkill-xphb.md) spell, a [stinking cloud](Sonstige/z_Content%20and%20Rules/spells/stinking-cloud-xphb.md) spell, inhaled poisons, and the breath weapons of some dragons).
