...
---
# Rod of Seven Parts
*Weapon ([quarterstaff](Sonstige/z_Content%20and%20Rules/items/quarterstaff-xphb.md)), rod, artifact (requires attunement)*  
![](Sonstige/z_Content%20and%20Rules/items/img/rod-of-seven-parts.webp#right)
...
Eons ago, a war between the primordials and the gods scarred the planes of existence. A demon lord named [Miska the Wolf-Spider](Sonstige/z_Content%20and%20Rules/bestiary/npc/miska-the-wolf-spider-veor.md) eventually pushed the primordials' enemies to the brink of annihilation.
...
| Piece | Spell |
|-------|-------|
| First | [Commune](Sonstige/z_Content%20and%20Rules/spells/commune-xphb.md) |
| Second | [Arcane Gate](Sonstige/z_Content%20and%20Rules/spells/arcane-gate-xphb.md) |
| Third | [Reverse Gravity](Sonstige/z_Content%20and%20Rules/spells/reverse-gravity-xphb.md) (spell save DC 18) |
| Fourth | [Regenerate](Sonstige/z_Content%20and%20Rules/spells/regenerate-xphb.md) |
| Fifth | [Find the Path](Sonstige/z_Content%20and%20Rules/spells/find-the-path-xphb.md) |
| Sixth | [Mirage Arcane](Sonstige/z_Content%20and%20Rules/spells/mirage-arcane-xphb.md) |
| Seventh | [Simulacrum](Sonstige/z_Content%20and%20Rules/spells/simulacrum-xphb.md) |
^rod-pieces
...
The Rod of Seven Parts has 7 charges and regains `1d4 + 3` expended charges daily at dawn. While holding the rod, you can use an action to expend 1 charge and cast any of the spells in the Rod Pieces table. You can also use an action to cast [Detect Evil and Good](Sonstige/z_Content%20and%20Rules/spells/detect-evil-and-good-xphb.md) from the rod without using any charges.
...
![A piece of the Rod of Seven Parts](Sonstige/z_Content%20and%20Rules/items/img/rod-of-seven-parts-piece.webp#center)
