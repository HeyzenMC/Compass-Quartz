...
![A Docent](Sonstige/z_Content%20and%20Rules/adventures/vecna-eve-of-ruin/img/070-04-004-docent.webp#right)
...
Whenever you end your turn with 0 hit points, the docent can make a Wisdom ([Medicine](Sonstige/z_Content%20and%20Rules/skills.md#Medicine)) check with a +6 bonus. If this check succeeds, the docent stabilizes you.
...
**Skills**. The docent has a +7 bonus to one of the following skills (roll a `d4`): (1) [Arcana](Sonstige/z_Content%20and%20Rules/skills.md#Arcana), (2) [History](Sonstige/z_Content%20and%20Rules/skills.md#History), (3) [Investigation](Sonstige/z_Content%20and%20Rules/skills.md#Investigation), or (4) [Nature](Sonstige/z_Content%20and%20Rules/skills.md#Nature).

**Spells**. The docent knows one of the following spells and can cast it at will, requiring no components (roll a `d6`): (1–2) [detect evil and good](Sonstige/z_Content%20and%20Rules/spells/detect-evil-and-good-xphb.md) or (3–6) [detect magic](Sonstige/z_Content%20and%20Rules/spells/detect-magic-xphb.md). The docent decides when to cast the spell.
