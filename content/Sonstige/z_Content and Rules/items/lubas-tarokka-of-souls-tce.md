...
![](Sonstige/z_Content%20and%20Rules/items/img/lubas-tarokka-of-souls.webp#right)
...
Created by a figure of Vistani legend, Luba's Tarokka of Souls shaped the destiny of countless heroes. The prophecies of this deck of cards also revealed great evils and guided its creator into the path of nefarious forces. Untold times the deck's creator, Mother Luba, narrowly escaped doom, spared only by her keen insights. But even for her, not all wickedness could be escaped. In the most dire cases, Mother Luba managed to ensnare beings of pure evil amid the strands of fate, imprisoning them within her [tarokka deck](Sonstige/z_Content%20and%20Rules/decks/tarokka-deck-rhw.md). There these foul spirits dwell still, trapped within a nether-realm hidden amid shuffling cards, waiting for fate to turn foul—as it inevitably will.

Like all [tarokka decks](Sonstige/z_Content%20and%20Rules/decks/tarokka-deck-rhw.md), the *Tarokka of Souls* is a lavishly illustrated collection of fifty-four cards, comprising the fourteen cards of the high deck and forty other cards divided into four suits: coins, glyphs, stars, and swords.

## Random Properties

The artifact has the following random properties, which you can determine by rolling on the tables in the "Artifacts" section of the "Dungeon Master's Guide":

- 2 [minor detrimental](Sonstige/z_Content%20and%20Rules/tables/artifact-properties-minor-detrimental-properties-xdmg.md) properties  
- 2 [minor beneficial](Sonstige/z_Content%20and%20Rules/tables/artifact-properties-minor-beneficial-properties-xdmg.md) properties  

## Spells

While holding the deck, you can use an action to cast one of the following spells (save DC 18) from it: [comprehend languages](Sonstige/z_Content%20and%20Rules/spells/comprehend-languages-xphb.md), [detect evil and good](Sonstige/z_Content%20and%20Rules/spells/detect-evil-and-good-xphb.md), [detect magic](Sonstige/z_Content%20and%20Rules/spells/detect-magic-xphb.md), [detect poison and disease](Sonstige/z_Content%20and%20Rules/spells/detect-poison-and-disease-xphb.md), [locate object](Sonstige/z_Content%20and%20Rules/spells/locate-object-xphb.md), or [scrying](Sonstige/z_Content%20and%20Rules/spells/scrying-xphb.md). Once you use the deck to cast a spell, you can't cast that spell again from it until the next dawn.

## Enduring Vision

While holding the deck, you automatically succeed on Constitution saving throws made to maintain your [concentration](Sonstige/z_Content%20and%20Rules/conditions.md#Concentration) on divination spells.
...
| dice: d100 | Card | Soul |
|------------|------|------|
| 1 | Artifact | [Flameskull](Sonstige/z_Content%20and%20Rules/bestiary/undead/flameskull-xmm.md) |
| 2 | Beast | [Wraith](Sonstige/z_Content%20and%20Rules/bestiary/undead/wraith-xmm.md) |
| 3 | Broken | [Banshee](Sonstige/z_Content%20and%20Rules/bestiary/undead/banshee-xmm.md) |
| 4 | Darklord | [Vampire](Sonstige/z_Content%20and%20Rules/bestiary/undead/vampire-xmm.md) |
| 5 | Donjon | [Mummy](Sonstige/z_Content%20and%20Rules/bestiary/undead/mummy-xmm.md) |
| 6 | Executioner | [Death knight](Sonstige/z_Content%20and%20Rules/bestiary/undead/death-knight-xmm.md) |
| 7 | Ghost | [Ghost](Sonstige/z_Content%20and%20Rules/bestiary/undead/ghost-xmm.md) |
| 8 | Horseman | [Mummy lord](Sonstige/z_Content%20and%20Rules/bestiary/undead/mummy-lord-xmm.md) |
| 9 | Innocent | [Ghost](Sonstige/z_Content%20and%20Rules/bestiary/undead/ghost-xmm.md) |
| 10 | Marionette | [Mummy](Sonstige/z_Content%20and%20Rules/bestiary/undead/mummy-xmm.md) |
| 11 | Mists | [Wraith](Sonstige/z_Content%20and%20Rules/bestiary/undead/wraith-xmm.md) |
| 12 | Raven | [Vampire spawn](Sonstige/z_Content%20and%20Rules/bestiary/undead/vampire-spawn-xmm.md) |
| 13 | Seer | [Vampire](Sonstige/z_Content%20and%20Rules/bestiary/undead/vampire-xmm.md) |
| 14 | Tempter | [Vampire spawn](Sonstige/z_Content%20and%20Rules/bestiary/undead/vampire-spawn-xmm.md) |
| 15-100 | — | — |
^souls-of-the-tarokka
...
Luba's Tarokka of Souls can be destroyed only if all fourteen souls within are released and destroyed. This reveals a fifteenth soul, a [lich](Sonstige/z_Content%20and%20Rules/bestiary/undead/lich-xmm.md), that inhabits the Nether card, which appears only when the fourteen souls are defeated. If this ancient entity is destroyed, the Nether card vanishes and the deck becomes a normal [tarokka deck](Sonstige/z_Content%20and%20Rules/decks/tarokka-deck-rhw.md), with no special properties, but it includes a new card of the DM's design.
