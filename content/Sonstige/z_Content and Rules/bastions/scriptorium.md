...
- **Craft.** Spell Scroll. You commission the facility's hireling to scribe a [Spell Scroll](Sonstige/z_Content%20and%20Rules/items/spell-scroll-xdmg.md) containing one Cleric or Wizard spell of level 3 or lower. The facility has the necessary [Calligrapher's Supplies](Sonstige/z_Content%20and%20Rules/items/calligraphers-supplies-xphb.md), and the hireling meets all the prerequisites needed to scribe the scroll. The ""Crafting Equipment"" section in the "Player's Handbook" specifies the time needed to scribe the scroll and the cost of the scroll, which you must pay.  
