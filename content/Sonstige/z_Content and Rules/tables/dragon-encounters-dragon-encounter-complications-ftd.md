...
| 5 | The dragon has a way to call for help hidden deep inside the lair, such as a magic horn that summons minions, an [iron flask](Sonstige/z_Content%20and%20Rules/items/iron-flask-xdmg.md) with a powerful Fiend inside, or a magic portal to an echo's lair. The characters must prevent the dragon from summoning aid or face a new threat. |
...
| 12 | A feature in the dragon's lair has an unpredictable magical effect, perhaps similar to a [wand of wonder](Sonstige/z_Content%20and%20Rules/items/wand-of-wonder-xdmg.md), a sorcerer's [Wild Magic Surge](Sonstige/z_Content%20and%20Rules/tables/wild-magic-surge-xphb.md), or a "dungeon trick" as described in the "Dungeon Master's Guide". The dragon avoids the feature unless the encounter is going badly, then either activates the feature or tries to goad the characters into doing so. |
