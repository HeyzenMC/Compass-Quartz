...
![A Blob of Annihilation attacks Sharn, the City of Towers, in the world of Eberron](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/021-02-001-blob-attack.webp#center)
...
As described in the "Player's Handbook", [alignment](Sonstige/z_Content%20and%20Rules/variant-rules/alignment-xphb.md) is a roleplaying tool. It is a quick way to describe a creature's moral and ethical orientation. Like other elements of the game, it's meant to be a tool to serve you and your game, not a constraint or burden. Alignment can help your game in three ways: as a tool for player characters, as a descriptor of a creature's demeanor, and as a summary of an organization's ethos.
...
A creature's alignment can help you determine the creature's attitude in an encounter. A Chaotic Evil monster is likely to be [Hostile](Sonstige/z_Content%20and%20Rules/variant-rules/hostile-attitude-xphb.md), while a Lawful Good one is more likely to have a [Friendly](Sonstige/z_Content%20and%20Rules/variant-rules/friendly-attitude-xphb.md) attitude, ready to help those in need.

#### Personality

"Chapter 2" of the "Player's Handbook" offers a [table of brief personality traits](Sonstige/z_Content%20and%20Rules/tables/alignment-and-personality-personality-traits-by-alignment-xphb.md) linked to alignment that can inspire you in playing an NPC or another monster in your game.
...
![An exciting chase nears its conclusion](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/022-02-002-party-gives-chase.webp#center)
...
Know the capabilities of the characters in your party before you make a chase an important feature of an adventure. A character with a high Speed or the right spell (such as [Dimension Door](Sonstige/z_Content%20and%20Rules/spells/dimension-door-xphb.md), [Fly](Sonstige/z_Content%20and%20Rules/spells/fly-xphb.md), or [Hold Monster](Sonstige/z_Content%20and%20Rules/spells/hold-monster-xphb.md)) can often end a chase before it begins.

### Beginning a Chase

A chase requires at least one quarry and at least one pursuer. Any participants not already in [Initiative](Sonstige/z_Content%20and%20Rules/variant-rules/initiative-xphb.md) order must roll Initiative as the chase begins. As in combat, each participant in the chase can take one action and move on its turn.
...
Participants in the chase are strongly motivated to take the [Dash](Sonstige/z_Content%20and%20Rules/actions.md#Dash) action every round. Pursuers who stop to cast spells and make attacks run the risk of losing their quarry, and a quarry that doesn't take the Dash action is likely to be caught.

#### Dashing

A chase participant can take the [Dash](Sonstige/z_Content%20and%20Rules/actions.md#Dash) action a number of times equal to 3 plus its Constitution modifier (minimum of once). Each additional Dash action it takes during the chase requires the creature to succeed on a DC 10 Constitution saving throw at the end of its turn or gain 1 [Exhaustion](Sonstige/z_Content%20and%20Rules/conditions.md#Exhaustion) level. A participant drops out of the chase if it has 5 [Exhaustion](Sonstige/z_Content%20and%20Rules/conditions.md#Exhaustion) levels. A creature can remove the [Exhaustion](Sonstige/z_Content%20and%20Rules/conditions.md#Exhaustion) levels it gained during the chase by finishing a [Short](Sonstige/z_Content%20and%20Rules/variant-rules/short-rest-xphb.md) or [Long Rest](Sonstige/z_Content%20and%20Rules/variant-rules/long-rest-xphb.md).

#### Spells and Attacks

A chase participant can make attacks and cast spells against other creatures within range.

Chase participants can't normally make [Opportunity Attacks](Sonstige/z_Content%20and%20Rules/actions.md#Opportunity%20Attack) against each other, since they are all assumed to be moving in the same direction at the same time. However, participants can still be the targets of [Opportunity Attacks](Sonstige/z_Content%20and%20Rules/actions.md#Opportunity%20Attack) from creatures not participating in the chase. For example, adventurers who chase a thief past a gang of ruffians might provoke [Opportunity Attacks](Sonstige/z_Content%20and%20Rules/actions.md#Opportunity%20Attack) from the ruffians.
...
If neither side gives up the chase, the quarry makes a Dexterity ([Stealth](Sonstige/z_Content%20and%20Rules/skills.md#Stealth)) check on Initiative count 0 each round, after every participant in the chase has taken its turn. If the quarry is never out of the lead pursuer's sight, the check fails automatically. Otherwise, compare the check's total to the [Passive Perception](Sonstige/z_Content%20and%20Rules/variant-rules/passive-perception-xphb.md) scores of the pursuers. If the quarry consists of multiple creatures, they all make the check separately, so it's possible for one quarry to escape while others remain in the chase.

The quarry can gain [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md) or [Disadvantage](Sonstige/z_Content%20and%20Rules/variant-rules/disadvantage-xphb.md) on its check based on the circumstances, as shown in the Escape Factors table.

![Ending a Chase; Escape Factors](Sonstige/z_Content%20and%20Rules/tables/ending-a-chase-escape-factors-xdmg.md)

Other factors might help or hinder the quarry's ability to escape, at your discretion. For example, a quarry with a [Faerie Fire](Sonstige/z_Content%20and%20Rules/spells/faerie-fire-xphb.md) spell cast on it might have Disadvantage on checks made to escape because it's much easier to spot.

If the total of the quarry's check is greater than the highest [Passive Perception](Sonstige/z_Content%20and%20Rules/variant-rules/passive-perception-xphb.md) score of the pursuers, the quarry escapes. If not, the chase continues for another round. Escape doesn't necessarily mean the quarry has outpaced its pursuers. For example, in a city, escape might mean the quarry ducked into a crowd or slipped around a corner, leaving no clue as to where it went.
...
![An ill-advised attempt to steal Xanathar's pet goldfish, Sylgar, leads to a heated chase](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/023-02-003-sylgar-theft.webp#center)
...
Characters can create their own complications to shake off pursuers or slow their quarry (for example, casting the [Web](Sonstige/z_Content%20and%20Rules/spells/web-xphb.md) spell in a narrow alleyway). Adjudicate these at your discretion.

![Urban Chase Complications](Sonstige/z_Content%20and%20Rules/tables/urban-chase-complications-xdmg.md)

![Wilderness Chase Complications](Sonstige/z_Content%20and%20Rules/tables/wilderness-chase-complications-xdmg.md)
...
![You might alter the Sailor background to reflect a character's youth on the seas of Greyhawk](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/024-02-004-seas-of-greyhawk.webp#center)
...
![Baba Yaga invents a new creature—a fire-breathing Giant Toad!](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/025-02-005-baba-yaga.webp#center)
...
You can alter a creature's size and creature type as you please. For example, you can use an [Ogre](Sonstige/z_Content%20and%20Rules/bestiary/giant/ogre-xmm.md) stat block for a human bully—just make it a Medium Humanoid instead of a Large Giant.

#### Ability Scores

You can usually change a creature's Intelligence, Wisdom, and Charisma scores freely unless the ability is used for spellcasting. For example, a [Black Pudding](Sonstige/z_Content%20and%20Rules/bestiary/ooze/black-pudding-xmm.md) stat block could represent a sapient alien if you raise its Intelligence and Charisma to 10 or so. It's usually best to leave its Strength, Dexterity, and Constitution scores alone, as changes to these scores can alter a monster's attack bonus, damage, [Armor Class](Sonstige/z_Content%20and%20Rules/variant-rules/armor-class-xphb.md), or [Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/hit-points-xphb.md), which in turn can alter its [Challenge Rating](Sonstige/z_Content%20and%20Rules/variant-rules/challenge-rating-xphb.md).

#### Languages

You can change any or all of the languages the creature knows. You might want to add languages if you've made a creature sapient that wasn't before. You can also add or remove [telepathy](Sonstige/z_Content%20and%20Rules/variant-rules/telepathy-xphb.md) or other forms of communication.

#### Proficiencies

You can give a creature any skill proficiencies you want and give it [Expertise](Sonstige/z_Content%20and%20Rules/variant-rules/expertise-xphb.md) if you want it to be very skilled. If you want a creature to be good at hiding, give it Expertise in the [Stealth](Sonstige/z_Content%20and%20Rules/skills.md#Stealth) skill. If its keen senses make it an excellent tracker or otherwise adept at finding hidden foes, give it Expertise in the [Perception](Sonstige/z_Content%20and%20Rules/skills.md#Perception) skill. (You can also increase its Wisdom, as noted above.)

You can also swap a monster's saving throw proficiencies. If it has none, you can add one or two.

#### Senses

[Blindsight](Sonstige/z_Content%20and%20Rules/senses.md#Blindsight), [Darkvision](Sonstige/z_Content%20and%20Rules/senses.md#Darkvision), [Tremorsense](Sonstige/z_Content%20and%20Rules/senses.md#Tremorsense), and [Truesight](Sonstige/z_Content%20and%20Rules/senses.md#Truesight) have no bearing on a creature's Challenge Rating. You can add or remove them freely.
...
You can freely change the name and flavor of an attack, as well as its damage type. For example, you can turn an ordinary [Skeleton](Sonstige/z_Content%20and%20Rules/bestiary/undead/skeleton-xmm.md) into an ice skeleton that deals Cold damage as it accosts characters with a blade of ice or hurls shards of ice at them.

#### Resistances and Immunities

If a creature doesn't have [Resistance](Sonstige/z_Content%20and%20Rules/variant-rules/resistance-xphb.md) or [Immunity](Sonstige/z_Content%20and%20Rules/variant-rules/immunity-xphb.md) to one or more damage types, you can give it Resistance or Immunity to one or two damage types. You can also change the damage type of its existing Resistances and Immunities.
...
You can also use traits from other stat blocks in the "Monster Manual", provided you don't add traits that alter a creature's Hit Points, confer [Temporary Hit Points](Sonstige/z_Content%20and%20Rules/variant-rules/temporary-hit-points-xphb.md), or change the amount of damage the creature deals to other creatures.

#### Creature Traits

- **Aversion to Fire.** If the creature takes Fire damage, it has [Disadvantage](Sonstige/z_Content%20and%20Rules/variant-rules/disadvantage-xphb.md) on attack rolls and ability checks until the end of its next turn.  
- **Battle Ready.** The creature has [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md) on [Initiative](Sonstige/z_Content%20and%20Rules/variant-rules/initiative-xphb.md) rolls.  
- **Beast Whisperer.** The creature can communicate with Beasts as if they shared a common language.  
- **Death Jinx.** When the creature dies, one random creature within 10 feet of the dead creature is targeted by a [Bane](Sonstige/z_Content%20and%20Rules/spells/bane-xphb.md) spell (save DC 13), which lasts for its full duration.  
- **Dimensional Disruption.** Disruptive energy extends from the creature in a 30-foot [Emanation](Sonstige/z_Content%20and%20Rules/variant-rules/emanation-area-of-effect-xphb.md). Other creatures can't teleport to or from a space in that area. Any attempt to do so is wasted.  
- **Disciple of the Nine Hells.** When the creature dies, its body disgorges a [Hostile](Sonstige/z_Content%20and%20Rules/variant-rules/hostile-attitude-xphb.md) [Imp](Sonstige/z_Content%20and%20Rules/bestiary/fiend/imp-xmm.md) in the same space.  
...
- **Emissary of Juiblex.** When the creature dies, its body disgorges a [Hostile](Sonstige/z_Content%20and%20Rules/variant-rules/hostile-attitude-xphb.md) [Ochre Jelly](Sonstige/z_Content%20and%20Rules/bestiary/ooze/ochre-jelly-xmm.md) in the same space.  
- **Fey Ancestry.** The creature has Advantage on saving throws it makes to avoid or end the [Charmed](Sonstige/z_Content%20and%20Rules/conditions.md#Charmed) condition, and magic can't put it to sleep.  
- **Forbiddance.** The creature can't enter a residence without an invitation from one of its occupants.  
- **Gloom Shroud.** Imperceptible energy channeled from the "Shadowfell" extends from the creature in a 20-foot [Emanation](Sonstige/z_Content%20and%20Rules/variant-rules/emanation-area-of-effect-xphb.md). Other creatures in that area have [Disadvantage](Sonstige/z_Content%20and%20Rules/variant-rules/disadvantage-xphb.md) on Charisma checks and Charisma saving throws.  
- **Light.** The creature sheds [Bright Light](Sonstige/z_Content%20and%20Rules/variant-rules/bright-light-xphb.md) in a 10-foot radius and [Dim Light](Sonstige/z_Content%20and%20Rules/variant-rules/dim-light-xphb.md) for an additional 10 feet. As a [Bonus Action](Sonstige/z_Content%20and%20Rules/variant-rules/bonus-action-xphb.md), the creature can suppress this light or cause it to return. The light winks out if the creature dies.  
- **Mimicry.** The creature can mimic Beast sounds and Humanoid voices. A creature that hears the sounds can tell they are imitations with a successful DC 14 Wisdom ([Insight](Sonstige/z_Content%20and%20Rules/skills.md#Insight)) check.  
- **Poison Tolerant.** The creature has Advantage on saving throws it makes to avoid or end the [Poisoned](Sonstige/z_Content%20and%20Rules/conditions.md#Poisoned) condition.  
...
- **Slaad Host.** When the creature dies, a [Hostile](Sonstige/z_Content%20and%20Rules/variant-rules/hostile-attitude-xphb.md) [Slaad Tadpole](Sonstige/z_Content%20and%20Rules/bestiary/aberration/slaad-tadpole-xmm.md) bursts from its innards in the same space.  
- **Steadfast.** The creature has [Immunity](Sonstige/z_Content%20and%20Rules/variant-rules/immunity-xphb.md) to the [Frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened) condition while it can see an ally within 30 feet of itself.  
...
- **Warrior's Wrath.** The creature has Advantage on melee attack rolls against any [Bloodied](Sonstige/z_Content%20and%20Rules/conditions.md#Bloodied) creature.  
...
One capability can replace a similar one. For example, a [Potion of Climbing](Sonstige/z_Content%20and%20Rules/items/potion-of-climbing-xdmg.md) could become a *Potion of Swimming*.

#### Altered Form

You can alter a magic item's form while leaving its properties intact. For example, you can turn a [Ring of the Ram](Sonstige/z_Content%20and%20Rules/items/ring-of-the-ram-xdmg.md) into a wand or a [Cloak of Protection](Sonstige/z_Content%20and%20Rules/items/cloak-of-protection-xdmg.md) into some other worn object (such as a circlet) without altering the item's properties.

#### Altered Damage Types

An item that deals damage of one type could instead deal damage of another type. For example, a [Flame Tongue](Sonstige/z_Content%20and%20Rules/items/flame-tongue-xdmg.md) sword could deal Lightning damage instead of Fire damage.

#### Combining Items

You can merge the properties of two magic items of the same rarity into a single item, provided no more than one of them requires [Attunement](Sonstige/z_Content%20and%20Rules/variant-rules/attunement-xphb.md). For example, you could combine the properties of a [Helm of Comprehending Languages](Sonstige/z_Content%20and%20Rules/items/helm-of-comprehending-languages-xdmg.md) with those of a [Helm of Telepathy](Sonstige/z_Content%20and%20Rules/items/helm-of-telepathy-xdmg.md) into a single helmet. This makes the item more powerful (and probably increases its rarity), but it won't break your game.
...
A magic item should either let a character do something they couldn't do before or improve the character's ability to do something they can do already. For example, a [Ring of Jumping](Sonstige/z_Content%20and%20Rules/items/ring-of-jumping-xdmg.md) lets its wearer jump greater distances, thus augmenting what a character can already do. A [Ring of the Ram](Sonstige/z_Content%20and%20Rules/items/ring-of-the-ram-xdmg.md), however, gives a character the ability to deal Force damage.
...
![Power Level; Magic Item Power by Rarity](Sonstige/z_Content%20and%20Rules/tables/power-level-magic-item-power-by-rarity-xdmg.md)
...
If the item grants a bonus that other items also grant, it's a good idea to require [Attunement](Sonstige/z_Content%20and%20Rules/variant-rules/attunement-xphb.md) so characters don't try to collect too many of those items.

## Creating a Spell

![Ringlerun's spell research leads in unexpected directions as he unintentionally creates a flying gelatinous cubelet](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/026-02-006-ringlerun-researching.webp#center)
...
![Spell Damage](Sonstige/z_Content%20and%20Rules/tables/spell-damage-xdmg.md)
...
![The curse of demonic possession has devastating effects](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/027-02-007-demonic-possession.webp#center)

Every curse has rules that govern it. A curse typically takes one of the forms detailed below.

#### Bestow Curse

The simplest curses are created by the [Bestow Curse](Sonstige/z_Content%20and%20Rules/spells/bestow-curse-xphb.md) spell. The effects of such curses are limited and can be ended by the [Remove Curse](Sonstige/z_Content%20and%20Rules/spells/remove-curse-xphb.md) spell.
...
You decide how a spell like [Remove Curse](Sonstige/z_Content%20and%20Rules/spells/remove-curse-xphb.md) affects a creature with accursed origins. For example, you might decide that a mummy was created through a curse and it can be destroyed permanently only by casting *Remove Curse* on its corpse.
...
A creature affected by such a curse should know why they're being punished and be able to learn how to end their curse, likely by symbolically righting the wrong they committed. How a spell like [Remove Curse](Sonstige/z_Content%20and%20Rules/spells/remove-curse-xphb.md) affects a curse that's part of your adventure is up to you—the spell might merely suppress the effects of the curse for a time. Regardless, narrative curses should feel like rare, potent magic rooted in the lore of your campaign.
...
- [Cackle Fever](Sonstige/z_Content%20and%20Rules/diseases.md#Cackle%20Fever)  
- [Sewer Plague](Sonstige/z_Content%20and%20Rules/diseases.md#Sewer%20Plague)  
- [Sight Rot](Sonstige/z_Content%20and%20Rules/diseases.md#Sight%20Rot)  
...
![Sometimes death—even the death of an entire party—is just a passage to new adventures](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/028-02-008-death-passage.webp#center)
...
The character has 1 Hit Point and the [Unconscious](Sonstige/z_Content%20and%20Rules/conditions.md#Unconscious) condition. The character can regain Hit Points as normal, but the character remains Unconscious until they are targeted by a [Greater Restoration](Sonstige/z_Content%20and%20Rules/spells/greater-restoration-xphb.md) spell or experience a sudden awakening (see below).
...
You can also reward a player who describes a memory or something else occupying the dying character's thoughts with [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md) on the Death Save.
...
It's also possible for dead characters to be brought back to life. The most common way is through spells such as [Revivify](Sonstige/z_Content%20and%20Rules/spells/revivify-xphb.md) and [Raise Dead](Sonstige/z_Content%20and%20Rules/spells/raise-dead-xphb.md). It's up to you to decide how easy it is for characters to access those spells if they can't cast them. The "Player's Handbook" offers suggested prices for [spellcasting services](Sonstige/z_Content%20and%20Rules/tables/spellcasting-services-xphb.md).
...
A powerful individual finds the adventurers' bodies and has them raised from the dead, putting the adventurers in the debt of their rescuer. What if the adventurers wake up decades after their death, returned to life by a [Resurrection](Sonstige/z_Content%20and%20Rules/spells/resurrection-xphb.md) spell cast by someone who believed they had an important role to play in this future era?
...
With the [Utilize](Sonstige/z_Content%20and%20Rules/actions.md#Utilize) action, a creature can try to force open a door that is barred or locked, doing so with a successful Strength ([Athletics](Sonstige/z_Content%20and%20Rules/skills.md#Athletics)) check. The table provides the DC of the check. For bigger doors, double or triple the Hit Points and increase the DC of the check by 5.

![Doors](Sonstige/z_Content%20and%20Rules/tables/doors-xdmg.md)

#### Barred Door

A barred door has no lock. A creature on the barred side of the door can take the [Utilize](Sonstige/z_Content%20and%20Rules/actions.md#Utilize) action to lift the bar from its braces, allowing the door to be opened.

#### Locked Door

Characters who don't have the key to a locked door can try to pick the lock using [Thieves' Tools](Sonstige/z_Content%20and%20Rules/items/thieves-tools-xphb.md). The Lock Complexity table tells you how long it takes to try to pick a lock based on its complexity. At the end of that time, the character picks the lock by making a successful Dexterity ([Sleight of Hand](Sonstige/z_Content%20and%20Rules/skills.md#Sleight%20of%20Hand)) check using Thieves' Tools. The DC is determined by the lock's quality, as shown in the Lock Quality table.

![Locked Door; Lock Complexity](Sonstige/z_Content%20and%20Rules/tables/locked-door-lock-complexity-xdmg.md)

![Locked Door; Lock Quality](Sonstige/z_Content%20and%20Rules/tables/locked-door-lock-quality-xdmg.md)
...
With the [Search](Sonstige/z_Content%20and%20Rules/actions.md#Search) action, a character can search for a secret door along a 10-foot-square section of wall and make a Wisdom ([Perception](Sonstige/z_Content%20and%20Rules/skills.md#Perception)) check. On a successful check, the character finds any secret door hidden in that section of wall as well as the mechanism to open the door. The DC of the check depends on how well the secret door is hidden, as shown in the Secret Doors table.

You can instead call for an Intelligence ([Investigation](Sonstige/z_Content%20and%20Rules/skills.md#Investigation)) check if the challenge involves deducing that a door is present from noticeable clues, rather than spotting those clues in the first place. See ""Perception"" in "chapter 2" for more advice.

![Secret Doors](Sonstige/z_Content%20and%20Rules/tables/secret-doors-xdmg.md)
...
Typically made of iron or wood, a portcullis blocks a passage or an archway until it is raised into the ceiling by a winch and chain. Creatures within 5 feet of a lowered portcullis can make ranged attacks or cast spells through it, and they have [Three-Quarters Cover](Sonstige/z_Content%20and%20Rules/tables/cover-xphb.md) against attacks, spells, and other effects originating from the opposite side. A portcullis can also be attacked and destroyed, using the AC and Hit Points of a metal door (if iron) or a wooden door (if wood).

Winching a portcullis up or down requires the [Utilize](Sonstige/z_Content%20and%20Rules/actions.md#Utilize) action. If a creature can't reach the winch (usually because it's on the other side of the portcullis), lifting the portcullis requires the [Utilize](Sonstige/z_Content%20and%20Rules/actions.md#Utilize) action and a successful Strength ([Athletics](Sonstige/z_Content%20and%20Rules/skills.md#Athletics)) check. The DC of the check depends on the type of portcullis, as shown in the Portcullises table.

![Portcullises](Sonstige/z_Content%20and%20Rules/tables/portcullises-xdmg.md)
...
![Dungeons; Dungeon Quirks](Sonstige/z_Content%20and%20Rules/tables/dungeons-dungeon-quirks-xdmg.md)

### Mapping a Dungeon

![A dungeon built by giants offers enormous adventures](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/029-02-009-giants-dungeon.webp#center)
...
When you design a guard post, decide how many guards are on duty, note their [Passive Perception](Sonstige/z_Content%20and%20Rules/variant-rules/passive-perception-xphb.md) scores, and decide what they do when they notice intruders (see ""Monster Behavior"" in "chapter 4"). Some will rush headlong into a fight, while others will negotiate, sound an alarm, or flee to get help.
...
Sapient creatures often have laboratories, workshops, libraries, forges, and studios. Because such areas tend to contain valuable equipment, their doors are often locked and sometimes even warded by [Glyph of Warding](Sonstige/z_Content%20and%20Rules/spells/glyph-of-warding-xphb.md) spells and similar effects.

### Dungeon Decay

The States of Ruin table can help you determine the general conditions of a dungeon area.

![Dungeon Decay; States of Ruin](Sonstige/z_Content%20and%20Rules/tables/dungeon-decay-states-of-ruin-xdmg.md)

## Environmental Effects

![A friendly bronze dragon keeps a watchful eye on a storm-tossed ship](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/030-02-010-bronze-dragon-v-ship.webp#center)
...
- [Dead Magic Zone](Sonstige/z_Content%20and%20Rules/traps-hazards/dead-magic-zone-xdmg.md)  
- [Deep Water](Sonstige/z_Content%20and%20Rules/traps-hazards/deep-water-xdmg.md)  
- [Extreme Cold](Sonstige/z_Content%20and%20Rules/traps-hazards/extreme-cold-xdmg.md)  
- [Extreme Heat](Sonstige/z_Content%20and%20Rules/traps-hazards/extreme-heat-xdmg.md)  
- [Frigid Water](Sonstige/z_Content%20and%20Rules/traps-hazards/frigid-water-xdmg.md)  
- [Heavy Precipitation](Sonstige/z_Content%20and%20Rules/traps-hazards/heavy-precipitation-xdmg.md)  
- [High Altitude](Sonstige/z_Content%20and%20Rules/traps-hazards/high-altitude-xdmg.md)  
- [Planar Effects](Sonstige/z_Content%20and%20Rules/traps-hazards/planar-effects-xdmg.md)  
- [Slippery Ice](Sonstige/z_Content%20and%20Rules/traps-hazards/slippery-ice-xdmg.md)  
- [Strong Wind](Sonstige/z_Content%20and%20Rules/traps-hazards/strong-wind-xdmg.md)  
- [Thin Ice](Sonstige/z_Content%20and%20Rules/traps-hazards/thin-ice-xdmg.md)  
- [Wild Magic Zone](Sonstige/z_Content%20and%20Rules/traps-hazards/wild-magic-zone-xdmg.md)  
...
Whenever the characters encounter something that is supernaturally frightful, use the [Frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened) condition as the baseline effect. Fear effects typically require a Wisdom saving throw, with a save DC set based on how terrifying the situation is. The Sample Fear DCs table provides some examples.

![Fear Effects; Sample Fear DCs](Sonstige/z_Content%20and%20Rules/tables/fear-effects-sample-fear-dcs-xdmg.md)

Typically, a [Frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened) creature repeats the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
- The Frightened creature must take the [Dash](Sonstige/z_Content%20and%20Rules/actions.md#Dash) action on each of its turns and uses its movement to get farther away from the source of its fear.  
- Attack rolls against the Frightened creature have [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md).  
...
![Sample Mental Stress Effects](Sonstige/z_Content%20and%20Rules/tables/sample-mental-stress-effects-xdmg.md)
...
The character has the [Frightened](Sonstige/z_Content%20and%20Rules/conditions.md#Frightened), [Incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated), or [Stunned](Sonstige/z_Content%20and%20Rules/conditions.md#Stunned) condition for `1d10` minutes. This condition might be accompanied by alarming behavior or hallucinations. These effects can be suppressed with the [Calm Emotions](Sonstige/z_Content%20and%20Rules/spells/calm-emotions-xphb.md) spell or removed by the [Lesser Restoration](Sonstige/z_Content%20and%20Rules/spells/lesser-restoration-xphb.md) spell.

##### Long-Term Effects

The character has [Disadvantage](Sonstige/z_Content%20and%20Rules/variant-rules/disadvantage-xphb.md) on some or all ability checks for `1d10 × 10` hours, stemming from an unwillingness or inability to exert a particular set of abilities. The character might feel enervated and unable to exert much Strength, for example, or become so suspicious of others that Charisma checks are more difficult. These effects can be suppressed with the Calm Emotions spell or removed by the Lesser Restoration spell.

##### Indefinite Effects

An indefinite effect is a long-term effect (see above) that lasts until removed by a [Greater Restoration](Sonstige/z_Content%20and%20Rules/spells/greater-restoration-xphb.md) spell. It can be suppressed by a Calm Emotions spell.

![Fight, flight, or freeze?](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/031-02-011-fight-flight-or-freeze.webp#center)
...
![When faced with a troll, there's no time to figure out the right way to hold a shotgun](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/032-02-012-troll-v-firearms.webp#center)
...
Firearm Bullets are destroyed upon use in a modern firearm. Futuristic firearms use Energy Cells that become depleted but could possibly be recharged with the proper equipment, at your discretion. An [Energy Cell](Sonstige/z_Content%20and%20Rules/items/energy-cell-xdmg.md) weighs 1/2 lb.

![Firearms](Sonstige/z_Content%20and%20Rules/tables/firearms-xdmg.md)
...
As an action, you can either throw a grenade at a point up to 60 feet away or use a Grenade Launcher to propel the grenade to a point up to 1,000 feet away. The grenade explodes at that point, creating a particular effect in a 20-foot-radius [Sphere](Sonstige/z_Content%20and%20Rules/variant-rules/sphere-area-of-effect-xphb.md).

#### Fragmentation Grenade

Each creature in the [Sphere](Sonstige/z_Content%20and%20Rules/variant-rules/sphere-area-of-effect-xphb.md) makes a DC 15 Dexterity saving throw, taking 17 (`5d6`) Piercing damage on a failed save or half as much damage on a successful one.

#### Smoke Grenade

The area of the [Sphere](Sonstige/z_Content%20and%20Rules/variant-rules/sphere-area-of-effect-xphb.md) is [Heavily Obscured](Sonstige/z_Content%20and%20Rules/variant-rules/heavily-obscured-xphb.md) by smoke for 1 minute. A strong wind (such as the [Gust of Wind](Sonstige/z_Content%20and%20Rules/spells/gust-of-wind-xphb.md) spell) disperses the smoke.

#### Gunpowder

Setting fire to a container full of Gunpowder causes it to explode. When a container explodes, each creature in a 10-foot-radius [Sphere](Sonstige/z_Content%20and%20Rules/variant-rules/sphere-area-of-effect-xphb.md) centered on the container makes a DC 12 Dexterity saving throw, taking 10 (`3d6`) Fire damage (for a powder horn) or 24 (`7d6`) Fire damage (for a keg) on a failed save or half as much damage on a successful one.

### Alien Technology

When adventurers find a piece of technology that isn't from their world or time period, they can deduce what it is with a successful Intelligence ([Investigation](Sonstige/z_Content%20and%20Rules/skills.md#Investigation)) check, with the DC depending on the complexity of the item: DC 10 for a relatively simple item like a calculator or a lighter, or DC 20 for a complex item such as a computer, a chainsaw, or a hovercraft. You may require a separate Intelligence ([Investigation](Sonstige/z_Content%20and%20Rules/skills.md#Investigation)) check to determine whether a character can activate or operate the technology; a character who has observed the item in use or has operated a similar item either has [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md) on the check or succeeds on the check automatically (your choice).
...
**Titans** are the creations of deities. They might be manufactured on a divine forge, born from the blood spilled by a god, or otherwise brought about through divine will or substance. Some titans, including [krakens](Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/kraken-xmm.md) and the [tarrasque](Sonstige/z_Content%20and%20Rules/bestiary/monstrosity/tarrasque-xmm.md), appear in the "Monster Manual".
...
The "Player's Handbook" describes common hazards that adventurers encounter, such as [falling](Sonstige/z_Content%20and%20Rules/traps-hazards/falling-xphb.md) and [dehydration](Sonstige/z_Content%20and%20Rules/traps-hazards/dehydration-xphb.md). This section details some more unusual hazards you can add to a location to make it more challenging.
...
- [Brown Mold](Sonstige/z_Content%20and%20Rules/traps-hazards/brown-mold-xdmg.md)  
- [Fireball Fungus](Sonstige/z_Content%20and%20Rules/traps-hazards/fireball-fungus-xdmg.md)  
- [Green Slime](Sonstige/z_Content%20and%20Rules/traps-hazards/green-slime-xdmg.md)  
- [Inferno](Sonstige/z_Content%20and%20Rules/traps-hazards/inferno-xdmg.md)  
- [Poisonous Gas](Sonstige/z_Content%20and%20Rules/traps-hazards/poisonous-gas-xdmg.md)  
- [Quicksand Pit](Sonstige/z_Content%20and%20Rules/traps-hazards/quicksand-pit-xdmg.md)  
- [Razorvine](Sonstige/z_Content%20and%20Rules/traps-hazards/razorvine-xdmg.md)  
- [River Styx](Sonstige/z_Content%20and%20Rules/traps-hazards/river-styx-xdmg.md)  
- [Rockslide](Sonstige/z_Content%20and%20Rules/traps-hazards/rockslide-xdmg.md)  
- [Vicious Vine](Sonstige/z_Content%20and%20Rules/traps-hazards/vicious-vine-xdmg.md)  
- [Webs](Sonstige/z_Content%20and%20Rules/traps-hazards/webs-xdmg.md)  
- [Yellow Mold](Sonstige/z_Content%20and%20Rules/traps-hazards/yellow-mold-xdmg.md)  

![](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/035-02-015-spiders.webp#center)
...
![Fortifications; Maintenance Costs](Sonstige/z_Content%20and%20Rules/tables/fortifications-maintenance-costs-xdmg.md)
...
![Queen Yolande of Celene is grateful for adventurers' aid](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/036-02-016-queen-yolande.webp#center)
...
Whenever you would otherwise make a number of [D20 Tests](Sonstige/z_Content%20and%20Rules/variant-rules/d20-test-xphb.md) for identical monsters, the Mob Results table can help you determine the number of successful [D20 Tests](Sonstige/z_Content%20and%20Rules/variant-rules/d20-test-xphb.md) the monsters get without having to roll dice. Follow these steps:

- **Step 1.** Determine the minimum `d20` roll the monsters need to succeed on the [D20 Test](Sonstige/z_Content%20and%20Rules/variant-rules/d20-test-xphb.md) using the following formula:  

**Roll needed** = target number−monster's bonus

- **Step 2.** Find the roll needed on the Mob Results table. If all the monsters have [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md) on the roll (for example, if they're attacking and have the Pack Tactics trait, or if they're making a saving throw against a spell and have the Magic Resistance trait), find the roll needed in the With Advantage column. If all the monsters have [Disadvantage](Sonstige/z_Content%20and%20Rules/variant-rules/disadvantage-xphb.md) (for example, if they're attacking a creature protected by the [Blur](Sonstige/z_Content%20and%20Rules/spells/blur-xphb.md) spell), use the With Disadvantage column. Otherwise, use the Normal column.  
- **Step 3.** Read across the table to find a fractional number of successes you can easily apply to the group of monsters. That's the fraction of monsters that succeed on the [D20 Test](Sonstige/z_Content%20and%20Rules/variant-rules/d20-test-xphb.md).  

![Average Results; Mob Results](Sonstige/z_Content%20and%20Rules/tables/average-results-mob-results-xdmg.md)

### Adjudicating Areas of Effect

When the characters are fighting a large number of monsters, it's not always practical to use miniatures on a battle grid or some other visual aid. So how do you determine how many monsters are affected by the Wizard's [Fireball](Sonstige/z_Content%20and%20Rules/spells/fireball-xphb.md) spell or some other area of effect?
...
Your judgment always outweighs these guidelines, and it's fine to err on the side of affecting more creatures. For example, if eight zombies are crowded around a Fighter when the Bard centers a [Shatter](Sonstige/z_Content%20and%20Rules/spells/shatter-xphb.md) spell on the Fighter's space, the spell's area should definitely engulf all eight zombies, even though according to the table, a 10-foot-radius [Sphere](Sonstige/z_Content%20and%20Rules/variant-rules/sphere-area-of-effect-xphb.md) includes only three creatures.

![Adjudicating Areas of Effect; Targets in Area of Effect](Sonstige/z_Content%20and%20Rules/tables/adjudicating-areas-of-effect-targets-in-area-of-effect-xdmg.md)
...
Eight [Zombies](Sonstige/z_Content%20and%20Rules/bestiary/undead/zombie-xmm.md) surround and attack a Fighter. The zombies' attack bonus is +3, and the Fighter's AC is 18, so the roll needed is 15 (18−3). Finding 15 in the "Normal" column and reading across to the "Out of 8" column, the DM gets a result of 2/8—two of the zombies hit. Using the zombies' average damage (4 Bludgeoning damage), the Fighter takes 8 Bludgeoning damage.

After seeing the Fighter mauled by zombies, the Bard casts [Shatter](Sonstige/z_Content%20and%20Rules/spells/shatter-xphb.md), centering the spell on the Fighter. (The Bard trusts that the Fighter will succeed on the Constitution saving throw and survive the resulting damage.) The spell affects a 10-foot-radius [Sphere](Sonstige/z_Content%20and%20Rules/variant-rules/sphere-area-of-effect-xphb.md), and the Targets in Area of Effect table suggests that such an area should encompass three zombies. However, the DM decides that all eight zombies (and the Fighter) are affected. The zombies' Constitution saving throw bonus is +3, and the Bard's spell saving throw DC is 16, so the roll needed is 13 (16−3). Finding 13 in the "Normal" column and reading across to the "Out of 8" column, the DM gets a result of 3/8, so three of the zombies succeed on their saving throws.

Seeing a larger crowd of zombies in the distance, the Wizard casts [Fireball](Sonstige/z_Content%20and%20Rules/spells/fireball-xphb.md). The spell covers a 20-foot-radius Sphere. The Targets in Area of Effect table suggests that area covers ten zombies, but the DM rules that they're densely packed together and adds `1d3`, rolling a 2. So the spell engulfs twelve zombies in its area. The zombies' Dexterity saving throw modifier is −2, and the Wizard's spell save DC is 16, so the roll needed is 18 (16−[−2]). Finding 18 in the Normal column and reading across to the Out of 6 column, the DM gets a result of 1/6. Twelve times 1/6 is 2, so two of the twelve zombies succeed on the save.
...
![Nonplayer Characters come in all shapes and sizes](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/037-02-017-nonplayer-characters.webp#center)
...
![1: Common Names](Sonstige/z_Content%20and%20Rules/tables/1-common-names-xdmg.md)

![2: Guttural Names](Sonstige/z_Content%20and%20Rules/tables/2-guttural-names-xdmg.md)

![3: Lyrical Names](Sonstige/z_Content%20and%20Rules/tables/3-lyrical-names-xdmg.md)

![4: Monosyllabic Names](Sonstige/z_Content%20and%20Rules/tables/4-monosyllabic-names-xdmg.md)

![5: Sinister Names](Sonstige/z_Content%20and%20Rules/tables/5-sinister-names-xdmg.md)

![6: Whimsical Names](Sonstige/z_Content%20and%20Rules/tables/6-whimsical-names-xdmg.md)

#### Stat Block

![](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/038-02-018-lone-npc.webp#center)
...
Choose the NPC's [alignment](Sonstige/z_Content%20and%20Rules/variant-rules/alignment-xphb.md), which can help you sketch the outlines of an NPC's behavior and personality. See the "Player's Handbook" and ""Alignment"" in this chapter for more information.
...
For example, if you find the adventurers unexpectedly arguing with a Lawful Neutral guard, you might create a cooperative but laconic guard who is happy to help the adventurers but speaks curtly, hoping to end the conversation as quickly as possible. Or, looking at the [Imp](Sonstige/z_Content%20and%20Rules/bestiary/fiend/imp-xmm.md) stat block in the "Player's Handbook" and noting its highest ability (Dexterity) and its lowest (Strength), you might decide that the little devil is fidgety and indirect, constantly on the move and talking in circles to get to its point
...
![NPC Appearance](Sonstige/z_Content%20and%20Rules/tables/npc-appearance-xdmg.md)

#### Secret

Describe a secret the NPC is trying to hide or protect. The NPC Secrets table provides several ideas.

![NPC Secrets](Sonstige/z_Content%20and%20Rules/tables/npc-secrets-xdmg.md)

![Download PDF](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/039-02-019-npc-tracker-sheet.webp#center)
...
You can use different stat blocks in the "Monster Manual", perhaps with some tweaks, to reflect the same NPC at different times as they grow over the course of a campaign. For example, characters on their very first adventure might face a villain who uses the stat block of a [Mage Apprentice](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/mage-apprentice-xmm.md), only to have that villain escape and return many adventures later to haunt them as a [Mage](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/mage-xmm.md). Still later, the same villain might reappear as an [Archmage](Sonstige/z_Content%20and%20Rules/bestiary/humanoid/archmage-xmm.md). Of course, the trick here is making sure that the villain survives from one adventure to the next, or at least coming up with a plausible way for the villain to return from death. After all, death is rarely the final word for adventurers, so it needn't be for their opponents.
...
![As a member of another group of heroes, Niko first joined Sheila, Diana, Eric, and Presto as an NPC healer](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/040-02-020-npc-healer.webp#center)
...
If the characters own or operate a sailing ship or similar vessel, you can use these rules to track the loyalty of individual crew members or the ship's crew as a whole. If at least half the crew's Loyalty Scores drop to 0 during a voyage, the crew turns [Hostile](Sonstige/z_Content%20and%20Rules/variant-rules/hostile-attitude-xphb.md) and stages a mutiny. If the ship is berthed, disloyal crew members leave the ship and never return.

## Poison

Given their insidious and deadly nature, poisons are a favorite tool among assassins and evil creatures.

![Zarak applies poison to his dagger](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/041-02-021-zarak-poison-dagger.webp#center)

Poisons come in the following four types:

- **Contact.** Contact poison can be smeared on an object and remains potent until it is touched or washed off. A creature that touches contact poison with exposed skin suffers its effects.  
- **Ingested.** A creature must swallow an entire dose of ingested poison to suffer its effects. The dose can be delivered in food or a liquid. You may decide that a partial dose has a reduced effect, such as allowing [Advantage](Sonstige/z_Content%20and%20Rules/variant-rules/advantage-xphb.md) on the saving throw or dealing only half as much damage on a failed save.  
- **Inhaled.** Poisonous powders and gases take effect when inhaled. Blowing the powder or releasing the gas subjects creatures in a 5-foot [Cube](Sonstige/z_Content%20and%20Rules/variant-rules/cube-area-of-effect-xphb.md) to its effect. The resulting cloud dissipates immediately afterward. Holding one's breath is ineffective against inhaled poisons, as they affect nasal membranes, tear ducts, and other parts of the body.  
...
A character can attempt to harvest poison from a venomous creature that is dead or has the [Incapacitated](Sonstige/z_Content%20and%20Rules/conditions.md#Incapacitated) condition. The effort takes `1d6` minutes, after which the character makes a DC 20 Intelligence ([Nature](Sonstige/z_Content%20and%20Rules/skills.md#Nature)) check using a [Poisoner's Kit](Sonstige/z_Content%20and%20Rules/items/poisoners-kit-xphb.md). On a successful check, the character harvests enough poison for a single dose, and no additional poison can be harvested from that creature. On a failed check, the character is unable to extract any poison. If the character fails the check by 5 or more, the character is subjected to the creature's poison.
...
- [Assassin's Blood](Sonstige/z_Content%20and%20Rules/items/assassins-blood-xdmg.md)  
- [Burnt Othur Fumes](Sonstige/z_Content%20and%20Rules/items/burnt-othur-fumes-xdmg.md)  
- [Carrion Crawler Mucus](Sonstige/z_Content%20and%20Rules/items/carrion-crawler-mucus-xdmg.md)  
- [Essence of Ether](Sonstige/z_Content%20and%20Rules/items/essence-of-ether-xdmg.md)  
- [Lolth's Sting](Sonstige/z_Content%20and%20Rules/items/lolths-sting-xdmg.md)  
- [Malice](Sonstige/z_Content%20and%20Rules/items/malice-xdmg.md)  
- [Midnight Tears](Sonstige/z_Content%20and%20Rules/items/midnight-tears-xdmg.md)  
- [Oil of Taggit](Sonstige/z_Content%20and%20Rules/items/oil-of-taggit-xdmg.md)  
- [Pale Tincture](Sonstige/z_Content%20and%20Rules/items/pale-tincture-xdmg.md)  
- [Purple Worm Poison](Sonstige/z_Content%20and%20Rules/items/purple-worm-poison-xdmg.md)  
- [Serpent Venom](Sonstige/z_Content%20and%20Rules/items/serpent-venom-xdmg.md)  
- [Torpor](Sonstige/z_Content%20and%20Rules/items/torpor-xdmg.md)  
- [Truth Serum](Sonstige/z_Content%20and%20Rules/items/truth-serum-xdmg.md)  
- [Wyvern Poison](Sonstige/z_Content%20and%20Rules/items/wyvern-poison-xdmg.md)  
...
![Level-Based Renown](Sonstige/z_Content%20and%20Rules/tables/level-based-renown-xdmg.md)

## Settlements

![Life in a city is full of fantastical surprises!](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/042-02-022-city-life.webp#center)
...
![Settlement Tables and Tracker; Defining Traits](Sonstige/z_Content%20and%20Rules/tables/settlement-tables-and-tracker-defining-traits-xdmg.md)

![Settlement Tables and Tracker; Claims to Fame](Sonstige/z_Content%20and%20Rules/tables/settlement-tables-and-tracker-claims-to-fame-xdmg.md)

![Settlement Tables and Tracker; Current Calamities](Sonstige/z_Content%20and%20Rules/tables/settlement-tables-and-tracker-current-calamities-xdmg.md)

![Settlement Tables and Tracker; Local Leaders](Sonstige/z_Content%20and%20Rules/tables/settlement-tables-and-tracker-local-leaders-xdmg.md)

![Settlement Tables and Tracker; Tavern Names](Sonstige/z_Content%20and%20Rules/tables/settlement-tables-and-tracker-tavern-names-xdmg.md)

![Settlement Tables and Tracker; Random Shops](Sonstige/z_Content%20and%20Rules/tables/settlement-tables-and-tracker-random-shops-xdmg.md)

![](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/043-02-023-flagon-with-coins.webp#center)

![Download PDF](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/044-02-024-settlement-tracker-sheet.webp#center)
...
- [Ballista](Sonstige/z_Content%20and%20Rules/objects/ballista-xdmg.md)  
- [Cannon](Sonstige/z_Content%20and%20Rules/objects/cannon-xdmg.md)  
- [Flamethrower Coach](Sonstige/z_Content%20and%20Rules/objects/flamethrower-coach-xdmg.md)  
- [Lightning Cannon](Sonstige/z_Content%20and%20Rules/objects/lightning-cannon-xdmg.md)  
- [Mangonel](Sonstige/z_Content%20and%20Rules/objects/mangonel-xdmg.md)  
- [Ram](Sonstige/z_Content%20and%20Rules/objects/ram-xdmg.md)  
- [Siege Tower](Sonstige/z_Content%20and%20Rules/objects/siege-tower-xdmg.md)  
- [Suspended Cauldron](Sonstige/z_Content%20and%20Rules/objects/suspended-cauldron-xdmg.md)  
- [Trebuchet](Sonstige/z_Content%20and%20Rules/objects/trebuchet-xdmg.md)  

## Supernatural Gifts

![A magical creature like a unicorn might bestow a supernatural gift](Sonstige/z_Content%20and%20Rules/books/dungeon-masters-guide-2024/img/047-02-027-unicorn.webp#center)
...
There is no limit on the number of Blessings a character can receive, but it should be rare for a character to have more than one at a time. Moreover, a character can't benefit from multiple instances of a Blessing at the same time. For example, a character can't benefit from two instances of the [Blessing of Health](Sonstige/z_Content%20and%20Rules/rewards/blessing-of-health-xdmg.md) at once.

You can easily create more Blessings by mimicking the properties of a Wondrous Item.

- [Blessing of Health](Sonstige/z_Content%20and%20Rules/rewards/blessing-of-health-xdmg.md)  
- [Blessing of Magic Resistance](Sonstige/z_Content%20and%20Rules/rewards/blessing-of-magic-resistance-xdmg.md)  
- [Blessing of Protection](Sonstige/z_Content%20and%20Rules/rewards/blessing-of-protection-xdmg.md)  
- [Blessing of Understanding](Sonstige/z_Content%20and%20Rules/rewards/blessing-of-understanding-xdmg.md)  
- [Blessing of Valhalla](Sonstige/z_Content%20and%20Rules/rewards/blessing-of-valhalla-xdmg.md)  
- [Blessing of Weapon Enhancement](Sonstige/z_Content%20and%20Rules/rewards/blessing-of-weapon-enhancement-xdmg.md)  
- [Blessing of Wound Closure](Sonstige/z_Content%20and%20Rules/rewards/blessing-of-wound-closure-xdmg.md)  
...
Some Charms can be used only once; others can be used a specific number of times before vanishing. If a Charm lets a character cast a spell, the character can do so without expending a spell slot or providing any spell components. Unless otherwise stated, the spell uses its normal casting time, range, and duration; if the spell requires [Concentration](Sonstige/z_Content%20and%20Rules/conditions.md#Concentration), the character must concentrate.

A Charm can't be removed from a creature by anything short of divine intervention or a [Wish](Sonstige/z_Content%20and%20Rules/spells/wish-xphb.md) spell. A character can't benefit from multiple instances of a Charm at the same time.

A typical Charm mimics the effects of a Potion or spell, so it is easy to create more Charms of your own.

- [Charm of Animal Conjuring](Sonstige/z_Content%20and%20Rules/rewards/charm-of-animal-conjuring-xdmg.md)  
- [Charm of Darkvision](Sonstige/z_Content%20and%20Rules/rewards/charm-of-darkvision-xdmg.md)  
- [Charm of Feather Falling](Sonstige/z_Content%20and%20Rules/rewards/charm-of-feather-falling-xdmg.md)  
- [Charm of Heroism](Sonstige/z_Content%20and%20Rules/rewards/charm-of-heroism-xdmg.md)  
- [Charm of Restoration](Sonstige/z_Content%20and%20Rules/rewards/charm-of-restoration-xdmg.md)  
- [Charm of the Slayer](Sonstige/z_Content%20and%20Rules/rewards/charm-of-the-slayer-xdmg.md)  
- [Charm of Vitality](Sonstige/z_Content%20and%20Rules/rewards/charm-of-vitality-xdmg.md)  
...
- [Collapsing Roof](Sonstige/z_Content%20and%20Rules/traps-hazards/collapsing-roof-xdmg.md)  
- [Falling Net](Sonstige/z_Content%20and%20Rules/traps-hazards/falling-net-xdmg.md)  
- [Fire-Casting Statue](Sonstige/z_Content%20and%20Rules/traps-hazards/fire-casting-statue-xdmg.md)  
- [Hidden Pit](Sonstige/z_Content%20and%20Rules/traps-hazards/hidden-pit-xdmg.md)  
- [Poisoned Darts](Sonstige/z_Content%20and%20Rules/traps-hazards/poisoned-darts-xdmg.md)  
- [Poisoned Needle](Sonstige/z_Content%20and%20Rules/traps-hazards/poisoned-needle-xdmg.md)  
- [Rolling Stone](Sonstige/z_Content%20and%20Rules/traps-hazards/rolling-stone-xdmg.md)  
- [Spiked Pit](Sonstige/z_Content%20and%20Rules/traps-hazards/spiked-pit-xdmg.md)  
...
![Building Your Own Traps; Building a Trap](Sonstige/z_Content%20and%20Rules/tables/building-your-own-traps-building-a-trap-xdmg.md)