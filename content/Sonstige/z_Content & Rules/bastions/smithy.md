...
- **Craft.** Smith's Tools. The facility's hirelings craft anything that can be made with [Smith's Tools](Sonstige/z_Content%20&%20Rules/items/smiths-tools-xphb.md), using the rules in the "Player's Handbook".  
