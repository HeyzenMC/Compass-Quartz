...
A character with the noble background can mingle with the upper class, but other characters can do so only if you judge that the character has made sufficient contacts. Alternatively, a character might use a [disguise kit](Sonstige/z_Content%20&%20Rules/items/disguise-kit-xphb.md) and the [Deception](Sonstige/z_Content%20&%20Rules/skills.md#Deception) skill to pass as a noble visiting from a distant city.

## Resolution

After a workweek of carousing, a character stands to make contacts within the selected social class. The character makes a Charisma ([Persuasion](Sonstige/z_Content%20&%20Rules/skills.md#Persuasion)) check using the Carousing table.

![Carousing](Sonstige/z_Content%20&%20Rules/tables/carousing-xge.md)
...
![Lower-Class Carousing Complications](Sonstige/z_Content%20&%20Rules/tables/lower-class-carousing-complications-xge.md)

![Middle-Class Carousing Complications](Sonstige/z_Content%20&%20Rules/tables/middle-class-carousing-complications-xge.md)

![Upper-Class Carousing Complications](Sonstige/z_Content%20&%20Rules/tables/upper-class-carousing-complications-xge.md)