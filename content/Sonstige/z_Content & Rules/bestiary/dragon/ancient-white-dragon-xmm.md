...
"traits":
  - "desc": "The dragon can move across and climb icy surfaces without needing to\
      \ make an ability check. Additionally, [Difficult Terrain](Sonstige/z_Content%20&%20Rules/variant-rules/difficult-terrain-xphb.md)\
...
"regional_effects":
  - "desc": "The region containing an adult or ancient white dragon's lair is affected\
      ...
      \ area within 1 mile of the lair is an area of [extreme cold](Sonstige/z_Content%20&%20Rules/traps-hazards/extreme-cold-xdmg.md).\
      \ Any water in that area is [frigid water](Sonstige/z_Content%20&%20Rules/traps-hazards/frigid-water-xdmg.md).\
      \ See the \"Dungeon Master's Guide\" for rules on extreme cold and frigid water.\
      \  \n- **Glacial Gloom.** The area within 1 mile of the lair is [Lightly Obscured](Sonstige/z_Content%20&%20Rules/variant-rules/lightly-obscured-xphb.md)\
      ...
      \ or have its [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md)\
...
"legendary_actions":
  - "desc": "*Constitution Saving Throw:* DC 20, each creature in a 30-foot-radius\
      ...
      \ Cold damage, and the target's [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md)\
  ...
  - "desc": "The dragon moves up to half its [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md),\
    ...
    "name": "Pounce"
  - "desc": "The dragon casts [Fear](Sonstige/z_Content%20&%20Rules/spells/fear-xphb.md),\
      \ requiring no Material components and using Charisma as the spellcasting ability\
      \ (spell save DC 18). The dragon can't take this action again until the start\
      \ of its next turn.\n"
    "name": "Frightful Presence"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/dragon/token/ancient-white-dragon-xmm.webp"
```
^statblock
