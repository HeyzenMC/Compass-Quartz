...
"traits":
  - "desc": "The mimic adheres to anything that touches it. A Huge or smaller creature\
      \ adhered to the mimic has the [Grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled)\
...
"actions":
  - "desc": "*Melee Attack Roll:* +5 (with [Advantage](Sonstige/z_Content%20&%20Rules/variant-rules/advantage-xphb.md)\
      ...
      \ + 3) Piercing damage if the target is [Grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/monstrosity/token/mimic-xmm.webp"
```
^statblock
