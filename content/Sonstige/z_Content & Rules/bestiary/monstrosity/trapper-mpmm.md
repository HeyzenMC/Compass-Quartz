...
- "Trapper"
---
# [Trapper](Sonstige/z_Content%20&%20Rules/bestiary/monstrosity/trapper-mpmm.md)
...
"traits":
  - "desc": "If the trapper is motionless on a floor, wall, or ceiling at the start\
      ...
      \ 18 Intelligence ([Investigation](Sonstige/z_Content%20&%20Rules/skills.md#Investigation))\
...
"actions":
  - "desc": "One Large or smaller creature within 10 feet of the trapper must succeed\
      \ on a DC 13 Dexterity saving throw or be [grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled)\
      ...
      \ [grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled) in this\
      \ way, the target is [restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained),\
      \ [blinded](Sonstige/z_Content%20&%20Rules/conditions.md#Blinded), and deprived\
      \ of air. The trapper can smother only one creature at a time."
    "name": "Smother"
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/monstrosity/token/trapper-mpmm.webp"
```
^statblock
