...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 12 (2d8 + 3) Piercing\
      ...
      \ cursed target drops to 0 [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md),\
      \ it instead becomes a Weretiger under the DM's control and has 10 [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md).\
...
"bonus_actions":
  - "desc": "The weretiger moves up to its [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md)\
      \ without provoking [Opportunity Attacks](Sonstige/z_Content%20&%20Rules/actions.md#Opportunity%20Attack).\
      \ At the end of this movement, the weretiger can take the [Hide](Sonstige/z_Content%20&%20Rules/actions.md#Hide)\
      \ action."
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/monstrosity/token/weretiger-xmm.webp"
```
^statblock
