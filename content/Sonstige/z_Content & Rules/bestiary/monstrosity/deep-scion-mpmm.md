...
- "Deep Scion"
---
# [Deep Scion](Sonstige/z_Content%20&%20Rules/bestiary/monstrosity/deep-scion-mpmm.md)
...
"actions":
  ...
  - "desc": "The deep scion emits a terrible scream audible within 300 feet. Creatures\
      ...
      \ or be [stunned](Sonstige/z_Content%20&%20Rules/conditions.md#Stunned) until\
      \ the end of the deep scion's next turn. In water, the psychic screech also\
      \ telepathically transmits the deep scion's memories of the last 24 hours to\
      \ its master, regardless of distance, so long as it and its master are in the\
      \ same body of water."
...
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/monstrosity/token/deep-scion-mpmm.webp"
```
^statblock
