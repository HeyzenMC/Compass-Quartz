...
"cr": "2"
"traits":
  - "desc": "The ankheg can burrow through solid rock at half its [Burrow Speed](Sonstige/z_Content%20&%20Rules/variant-rules/burrow-speed-xphb.md)\
...
"actions":
  - "desc": "*Melee Attack Roll:* +5 (with [Advantage](Sonstige/z_Content%20&%20Rules/variant-rules/advantage-xphb.md)\
      ...
      \ Acid damage. If the target is a Large or smaller creature, it has the [Grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/monstrosity/token/ankheg-xmm.webp"
```
^statblock
