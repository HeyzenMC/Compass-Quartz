...
- "Meazel"
---
# [Meazel](Sonstige/z_Content%20&%20Rules/bestiary/monstrosity/meazel-mpmm.md)
...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target of the meazel's\
      ...
      \ DC 13 with disadvantage). Until the grapple ends, the target takes 10 (2d6\
      \ + 3) bludgeoning damage at the start of each of the meazel's turns. The meazel\
  ...
  - "desc": "The meazel, any equipment it is wearing or carrying, and any creature\
      ...
      \ becomes cursed for 1 hour or until the curse is ended by [remove curse](Sonstige/z_Content%20&%20Rules/spells/remove-curse-xphb.md)\
      \ or [greater restoration](Sonstige/z_Content%20&%20Rules/spells/greater-restoration-xphb.md).\
...
"bonus_actions":
  - "desc": "While in dim light or darkness, the meazel takes the [Hide](Sonstige/z_Content%20&%20Rules/actions.md#Hide)\
      \ action."
    "name": "Shadow Stealth"
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/monstrosity/token/meazel-mpmm.webp"
```
^statblock
