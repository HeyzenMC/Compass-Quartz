...
---
# [Draconian Infiltrator](Sonstige/z_Content%20&%20Rules/bestiary/monstrosity/draconian-infiltrator-ftd.md)
...
"actions":
  - "desc": "The draconian makes two Dagger attacks. If both attacks hit the same\
      ...
      \ become [poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned) until\
      \ the end of the target's next turn. While [poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned)\
      \ in this way, the target is also [paralyzed](Sonstige/z_Content%20&%20Rules/conditions.md#Paralyzed)."
    "name": "Multiattack"
...
"source":
  - "FTD"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/monstrosity/token/draconian-infiltrator-ftd.webp"
```
^statblock