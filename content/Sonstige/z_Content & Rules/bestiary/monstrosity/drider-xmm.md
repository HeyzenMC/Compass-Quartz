...
"traits":
  - "desc": "The drider can climb difficult surfaces, including along ceilings, without\
    ...
    "name": "Spider Climb"
  - "desc": "While in sunlight, the drider has [Disadvantage](Sonstige/z_Content%20&%20Rules/variant-rules/disadvantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Ranged Attack Roll:* +6, range 120 ft. *Hit:* 13 (3d6 + 3) Poison\
    ...
    "name": "Poison Burst"
"bonus_actions":
  - "desc": "The drider casts [Darkness](Sonstige/z_Content%20&%20Rules/spells/darkness-xphb.md),\
      \ [Faerie Fire](Sonstige/z_Content%20&%20Rules/spells/faerie-fire-xphb.md),\
      \ or [Web](Sonstige/z_Content%20&%20Rules/spells/web-xphb.md), requiring no\
      \ Material components and using Wisdom as the spellcasting ability (spell save\
      \ DC 14).\n"
    "name": "Magic of the Spider Queen (Recharge 5-6)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/monstrosity/token/drider-xmm.webp"
```
^statblock
