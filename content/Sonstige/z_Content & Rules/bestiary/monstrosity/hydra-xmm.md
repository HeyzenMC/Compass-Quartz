...
"traits":
  ...
  - "desc": "The hydra has five heads. Whenever the hydra takes 25 damage or more\
    ...
    "name": "Multiple Heads"
  - "desc": "For each head the hydra has beyond one, it gets an extra [Reaction](Sonstige/z_Content%20&%20Rules/variant-rules/reaction-xphb.md)\
      \ that can be used only for [Opportunity Attacks](Sonstige/z_Content%20&%20Rules/actions.md#Opportunity%20Attack)."
    "name": "Reactive Heads"
"actions":
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/monstrosity/token/hydra-xmm.webp"
```
^statblock
