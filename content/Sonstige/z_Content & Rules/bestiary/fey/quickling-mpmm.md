...
"cr": "1"
"traits":
  - "desc": "Attack rolls against the quickling have disadvantage unless it is [incapacitated](Sonstige/z_Content%20&%20Rules/conditions.md#Incapacitated)\
      \ or its speed is 0."
  ...
  - "desc": "If the quickling is subjected to an effect that allows it to make a Dexterity\
      ...
      \ on the saving throw and only half damage if it fails, provided it isn't [incapacitated](Sonstige/z_Content%20&%20Rules/conditions.md#Incapacitated)."
    "name": "Evasion"
"actions":
...
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fey/token/quickling-mpmm.webp"
```
^statblock
