...
- "Annis Hag"
---
# [Annis Hag](Sonstige/z_Content%20&%20Rules/bestiary/fey/annis-hag-mpmm.md)
...
Much as annis hags befriend children in order to corrupt them, they may adopt a group of ogres, trolls, or other creatures ([ogres](Sonstige/z_Content%20&%20Rules/bestiary/giant/ogre-xmm.md) and [trolls](Sonstige/z_Content%20&%20Rules/bestiary/giant/troll-xmm.md)), ruling them through brute strength, insults, and superstition.
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 36\
      \ (9d6 + 5) bludgeoning damage, and the target is [grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled)\
  ...
  - "desc": "The hag casts one of the following spells, using Charisma as the spellcasting\
      \ ability (spell save DC 13):\n\n**3/day each:** [disguise self](Sonstige/z_Content%20&%20Rules/spells/disguise-self-xphb.md)\
      \ (including the form of a Medium Humanoid), [Fog cloud](Sonstige/z_Content%20&%20Rules/spells/fog-cloud-xphb.md)"
    "name": "Spellcasting"
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fey/token/annis-hag-mpmm.webp"
```
^statblock
