...
"cr": "1"
"traits":
  - "desc": "The dryad has [Advantage](Sonstige/z_Content%20&%20Rules/variant-rules/advantage-xphb.md)\
...
"actions":
  - "desc": "The dryad makes one Vine Lash or Thorn Burst attack, and it can use Spellcasting\
      \ to cast [Charm Monster](Sonstige/z_Content%20&%20Rules/spells/charm-monster-xphb.md)."
    "name": "Multiattack"
  ...
  - "desc": "The dryad casts one of the following spells, requiring no Material components\
      ...
      \ will:** [Animal Friendship](Sonstige/z_Content%20&%20Rules/spells/animal-friendship-xphb.md),\
      \ [Charm Monster](Sonstige/z_Content%20&%20Rules/spells/charm-monster-xphb.md)\
      \ (lasts 24 hours; ends early if the dryad casts the spell again), [Druidcraft](Sonstige/z_Content%20&%20Rules/spells/druidcraft-xphb.md)\n\
      \n**1/day each:** [Entangle](Sonstige/z_Content%20&%20Rules/spells/entangle-xphb.md),\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fey/token/dryad-xmm.webp"
```
^statblock
