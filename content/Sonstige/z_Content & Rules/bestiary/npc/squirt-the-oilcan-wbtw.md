...
- "Squirt the Oilcan"
---
# [Squirt the Oilcan](Sonstige/z_Content%20&%20Rules/bestiary/npc/squirt-the-oilcan-wbtw.md)
...
"traits":
  - "desc": "If Squirt is motionless at the start of combat, it has advantage on its\
      ...
      \ that creature must succeed on a DC 18 Intelligence ([Investigation](Sonstige/z_Content%20&%20Rules/skills.md#Investigation))\
...
"actions":
  ...
  - "desc": "Squirt expends 1 application of boggle oil to create a 10-foot-square\
      ...
      \ saving throw or fall [prone](Sonstige/z_Content%20&%20Rules/conditions.md#Prone).\
...
"source":
  - "WBtW"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/npc/token/squirt-the-oilcan-wbtw.webp"
```
^statblock