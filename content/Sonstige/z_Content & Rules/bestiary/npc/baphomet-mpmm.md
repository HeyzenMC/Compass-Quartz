...
- "Baphomet"
---
# [Baphomet](Sonstige/z_Content%20&%20Rules/bestiary/npc/baphomet-mpmm.md)
...
Baphomet's lair is his palace, the Lyktion, which is on the layer of the Abyss called the Endless Maze. Nestled within the twisting passages of the plane-wide labyrinth, the Lyktion is immaculately maintained and surrounded by a moat constructed in the fashion of a three-dimensional maze. The palace is a towering structure whose interior is as labyrinthine as the plane on which it stands; it is populated by [minotaurs](Sonstige/z_Content%20&%20Rules/bestiary/monstrosity/minotaur-of-baphomet-xmm.md), [goristros](Sonstige/z_Content%20&%20Rules/bestiary/fiend/goristro-xmm.md), and [quasits](Sonstige/z_Content%20&%20Rules/bestiary/fiend/quasit-xmm.md).
...
"traits":
  - "desc": "Baphomet can perfectly recall any path he has traveled, and he is immune\
      \ to the [maze](Sonstige/z_Content%20&%20Rules/spells/maze-xphb.md) spell."
...
"actions":
  ...
  - "desc": "Each creature of Baphomet's choice within 120 feet of him and aware of\
      \ him must succeed on a DC 18 Wisdom saving throw or become [frightened](Sonstige/z_Content%20&%20Rules/conditions.md#Frightened)\
      \ for 1 minute. A [frightened](Sonstige/z_Content%20&%20Rules/conditions.md#Frightened)\
  ...
  - "desc": "Baphomet casts one of the following spells, requiring no material components\
      ...
      \ each:** [dispel magic](Sonstige/z_Content%20&%20Rules/spells/dispel-magic-xphb.md),\
      \ [dominate beast](Sonstige/z_Content%20&%20Rules/spells/dominate-beast-xphb.md),\
      \ [maze](Sonstige/z_Content%20&%20Rules/spells/maze-xphb.md), [wall of stone](Sonstige/z_Content%20&%20Rules/spells/wall-of-stone-xphb.md)\n\
...
"legendary_actions":
  ...
  - "desc": "Baphomet moves up to his speed without provoking [opportunity attacks](Sonstige/z_Content%20&%20Rules/actions.md#Opportunity%20Attack),\
      \ then makes a Gore attack."
    "name": "Charge (Costs 2 Actions)"
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/npc/token/baphomet-mpmm.webp"
```
^statblock