...
"traits":
  - "desc": "The Selenelion twins, Gleam and Glister, have advantage on saving throws\
      \ against being [charmed](Sonstige/z_Content%20&%20Rules/conditions.md#Charmed),\
...
"actions":
  ...
  - "desc": "*Ranged Spell Attack:* +5 to hit, range 60 ft., one creature. *Hit:*\
      ...
      \ by a [polymorph](Sonstige/z_Content%20&%20Rules/spells/polymorph-xphb.md)\
      \ spell. The target can repeat the saving throw at the end of each of its turns,\
      \ ending the effect on itself on a success."
    "name": "Moon Ray (Gleam Only; 3/Day)"
  - "desc": "*Ranged Spell Attack:* +5 to hit, range 60 ft., one creature. *Hit:*\
      \ 12 (2d8 + 3) radiant damage, and the target must succeed on a DC 13 Wisdom\
      \ saving throw or be [blinded](Sonstige/z_Content%20&%20Rules/conditions.md#Blinded)\
  ...
  - "desc": "In her mind's eye, a Selenelion twin can see what the other twin sees\
      ...
      \ existence. Maintaining this effect requires [concentration](Sonstige/z_Content%20&%20Rules/conditions.md#Concentration)\
...
"source":
  - "WBtW"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/npc/token/selenelion-twin-wbtw.webp"
```
^statblock