...
- "Orcus"
---
# [Orcus](Sonstige/z_Content%20&%20Rules/bestiary/npc/orcus-mpmm.md)
...
Orcus rewards those who spread death in his name by granting them a small portion of his power. The least of these become [ghouls](Sonstige/z_Content%20&%20Rules/bestiary/undead/ghoul-xmm.md) and [zombies](Sonstige/z_Content%20&%20Rules/bestiary/undead/zombie-xmm.md) that serve in his legions, while his favored servants are the cultists and necromancers who murder the living and then manipulate the dead, emulating their dread master.

Orcus is a bestial creature of corruption with a diseased, decaying look. He has the lower torso of a goat and a humanlike upper body with a belly swollen with rot. Great bat wings sprout from his shoulders, and his head is like the skull of a goat, the flesh nearly rotted from it. In one hand, he wields the legendary [Wand of Orcus](Sonstige/z_Content%20&%20Rules/items/wand-of-orcus-xdmg.md), which is described in the *Dungeon Master's Guide*.
...
"ac": !!int "17"
"ac_class": "natural armor; 20 with the [Wand of Orcus](Sonstige/z_Content%20&%20Rules/items/wand-of-orcus-xdmg.md)"
"hp": !!int "405"
"hit_dice": "30d12 + 210"
"modifier": !!int "2"
"stats":
...
"traits":
  ...
  - "desc": "Orcus can cast [animate dead](Sonstige/z_Content%20&%20Rules/spells/animate-dead-xphb.md)\
      \ (at will) and [create undead](Sonstige/z_Content%20&%20Rules/spells/create-undead-xphb.md)\
      ...
      \ cast [create undead](Sonstige/z_Content%20&%20Rules/spells/create-undead-xphb.md)\
      \ even when it isn't night."
    "name": "Master of Undeath"
  - "desc": "Orcus wields the [Wand of Orcus](Sonstige/z_Content%20&%20Rules/items/wand-of-orcus-xdmg.md)."
...
"actions":
  ...
  - "desc": "*Ranged Spell Attack:* +15 to hit, range 120 ft., one target. *Hit:*\
    ...
    "name": "Necrotic Bolt"
  - "desc": "While holding the [Wand of Orcus](Sonstige/z_Content%20&%20Rules/items/wand-of-orcus-xdmg.md),\
  ...
  - "desc": "Orcus casts one of the following spells, requiring no material components\
      ...
      \n**3/day:** [dispel magic](Sonstige/z_Content%20&%20Rules/spells/dispel-magic-xphb.md)\n\
      \n**1/day:** [time stop](Sonstige/z_Content%20&%20Rules/spells/time-stop-xphb.md)"
    "name": "Spellcasting"
  - "desc": "While holding the [Wand of Orcus](Sonstige/z_Content%20&%20Rules/items/wand-of-orcus-xdmg.md),\
      ...
      \ 1d4 + 3 charges daily at dawn:\n\n**At will:** [animate dead](Sonstige/z_Content%20&%20Rules/spells/animate-dead-xphb.md)\
      \ (as an action), [blight](Sonstige/z_Content%20&%20Rules/spells/blight-xphb.md),\
      \ [speak with dead](Sonstige/z_Content%20&%20Rules/spells/speak-with-dead-xphb.md)\n\
      \n**2 charges each:** [power word kill](Sonstige/z_Content%20&%20Rules/spells/power-word-kill-xphb.md)\n\
      \n**1 charge each:** [circle of death](Sonstige/z_Content%20&%20Rules/spells/circle-of-death-xphb.md),\
...
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/npc/token/orcus-mpmm.webp"
```
^statblock