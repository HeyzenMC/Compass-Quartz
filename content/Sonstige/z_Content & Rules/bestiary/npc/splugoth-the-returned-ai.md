...
---
# [Splugoth the Returned](Sonstige/z_Content%20&%20Rules/bestiary/npc/splugoth-the-returned-ai.md)
...
"traits":
  - "desc": "As long as two or more of Splugoth's allies are within 5 feet of him\
      \ and are not [incapacitated](Sonstige/z_Content%20&%20Rules/conditions.md#Incapacitated),\
      \ attack rolls against him are made with disadvantage."
    "name": "Defensive Advantage"
  - "desc": "Splugoth can take the [Disengage](Sonstige/z_Content%20&%20Rules/actions.md#Disengage)\
      \ or [Hide](Sonstige/z_Content%20&%20Rules/actions.md#Hide) action as a bonus\
      \ action on each of his turns."
    "name": "Nimble Escape"
  - "desc": "Splugoth has advantage on saving throws against being [charmed](Sonstige/z_Content%20&%20Rules/conditions.md#Charmed)\
...
"actions":
  ...
  - "desc": "Splugoth remembers and repeats aloud a few words from a place he entered\
      ...
      \ throw or be [stunned](Sonstige/z_Content%20&%20Rules/conditions.md#Stunned)\
...
"reactions":
  - "desc": "When a creature Splugoth can see hits him with a melee weapon attack,\
      ...
      \ succeeds on a DC 12 Strength ([Athletics](Sonstige/z_Content%20&%20Rules/skills.md#Athletics))\
...
"source":
  - "AI"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/npc/token/splugoth-the-returned-ai.webp"
```
^statblock