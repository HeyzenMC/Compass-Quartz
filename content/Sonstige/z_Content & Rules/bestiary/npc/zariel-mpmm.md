...
- "Zariel"
---
# [Zariel](Sonstige/z_Content%20&%20Rules/bestiary/npc/zariel-mpmm.md)
...
"cr": "26"
"traits":
  - "desc": "Magical darkness doesn't impede Zariel's [darkvision](Sonstige/z_Content%20&%20Rules/senses.md#Darkvision)."
    "name": "Devil's Sight"
...
"actions":
  ...
  - "desc": "Zariel touches one creature within 10 feet of her. The target must succeed\
      ...
      \ be [poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned) for 1\
      \ minute. While [poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned)\
      \ in this way, the target is [blinded](Sonstige/z_Content%20&%20Rules/conditions.md#Blinded)\
      \ and [deafened](Sonstige/z_Content%20&%20Rules/conditions.md#Deafened). The\
  ...
  - "desc": "Zariel casts one of the following spells, requiring no material components\
      ...
      \ (can become Medium when changing her appearance), [detect evil and good](Sonstige/z_Content%20&%20Rules/spells/detect-evil-and-good-xphb.md),\
      \ [fireball](Sonstige/z_Content%20&%20Rules/spells/fireball-xphb.md), [invisibility](Sonstige/z_Content%20&%20Rules/spells/invisibility-xphb.md)\
      \ (self only), [major image](Sonstige/z_Content%20&%20Rules/spells/major-image-xphb.md),\
      \ [wall of fire](Sonstige/z_Content%20&%20Rules/spells/wall-of-fire-xphb.md)\n\
      \n**3/day each:** [blade barrier](Sonstige/z_Content%20&%20Rules/spells/blade-barrier-xphb.md),\
...
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/npc/token/zariel-mpmm.webp"
```
^statblock