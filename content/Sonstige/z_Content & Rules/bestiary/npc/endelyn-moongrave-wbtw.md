...
- "Endelyn Moongrave"
---
# [Endelyn Moongrave](Sonstige/z_Content%20&%20Rules/bestiary/npc/endelyn-moongrave-wbtw.md)
...
"traits":
  ...
  - "desc": "Endelyn can be killed only if she is reduced to 0 hit points during a\
    ...
    "name": "Eclipsed Doom"
  - "desc": "Endelyn can't be [surprised](Sonstige/z_Content%20&%20Rules/conditions.md#Surprised)."
...
"actions":
  ...
  - "desc": "Endelyn casts one of the following spells, requiring no material components\
      ...
      \ each:** [augury](Sonstige/z_Content%20&%20Rules/spells/augury-xphb.md), [polymorph](Sonstige/z_Content%20&%20Rules/spells/polymorph-xphb.md)\n\
      \n**1/day:** [plane shift](Sonstige/z_Content%20&%20Rules/spells/plane-shift-xphb.md)\
      \ (self only)"
    "name": "Spellcasting"
"source":
  - "WBtW"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/npc/token/endelyn-moongrave-wbtw.webp"
```
^statblock