...
"traits":
  - "desc": "The mephit explodes when it dies. *Constitution Saving Throw:* DC 11,\
      ...
      \ originating from the mephit. *Failure:* The target has the [Poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned)\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 11, one creature the mephit can see within\
      \ 15 feet. *Failure:* The target has the [Blinded](Sonstige/z_Content%20&%20Rules/conditions.md#Blinded)\
      \ condition until the end of the mephit's next turn."
    "name": "Cinder Breath (Recharge 6)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/elemental/token/smoke-mephit-xmm.webp"
```
^statblock
