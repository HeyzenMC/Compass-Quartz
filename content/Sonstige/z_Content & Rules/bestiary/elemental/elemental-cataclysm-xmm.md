...
"condition_immunities": "[blinded](Sonstige/z_Content%20&%20Rules/conditions.md#Blinded),\
  ...
  \ [grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled), [paralyzed](Sonstige/z_Content%20&%20Rules/conditions.md#Paralyzed),\
  ...
  \ [stunned](Sonstige/z_Content%20&%20Rules/conditions.md#Stunned), [unconscious](Sonstige/z_Content%20&%20Rules/conditions.md#Unconscious)"
"senses": "[Truesight](Sonstige/z_Content%20&%20Rules/senses.md#Truesight) 150 ft.,\
...
"actions":
  ...
  - "desc": "The cataclysm creates one of the following effects at random (roll 1d4):\n\
      ...
      \ a 60-foot-radius [Sphere](Sonstige/z_Content%20&%20Rules/variant-rules/sphere-area-of-effect-xphb.md)\
      ...
      \ \n- **2 Freezing Waves.** *Strength Saving Throw:* DC 23, each creature in\
      \ a 90-foot [Cone](Sonstige/z_Content%20&%20Rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 22 (5d8) Bludgeoning damage plus 22 (5d8) Cold damage, and\
      \ the target has the [Prone](Sonstige/z_Content%20&%20Rules/conditions.md#Prone)\
      \ condition. *Success:* Half damage only. *Failure or Success:* The target's\
      \ [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md) is reduced\
      \ to 0 until the end of its next turn.  \n- **3 Raging Storm.** A storm cloud\
      \ fills a 60-foot-radius [Sphere](Sonstige/z_Content%20&%20Rules/variant-rules/sphere-area-of-effect-xphb.md)\
      ...
      \ entirely in the cloud have the [Blinded](Sonstige/z_Content%20&%20Rules/conditions.md#Blinded)\
      \ and [Deafened](Sonstige/z_Content%20&%20Rules/conditions.md#Deafened) conditions\
      ...
      \ Throw:* DC 23, each creature in a 90-foot [Cube](Sonstige/z_Content%20&%20Rules/variant-rules/cube-area-of-effect-xphb.md)\
      \ originating from a point on the ground within 150 feet. *Failure:* 18 (4d8)\
      \ Bludgeoning damage plus 18 (4d8) Acid damage, and the target has the [Prone](Sonstige/z_Content%20&%20Rules/conditions.md#Prone)\
      \ condition and is buried under rubble. A buried target has the [Restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained)\
      \ condition, has [Total Cover](Sonstige/z_Content%20&%20Rules/variant-rules/cover-xphb.md),\
      \ and is suffocating. As an action, a buried creature or another creature within\
      \ 5 feet of it can make a DC 18 Strength ([Athletics](Sonstige/z_Content%20&%20Rules/skills.md#Athletics))\
      \ check. On a successful check, the creature is no longer buried. *Success:*\
      \ Half damage only.  "
    "name": "Cataclysmic Event (Recharge 4-6)"
  - "desc": "The cataclysm casts the [Control Weather](Sonstige/z_Content%20&%20Rules/spells/control-weather-xphb.md)\
...
"legendary_actions":
  - "desc": "The cataclysm makes one Elemental Burst attack."
    "name": "Eruption"
  - "desc": "The cataclysm moves up to its [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md),\
      \ [Fly Speed](Sonstige/z_Content%20&%20Rules/variant-rules/fly-speed-xphb.md),\
      \ or [Swim Speed](Sonstige/z_Content%20&%20Rules/variant-rules/swim-speed-xphb.md)\
      \ without provoking [Opportunity Attacks](Sonstige/z_Content%20&%20Rules/actions.md#Opportunity%20Attack).\
      ...
      \ target has the [Prone](Sonstige/z_Content%20&%20Rules/conditions.md#Prone)\
      \ condition. *Failure or Success:* The cataclysm can't take this action again\
      \ until the start of its next turn."
    "name": "Rumbling Movement"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/elemental/token/elemental-cataclysm-xmm.webp"
```
^statblock
