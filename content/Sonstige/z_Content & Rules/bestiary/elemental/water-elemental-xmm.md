...
"cr": "5"
"traits":
  - "desc": "If the elemental takes Cold damage, its [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 13 (2d8 + 4) Bludgeoning\
      \ damage. If the target is a Medium or smaller creature, it has the [Prone](Sonstige/z_Content%20&%20Rules/conditions.md#Prone)\
      \ condition."
    "name": "Slam"
  - "desc": "*Strength Saving Throw:* DC 15, each creature in the elemental's space.\
      ...
      \ smaller creature, it has the [Grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled)\
      \ condition (escape DC 14). Until the grapple ends, the target has the [Restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained)\
      ...
      \ can pull a creature out of it by succeeding on a DC 14 Strength ([Athletics](Sonstige/z_Content%20&%20Rules/skills.md#Athletics))\
      \ check. *Success:* Half damage only."
    "name": "Whelm (Recharge 4-6)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/elemental/token/water-elemental-xmm.webp"
```
^statblock
