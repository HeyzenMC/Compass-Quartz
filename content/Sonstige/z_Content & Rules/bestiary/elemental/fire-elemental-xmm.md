...
"traits":
  - "desc": "At the end of each of the elemental's turns, each creature in a 10-foot\
      ...
      \ flammable objects in the [Emanation](Sonstige/z_Content%20&%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ start [burning](Sonstige/z_Content%20&%20Rules/traps-hazards/burning-xphb.md)."
    "name": "Fire Aura"
  - "desc": "The elemental can move through a space as narrow as 1 inch without expending\
      ...
      \ 5 (1d10) Fire damage."
    "name": "Fire Form"
  - "desc": "The elemental sheds [Bright Light](Sonstige/z_Content%20&%20Rules/variant-rules/bright-light-xphb.md)\
      \ in a 30-foot radius and [Dim Light](Sonstige/z_Content%20&%20Rules/variant-rules/dim-light-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +6, reach 5 ft. *Hit:* 10 (2d6 + 3) Fire damage.\
      \ If the target is a creature or a flammable object, it starts [burning](Sonstige/z_Content%20&%20Rules/traps-hazards/burning-xphb.md)."
    "name": "Burn"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/elemental/token/fire-elemental-xmm.webp"
```
^statblock
