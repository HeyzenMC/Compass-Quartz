...
"actions":
  ...
  - "desc": "A 20-foot radius of spores extends from the swarm. These spores can go\
      ...
      \ throw. On a failed save, the creature is [incapacitated](Sonstige/z_Content%20&%20Rules/conditions.md#Incapacitated)\
      \ and its speed is halved, both for 1 minute. A creature can repeat the saving\
      \ throw at the end of each of its turns, ending the effect on itself on a success."
    "name": "Spores (1/Day)"
"source":
  - "WBtW"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/plant/token/swarm-of-campestris-wbtw.webp"
```
^statblock