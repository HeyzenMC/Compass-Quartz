...
"actions":
  ...
  - "desc": "The treant magically animates up to two trees it can see within 60 feet\
      ...
      \ takes its turn immediately after the treant on the same [Initiative](Sonstige/z_Content%20&%20Rules/variant-rules/initiative-xphb.md)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/plant/token/treant-xmm.webp"
```
^statblock
