...
"traits":
  - "desc": "Whenever the shambling mound is subjected to Lightning damage, it regains\
      \ a number of [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)\
...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 15, one Medium or smaller creature within\
      ...
      \ condition (escape DC 14). Until the grapple ends, the target has the [Blinded](Sonstige/z_Content%20&%20Rules/conditions.md#Blinded)\
      \ and [Restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained)\
      \ conditions, and it takes 10 (3d6) Lightning damage at the start of each\
      \ of its turns. When the shambling mound moves, the [Grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled)\
      \ target moves with it, costing it no extra movement. The shambling mound can\
      \ have only one creature [Grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled)\
      \ by this action at a time."
    "name": "Engulf"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/plant/token/shambling-mound-xmm.webp"
```
^statblock
