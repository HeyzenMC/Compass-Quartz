...
"traits":
  ...
  - "desc": "If the planetar dies outside Mount Celestia, its body disappears, and\
      \ it gains a new body instantly, reviving with all its [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)\
      \ somewhere in Mount Celestia."
    "name": "Exalted Restoration"
  - "desc": "The planetar has [Advantage](Sonstige/z_Content%20&%20Rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +12, reach 10 ft. *Hit:* 14 (2d6 + 7) Slashing\
    ...
    "name": "Radiant Sword"
  - "desc": "*Dexterity Saving Throw:* DC 20, each enemy in a 20-foot-radius [Sphere](Sonstige/z_Content%20&%20Rules/variant-rules/sphere-area-of-effect-xphb.md)\
  ...
  - "desc": "The planetar casts one of the following spells, requiring no Material\
      ...
      \n**At will:** [Detect Evil and Good](Sonstige/z_Content%20&%20Rules/spells/detect-evil-and-good-xphb.md)\n\
    ...
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The planetar casts [Cure Wounds](Sonstige/z_Content%20&%20Rules/spells/cure-wounds-xphb.md),\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/celestial/token/planetar-xmm.webp"
```
^statblock
