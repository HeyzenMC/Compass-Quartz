...
"traits":
  ...
  - "desc": "The unicorn has [Advantage](Sonstige/z_Content%20&%20Rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "The unicorn casts one of the following spells, requiring no spell components\
      ...
      \ [Druidcraft](Sonstige/z_Content%20&%20Rules/spells/druidcraft-xphb.md)\n\n\
      **1/day each:** [Calm Emotions](Sonstige/z_Content%20&%20Rules/spells/calm-emotions-xphb.md),\
      \ [Dispel Evil and Good](Sonstige/z_Content%20&%20Rules/spells/dispel-evil-and-good-xphb.md),\
      \ [Entangle](Sonstige/z_Content%20&%20Rules/spells/entangle-xphb.md), [Pass\
      \ without Trace](Sonstige/z_Content%20&%20Rules/spells/pass-without-trace-xphb.md),\
      \ [Word of Recall](Sonstige/z_Content%20&%20Rules/spells/word-of-recall-xphb.md)"
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The unicorn touches another creature with its horn and casts [Cure Wounds](Sonstige/z_Content%20&%20Rules/spells/cure-wounds-xphb.md)\
      \ or [Lesser Restoration](Sonstige/z_Content%20&%20Rules/spells/lesser-restoration-xphb.md)\
...
"regional_effects":
  - "desc": "The region containing a unicorn's lair is changed by its presence, creating\
      ...
      \ have [Advantage](Sonstige/z_Content%20&%20Rules/variant-rules/advantage-xphb.md)\
      \ on Dexterity ([Stealth](Sonstige/z_Content%20&%20Rules/skills.md#Stealth))\
      ...
      \ from a spell, it regains the maximum number of [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)\
...
"legendary_actions":
  - "desc": "The unicorn moves up to half its [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md)\
  ...
  - "desc": "The unicorn targets itself or one creature it can see within 60 feet\
      \ of itself. The target gains 10 (3d6) [Temporary Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/temporary-hit-points-xphb.md),\
      \ and its AC increases by 2 until the end of the unicorn's next turn. The unicorn\
      \ can't take this action again until the start of its next turn."
    "name": "Shimmering Shield"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/celestial/token/unicorn-xmm.webp"
```
^statblock
