...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 13, one creature the spider can see within\
      \ 60 feet. *Failure:* The target has the [Restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained)\
...
"source":
  - "XMM"
  - "XPHB"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/beast/token/giant-spider-xmm.webp"
```
^statblock
