...
"reactions":
  - "desc": "Trigger: A creature the cyclops can see makes an attack roll against\
      \ it. _Response:_ The cyclops imposes [Disadvantage](Sonstige/z_Content%20&%20Rules/variant-rules/disadvantage-xphb.md)\
      \ on the roll, and the cyclops gains [Advantage](Sonstige/z_Content%20&%20Rules/variant-rules/advantage-xphb.md)\
      \ on attack rolls against the target until the end of the cyclops's next turn."
    "name": "Limited Foresight (Recharge 6)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/giant/token/cyclops-sentry-xmm.webp"
```
^statblock
