...
"cr": "5"
"traits":
  - "desc": "If the troll ends any turn [Bloodied](Sonstige/z_Content%20&%20Rules/conditions.md#Bloodied)\
      \ and took 15+ Slashing damage during that turn, one of the troll's limbs is\
      \ severed, falls into the troll's space, and becomes a [Troll Limb](Sonstige/z_Content%20&%20Rules/bestiary/giant/troll-limb-xmm.md).\
      \ The limb acts immediately after the troll's turn. The troll has 1 [Exhaustion](Sonstige/z_Content%20&%20Rules/conditions.md#Exhaustion)\
      \ level for each missing limb, and it grows replacement limbs the next time\
      \ it regains [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)."
    "name": "Loathsome Limbs (4/Day)"
  - "desc": "The troll regains 15 [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)\
      ...
      \ if it starts its turn with 0 [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 10 ft. *Hit:* 11 (2d6 + 4) Slashing\
    ...
    "name": "Rend"
"bonus_actions":
  - "desc": "The troll moves up to half its [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md)\
      \ straight toward an enemy it can see."
    "name": "Charge"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/giant/token/troll-xmm.webp"
```
^statblock
