...
- "Gauth"
---
# [Gauth](Sonstige/z_Content%20&%20Rules/bestiary/aberration/gauth-mpmm.md)
...
"traits":
  - "desc": "When a creature that can see the gauth's central eye starts its turn\
      ...
      \ saving throw if the gauth isn't [incapacitated](Sonstige/z_Content%20&%20Rules/conditions.md#Incapacitated)\
      \ and can see the creature. A creature that fails the save is [stunned](Sonstige/z_Content%20&%20Rules/conditions.md#Stunned)\
      \ until the start of its next turn.\n\nUnless [surprised](Sonstige/z_Content%20&%20Rules/conditions.md#Surprised),\
...
"actions":
  ...
  - "desc": "The gauth shoots three of the following magical eye rays at random (roll\
      ...
      \ [paralyzed](Sonstige/z_Content%20&%20Rules/conditions.md#Paralyzed) for 1\
      ...
      \ throw or fall asleep and remain [unconscious](Sonstige/z_Content%20&%20Rules/conditions.md#Unconscious)\
...
"source":
  - "MPMM"
  - "VGM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/aberration/token/gauth-mpmm.webp"
```
^statblock
