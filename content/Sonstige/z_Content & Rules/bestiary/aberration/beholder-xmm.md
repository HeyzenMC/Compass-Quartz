...
"skillsaves":
  - "name": "[Perception](Sonstige/z_Content%20&%20Rules/skills.md#Perception)"
    "desc": "+12"
"condition_immunities": "[prone](Sonstige/z_Content%20&%20Rules/conditions.md#Prone)"
...
"actions":
  ...
  - "desc": "The beholder randomly shoots one of the following magical rays at a target\
      ...
      \ has the [Charmed](Sonstige/z_Content%20&%20Rules/conditions.md#Charmed) condition\
      ...
      \ has the [Paralyzed](Sonstige/z_Content%20&%20Rules/conditions.md#Paralyzed)\
      \ condition and repeats the save at the end of each of its turns, ending the\
      \ effect on itself on a success. After 1 minute, it succeeds automatically.\
      \  \n- **3 Fear Ray.** *Wisdom Saving Throw:* DC 16. *Failure:* 14 (4d6) Psychic\
      \ damage, and the target has the [Frightened](Sonstige/z_Content%20&%20Rules/conditions.md#Frightened)\
      ...
      \ Necrotic damage. Until the end of the target's next turn, the target's [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md)\
      \ is halved; the target can't take Reactions; and it can take either an action\
      \ or a [Bonus Action](Sonstige/z_Content%20&%20Rules/variant-rules/bonus-action-xphb.md)\
      \ on its turn, not both. *Success:* Half damage only.  \n- **5 Enervation Ray.**\
      \ *Constitution Saving Throw:* DC 16. *Failure:* 13 (3d8) Poison damage, and\
      \ the target has the [Poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned)\
      \ condition until the end of its next turn. While [Poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned),\
      \ the target can't regain [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md).\
      ...
      \ the [Restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained)\
      \ condition until the start of the beholder's next turn or until the beholder\
      \ has the [Incapacitated](Sonstige/z_Content%20&%20Rules/conditions.md#Incapacitated)\
      ...
      \ it is a Construct or an Undead). *Failure:* The target has the [Unconscious](Sonstige/z_Content%20&%20Rules/conditions.md#Unconscious)\
      ...
      \ [Restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained) condition\
      \ and repeats the save at the end of its next turn if it is still [Restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained),\
      \ ending the effect on itself on a success. *2Nd Failure:* The target has the\
      \ [Petrified](Sonstige/z_Content%20&%20Rules/conditions.md#Petrified) condition\
      \ instead of the [Restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained)\
      \ condition.  \n- **9 Disintegration Ray.** *Dexterity Saving Throw:* DC 16.\
      \ *Failure:* 36 (8d8) Force damage. If the target is a nonmagical object or\
      \ a creation of magical force, a 10-foot [Cube](Sonstige/z_Content%20&%20Rules/variant-rules/cube-area-of-effect-xphb.md)\
      \ of it disintegrates into dust. *Success:* Half damage. *Failure or Success:*\
      \ If the target is a creature and this damage reduces it to 0 [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md),\
      ...
      \ or Success:* The target dies if the ray reduces it to 0 [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md).\
      \  "
    "name": "Eye Rays"
"bonus_actions":
  - "desc": "The beholder's central eye emits an antimagic wave in a 150-foot [Cone](Sonstige/z_Content%20&%20Rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ Until the start of the beholder's next turn, that area acts as an [Antimagic\
      \ Field](Sonstige/z_Content%20&%20Rules/spells/antimagic-field-xphb.md) spell,\
      \ and that area works against the beholder's own Eye Rays."
    "name": "Antimagic Cone"
"regional_effects":
  - "desc": "The region containing a beholder's lair is twisted by its presence, creating\
      ...
      \ and its allies) that finishes a [Short Rest](Sonstige/z_Content%20&%20Rules/variant-rules/short-rest-xphb.md)\
      ...
      \ 1 mile of the lair that makes a [D20 Test](Sonstige/z_Content%20&%20Rules/variant-rules/d20-test-xphb.md)\
      \ and rolls a 1 has the [Prone](Sonstige/z_Content%20&%20Rules/conditions.md#Prone)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/aberration/token/beholder-xmm.webp"
```
^statblock
