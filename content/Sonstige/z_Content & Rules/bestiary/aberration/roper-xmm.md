...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 17 (3d8 + 4) Piercing\
      \ damage."
    "name": "Bite"
  - "desc": "*Melee Attack Roll:* +7, reach 60 ft. *Hit:* The target has the [Grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled)\
      \ condition (escape DC 14) from one of six tentacles, and the target has the\
      \ [Poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned) condition\
      \ until the grapple ends.\n\nThe tentacle can be damaged, freeing a creature\
      \ it has [Grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled) when\
      \ destroyed (AC 20, HP 10, [Immunity](Sonstige/z_Content%20&%20Rules/variant-rules/immunity-xphb.md)\
    ...
    "name": "Tentacle"
  - "desc": "The roper pulls each creature [Grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled)\
      \ by it up to 30 feet straight toward it."
    "name": "Reel"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/aberration/token/roper-xmm.webp"
```
^statblock
