...
"actions":
  - "desc": "*Melee Attack Roll:* +7, reach 5 ft. *Hit:* 22 (4d8 + 4) Psychic\
      \ damage. If the target is a Medium or smaller creature, it has the [Grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled)\
      \ condition (escape DC 14) from all the mind flayer's tentacles, and the target\
      \ has the [Stunned](Sonstige/z_Content%20&%20Rules/conditions.md#Stunned) condition\
      \ until the grapple ends."
    "name": "Tentacles"
  - "desc": "*Constitution Saving Throw:* DC 15, one creature that is [Grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled)\
    ...
    "name": "Extract Brain"
  - "desc": "*Intelligence Saving Throw:* DC 15, each creature in a 60-foot [Cone](Sonstige/z_Content%20&%20Rules/variant-rules/cone-area-of-effect-xphb.md).\
      \ *Failure:* 31 (6d8 + 4) Psychic damage, and the target has the [Stunned](Sonstige/z_Content%20&%20Rules/conditions.md#Stunned)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/aberration/token/mind-flayer-xmm.webp"
```
^statblock
