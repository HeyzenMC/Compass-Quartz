...
"traits":
  ...
  - "desc": "If the flumph receives the [Prone](Sonstige/z_Content%20&%20Rules/conditions.md#Prone)\
      \ condition, roll a die. On an odd number, it has the [Incapacitated](Sonstige/z_Content%20&%20Rules/conditions.md#Incapacitated)\
      \ condition. At the end of each of its turns, the flumph makes a DC 10 Dexterity\
      \ saving throw, ending the [Incapacitated](Sonstige/z_Content%20&%20Rules/conditions.md#Incapacitated)\
...
"actions":
  ...
  - "desc": "*Dexterity Saving Throw:* DC 10, one creature the flumph can see within\
      ...
      \ a stench for 1d4 hours, and has the [Poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned)\
      \ condition while the stench lasts. Other creatures have the [Poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned)\
      \ condition while in a 5-foot [Emanation](Sonstige/z_Content%20&%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the coated target. The target can remove the stench on itself\
      \ if it bathes during a [Short](Sonstige/z_Content%20&%20Rules/variant-rules/short-rest-xphb.md)\
      \ or [Long Rest](Sonstige/z_Content%20&%20Rules/variant-rules/long-rest-xphb.md)."
    "name": "Stench Spray (1/Day)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/aberration/token/flumph-xmm.webp"
```
^statblock
