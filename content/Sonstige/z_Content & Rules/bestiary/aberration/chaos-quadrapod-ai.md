...
- "Chaos Quadrapod"
---
# [Chaos Quadrapod](Sonstige/z_Content%20&%20Rules/bestiary/aberration/chaos-quadrapod-ai.md)
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 15 ft., one target. *Hit:*\
      \ 11 (2d6 + 4) bludgeoning damage. If the target is a creature, it is [grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled)\
      \ (escape DC 14). Until this grapple ends, the target is [restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained).\
...
"source":
  - "AI"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/aberration/token/chaos-quadrapod-ai.webp"
```
^statblock