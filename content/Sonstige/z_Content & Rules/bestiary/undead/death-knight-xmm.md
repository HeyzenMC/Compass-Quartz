...
"traits":
  ...
  - "desc": "The death knight has [Advantage](Sonstige/z_Content%20&%20Rules/variant-rules/advantage-xphb.md)\
      \ on saving throws against spells and other magical effects."
    "name": "Magic Resistance"
  - "desc": "Undead creatures of the death knight's choice (excluding itself) in a\
      \ 60-foot [Emanation](Sonstige/z_Content%20&%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from it have [Advantage](Sonstige/z_Content%20&%20Rules/variant-rules/advantage-xphb.md)\
      \ on attack rolls and saving throws. It can't use this trait if it has the [Incapacitated](Sonstige/z_Content%20&%20Rules/conditions.md#Incapacitated)\
      \ condition."
    "name": "Marshal Undead"
  - "desc": "If the death knight is destroyed before it atones for its evil, it gains\
      \ a new body in 1d10 days, reviving with all its [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md).\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +11, reach 5 ft. *Hit:* 12 (2d6 + 5) Slashing\
    ...
    "name": "Dread Blade"
  - "desc": "*Dexterity Saving Throw:* DC 18, each creature in a 20-foot-radius [Sphere](Sonstige/z_Content%20&%20Rules/variant-rules/sphere-area-of-effect-xphb.md)\
  ...
  - "desc": "The death knight casts one of the following spells, requiring no Material\
      ...
      \n**At will:** [Command](Sonstige/z_Content%20&%20Rules/spells/command-xphb.md),\
      \ [Phantom Steed](Sonstige/z_Content%20&%20Rules/spells/phantom-steed-xphb.md)\n\
      \n**2/day each:** [Destructive Wave](Sonstige/z_Content%20&%20Rules/spells/destructive-wave-xphb.md)\
      \ (Necrotic), [Dispel Magic](Sonstige/z_Content%20&%20Rules/spells/dispel-magic-xphb.md)"
    "name": "Spellcasting"
"reactions":
...
"legendary_actions":
  - "desc": "The death knight uses Spellcasting to cast [Command](Sonstige/z_Content%20&%20Rules/spells/command-xphb.md).\
  ...
  - "desc": "*Constitution Saving Throw:* DC 18, one creature the death knight can\
      ...
      \ [Hit Point](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)\
      \ maximum decreases by an amount equal to the damage taken. *Failure or Success:*\
      \ The death knight can't take this action again until the start of its next\
      \ turn."
    "name": "Fell Word"
  - "desc": "The death knight moves up to half its [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md),\
      \ and it makes one Dread Blade attack."
    "name": "Lunge"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/undead/token/death-knight-xmm.webp"
```
^statblock
