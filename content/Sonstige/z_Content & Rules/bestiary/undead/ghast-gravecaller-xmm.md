...
"traits":
  - "desc": "*Constitution Saving Throw:* DC 13, any creature that starts its turn\
      \ in a 5-foot [Emanation](Sonstige/z_Content%20&%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the ghast. *Failure:* The target has the [Poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +6, reach 5 ft. *Hit:* 13 (3d6 + 3) Slashing\
      \ damage. If the target isn't an Undead, it has the [Paralyzed](Sonstige/z_Content%20&%20Rules/conditions.md#Paralyzed)\
      \ condition until the end of its next turn."
    "name": "Claw"
  - "desc": "*Melee  or Ranged Attack Roll:* +7, reach 5 ft. or range 120 ft. *Hit:*\
      \ 15 (2d10 + 4) Necrotic damage, and the target has the [Frightened](Sonstige/z_Content%20&%20Rules/conditions.md#Frightened)\
      \ condition until the end of its next turn."
    "name": "Horrific Necrosis"
  - "desc": "The ghast casts one of the following spells, requiring no Material components\
      \ and using Intelligence as the spellcasting ability:\n\n**At will:** [Speak\
      \ with Dead](Sonstige/z_Content%20&%20Rules/spells/speak-with-dead-xphb.md),\
      \ [Thaumaturgy](Sonstige/z_Content%20&%20Rules/spells/thaumaturgy-xphb.md)"
    "name": "Spellcasting"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/undead/token/ghast-gravecaller-xmm.webp"
```
^statblock
