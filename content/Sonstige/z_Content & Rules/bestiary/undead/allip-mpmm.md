...
- "Allip"
---
# [Allip](Sonstige/z_Content%20&%20Rules/bestiary/undead/allip-mpmm.md)
...
"actions":
  ...
  - "desc": "Each creature within 30 feet of the allip that can hear it must make\
      ...
      \ psychic damage, and it is [stunned](Sonstige/z_Content%20&%20Rules/conditions.md#Stunned)\
      \ until the end of its next turn. On a successful save, it takes half as much\
      \ damage and isn't [stunned](Sonstige/z_Content%20&%20Rules/conditions.md#Stunned).\
...
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/undead/token/allip-mpmm.webp"
```
^statblock
