...
"traits":
  - "desc": "If the revenant dies, it revives 24 hours later unless [Dispel Evil and\
      ...
      \ is cast on its remains. If it revives, it animates another group of corpses\
      \ elsewhere on the same plane of existence; it now looks different but uses\
      \ the same stat block and returns with all its [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)."
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +8, reach 10 ft. *Hit:* 10 (1d10 + 5) Bludgeoning\
      ...
      \ The revenant can have up to two targets [Grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled)\
      \ in this way at a time."
    "name": "Suffocate"
  - "desc": "*Wisdom Saving Throw:* DC 15, each creature in a 30-foot [Emanation](Sonstige/z_Content%20&%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the revenant. *Failure:* The target has the [Paralyzed](Sonstige/z_Content%20&%20Rules/conditions.md#Paralyzed)\
      \ condition and repeats the save at the end of each of its turns, ending the\
      \ effect on itself on a success. After 1 minute, it succeeds automatically."
    "name": "Haunting Glare (Recharge 5-6)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/undead/token/graveyard-revenant-xmm.webp"
```
^statblock
