...
"cr": "5"
"traits":
  - "desc": "The revenant regains 10 [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)\
      ...
      \ only if it starts its turn with 0 [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)\
  ...
  - "desc": "If the revenant dies, it revives 24 hours later in a different body unless\
      ...
      \ block and returns with all its [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)."
...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 15, one creature the revenant can see within\
      \ 30 feet. *Failure:* The target has the [Frightened](Sonstige/z_Content%20&%20Rules/conditions.md#Frightened)\
      \ condition and repeats the save at the end of each of its turns, ending the\
      \ effect on itself on a success. After 1 minute, it succeeds automatically.\
      \ If the [Frightened](Sonstige/z_Content%20&%20Rules/conditions.md#Frightened)\
      \ target is cursed by the revenant (see Vow of Revenge), the target also has\
      \ the [Paralyzed](Sonstige/z_Content%20&%20Rules/conditions.md#Paralyzed) condition\
      \ for the duration."
    "name": "Vengeful Glare"
"bonus_actions":
  - "desc": "The revenant curses one creature it can see within 30 feet of itself.\
      ...
      \ the revenant uses this [Bonus Action](Sonstige/z_Content%20&%20Rules/variant-rules/bonus-action-xphb.md)\
      \ on a different creature."
    "name": "Vow of Revenge (1/Day)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/undead/token/revenant-xmm.webp"
```
^statblock
