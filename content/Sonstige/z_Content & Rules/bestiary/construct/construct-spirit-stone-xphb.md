...
---
# [Construct Spirit (Stone)](Sonstige/z_Content%20&%20Rules/bestiary/construct/construct-spirit-stone-xphb.md)
...
"traits":
  - "desc": "When a creature starts its turn within 10 feet of the spirit, the spirit\
      ...
      \ of its next turn, the target can't make [Opportunity Attacks](Sonstige/z_Content%20&%20Rules/actions.md#Opportunity%20Attack),\
      \ and its [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md)\
      \ is halved."
    "name": "Stony Lethargy"
"actions":
...
"source":
  - "XPHB"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/construct/token/construct-spirit-stone-xphb.webp"
```
^statblock