...
- "Hellfire Engine"
---
# [Hellfire Engine](Sonstige/z_Content%20&%20Rules/bestiary/construct/hellfire-engine-mpmm.md)
...
"condition_immunities": "[charmed](Sonstige/z_Content%20&%20Rules/conditions.md#Charmed),\
  ...
  \ [poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned), [unconscious](Sonstige/z_Content%20&%20Rules/conditions.md#Unconscious)"
...
"actions":
  - "desc": "The hellfire engine moves up to its speed in a straight line. During\
      ...
      \ hellfire engine's path. On a failed save, the creature falls [prone](Sonstige/z_Content%20&%20Rules/conditions.md#Prone)\
      \ and takes 28 (8d6) bludgeoning damage.\n\nIf the hellfire engine remains\
      \ in the [prone](Sonstige/z_Content%20&%20Rules/conditions.md#Prone) creature's\
      \ space, the creature is also [restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained)\
      \ until it's no longer in the same space as the hellfire engine. While [restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained)\
  ...
  - "desc": "The hellfire engine uses one of the following options (choose one or\
      ...
      \ Styx as a [lemure](Sonstige/z_Content%20&%20Rules/bestiary/fiend/lemure-xmm.md)\
      ...
      \ the [lemure](Sonstige/z_Content%20&%20Rules/bestiary/fiend/lemure-xmm.md)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/construct/token/hellfire-engine-mpmm.webp"
```
^statblock