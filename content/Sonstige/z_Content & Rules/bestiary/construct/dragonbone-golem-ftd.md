...
- "Dragonbone Golem"
---
# [Dragonbone Golem](Sonstige/z_Content%20&%20Rules/bestiary/construct/dragonbone-golem-ftd.md)
...
"traits":
  - "desc": "Each creature of the golem's choice that starts its turn within 20 feet\
      \ of the golem must make a DC 15 Wisdom saving throw unless the golem is [incapacitated](Sonstige/z_Content%20&%20Rules/conditions.md#Incapacitated).\
      \ On a failed save, the creature is [frightened](Sonstige/z_Content%20&%20Rules/conditions.md#Frightened)\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 12\
      ...
      \ it is pinned beneath the bony pinion and [restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained).\
      \ The golem has two pinions, each of which can restrain one target. If a creature\
      \ is [restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained) by\
      \ one of the pinions, the golem can't attack with it. Any creature [restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained)\
      \ by a pinion can free itself at the start of its turn with a successful DC\
      \ 17 Strength ([Athletics](Sonstige/z_Content%20&%20Rules/skills.md#Athletics))\
      \ check."
    "name": "Pinion"
  - "desc": "*Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 12\
  ...
  - "desc": "The golem emits a 60-foot cone of petrifying gas from its mouth. Each\
      ...
      \ take 35 (10d6) poison damage and be [restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained)\
      \ as it begins to turn to stone. The [restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained)\
      \ target must repeat the saving throw at the end of its next turn. On a successful\
      \ save, the effect ends on the target. On a failed save, the target is [petrified](Sonstige/z_Content%20&%20Rules/conditions.md#Petrified)."
    "name": "Petrifying Breath (Recharge 5-6)"
"source":
  - "FTD"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/construct/token/dragonbone-golem-ftd.webp"
```
^statblock