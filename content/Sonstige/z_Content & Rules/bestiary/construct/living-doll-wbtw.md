...
"condition_immunities": "[paralyzed](Sonstige/z_Content%20&%20Rules/conditions.md#Paralyzed),\
...
"traits":
  - "desc": "If the doll is motionless at the start of combat, it has advantage on\
      ...
      \ or act, that creature must succeed on a DC 18 Intelligence ([Investigation](Sonstige/z_Content%20&%20Rules/skills.md#Investigation))\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +2 to hit, reach 5 ft., one creature. *Hit:*\
      \ The target is [grappled](Sonstige/z_Content%20&%20Rules/conditions.md#Grappled)\
      \ (escape DC 6) and takes 11 (2d10) psychic damage at the start of each of\
      \ its turns until this grapple ends. The doll can grapple only one creature\
      \ at a time."
    "name": "Grabby Hands"
"bonus_actions":
  - "desc": "The doll cackles as it targets one or two creatures it can see within\
      ...
      \ damage and is [incapacitated](Sonstige/z_Content%20&%20Rules/conditions.md#Incapacitated)\
...
"source":
  - "WBtW"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/construct/token/living-doll-wbtw.webp"
```
^statblock