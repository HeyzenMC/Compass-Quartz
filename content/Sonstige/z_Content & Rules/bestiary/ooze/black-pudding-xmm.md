...
"traits":
  ...
  - "desc": "A creature that hits the pudding with a melee attack roll takes 4 (1d8)\
      ...
      \ -5. The penalty can be removed by casting the [Mending](Sonstige/z_Content%20&%20Rules/spells/mending-xphb.md)\
...
"actions":
  - "desc": "*Melee Attack Roll:* +5, reach 10 ft. *Hit:* 17 (4d6 + 3) Acid damage.\
      ...
      \ be removed by casting the [Mending](Sonstige/z_Content%20&%20Rules/spells/mending-xphb.md)\
      \ spell on the armor."
    "name": "Dissolving Pseudopod"
"reactions":
  - "desc": "Trigger: While the pudding is Large or Medium and has 10+ [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md),\
      \ it becomes [Bloodied](Sonstige/z_Content%20&%20Rules/conditions.md#Bloodied)\
      ...
      \ original pudding and acts on its [Initiative](Sonstige/z_Content%20&%20Rules/variant-rules/initiative-xphb.md).\
      \ The original pudding's [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)\
      \ are divided evenly between the new puddings (round down)."
    "name": "Split"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/ooze/token/black-pudding-xmm.webp"
```
^statblock
