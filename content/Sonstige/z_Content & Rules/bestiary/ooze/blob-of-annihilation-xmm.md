...
"cr": "23"
"traits":
  - "desc": "If the blob is reduced to 0 [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md),\
  ...
  - "desc": "The blob has [Advantage](Sonstige/z_Content%20&%20Rules/variant-rules/advantage-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +15, reach 30 ft. *Hit:* 24 (3d10 + 8) Force\
      \ damage."
    "name": "Pseudopod"
  - "desc": "The blob moves up to its [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md)\
      ...
      \ While engulfed, a target has [Total Cover](Sonstige/z_Content%20&%20Rules/variant-rules/cover-xphb.md)\
      ...
      \ Force damage at the start of each of its turns, is suffocating, has the [Restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained)\
      \ condition, and repeats the save at the end of each of its turns. An engulfed\
      \ creature that is reduced to 0 [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)\
  ...
  - "desc": "The blob lobs a slimy glob at one Large or smaller creature it can see\
      ...
      \ toward the blob, and the target has the [Restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/ooze/token/blob-of-annihilation-xmm.webp"
```
^statblock
