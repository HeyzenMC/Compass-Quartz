...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +10, reach 5 ft. *Hit:* 16 (3d6 + 6) Slashing\
      ...
      \ effects of the pirate's choice:\n\n- **Awestruck.** The target has the [Charmed](Sonstige/z_Content%20&%20Rules/conditions.md#Charmed)\
      \ condition until the start of the pirate's next turn.  \n- **Poison.** The\
      \ target has the [Poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned)\
      \ condition until the start of the pirate's next turn.  "
    "name": "Scimitar"
...
"bonus_actions":
  - "desc": "The pirate chooses up to three other creatures it can see within 30 feet.\
      \ Until the start of the pirate's next turn, the targets have [Advantage](Sonstige/z_Content%20&%20Rules/variant-rules/advantage-xphb.md)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/humanoid/token/pirate-admiral-xmm.webp"
```
^statblock
