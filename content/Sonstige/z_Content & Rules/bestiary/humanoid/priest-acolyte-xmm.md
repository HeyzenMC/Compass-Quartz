...
"bonus_actions":
  - "desc": "The priest casts [Bless](Sonstige/z_Content%20&%20Rules/spells/bless-xphb.md),\
      ...
      \ or [Sanctuary](Sonstige/z_Content%20&%20Rules/spells/sanctuary-xphb.md), using\
      \ the same spellcasting ability as Spellcasting.\n"
    "name": "Divine Aid (1/Day)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/humanoid/token/priest-acolyte-xmm.webp"
```
^statblock
