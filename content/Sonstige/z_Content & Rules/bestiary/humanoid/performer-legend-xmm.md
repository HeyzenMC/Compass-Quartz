...
"actions":
  ...
  - "desc": "*Wisdom Saving Throw:* DC 17, each creature in a 20-foot-radius [Sphere](Sonstige/z_Content%20&%20Rules/variant-rules/sphere-area-of-effect-xphb.md)\
      \ centered on a point within 120 feet. *Failure:* 22 (4d8 + 4) Psychic damage,\
      \ and the target has the [Charmed](Sonstige/z_Content%20&%20Rules/conditions.md#Charmed)\
...
"reactions":
  - "desc": "Trigger: A creature hits the performer with an attack roll. _Response—\
      ...
      \ roll misses the performer, and the target has the [Charmed](Sonstige/z_Content%20&%20Rules/conditions.md#Charmed)\
      \ condition until the end of the performer's next turn."
    "name": "Warding Charm"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/humanoid/token/performer-legend-xmm.webp"
```
^statblock
