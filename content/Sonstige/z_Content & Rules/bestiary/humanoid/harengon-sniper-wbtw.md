...
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +5 to hit (the target gains no benefit from\
      ...
      \ can use the [Hide](Sonstige/z_Content%20&%20Rules/actions.md#Hide) action."
    "name": "Light Crossbow"
"source":
  - "WBtW"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/humanoid/token/harengon-sniper-wbtw.webp"
```
^statblock