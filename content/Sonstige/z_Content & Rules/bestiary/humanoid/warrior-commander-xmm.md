...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +9, reach 5 ft. *Hit:* 19 (4d6 + 5) Slashing\
      ...
      \ The target has [Disadvantage](Sonstige/z_Content%20&%20Rules/variant-rules/disadvantage-xphb.md)\
      \ on its next attack roll before the start of the warrior's next turn.  \n-\
      \ **Maneuver.** One ally who can see or hear the warrior can take a [Reaction](Sonstige/z_Content%20&%20Rules/variant-rules/reaction-xphb.md)\
      \ to move up to half the ally's [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md)\
  ...
  - "desc": "*Ranged Attack Roll:* +9, range 150/600 ft. *Hit:* 18 (3d8 + 5) Piercing\
      \ damage, and the target's [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md)\
      \ decreases by 10 feet until the end of the target's next turn."
    "name": "Longbow"
"bonus_actions":
  - "desc": "The warrior moves up to half its [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md)\
      \ straight toward an enemy it can see without provoking [Opportunity Attacks](Sonstige/z_Content%20&%20Rules/actions.md#Opportunity%20Attack)."
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/humanoid/token/warrior-commander-xmm.webp"
```
^statblock
