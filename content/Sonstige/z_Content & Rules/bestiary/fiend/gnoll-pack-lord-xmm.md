...
"actions":
  ...
  - "desc": "The gnoll targets another creature it can see within 60 feet of itself\
      \ that has the Rampage [Bonus Action](Sonstige/z_Content%20&%20Rules/variant-rules/bonus-action-xphb.md).\
      \ The target can take a [Reaction](Sonstige/z_Content%20&%20Rules/variant-rules/reaction-xphb.md)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fiend/token/gnoll-pack-lord-xmm.webp"
```
^statblock
