...
"traits":
  - "desc": "If the erinyes dies outside the Nine Hells, its body disappears in sulfurous\
      \ smoke, and it gains a new body instantly, reviving with all its [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)\
      \ somewhere in the Nine Hells."
    "name": "Diabolical Restoration"
  - "desc": "The erinyes has [Advantage](Sonstige/z_Content%20&%20Rules/variant-rules/advantage-xphb.md)\
      \ on saving throws against spells and other magical effects."
    "name": "Magic Resistance"
  - "desc": "The erinyes has a magic rope. While bearing it, the erinyes can use the\
      \ Entangling Rope action. The rope has AC 20, HP 90, and [Immunity](Sonstige/z_Content%20&%20Rules/variant-rules/immunity-xphb.md)\
      \ to Poison and Psychic damage. The rope turns to dust if reduced to 0 [Hit\
      \ Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md),\
      ...
      \ when finishing a [Short](Sonstige/z_Content%20&%20Rules/variant-rules/short-rest-xphb.md)\
...
"actions":
  ...
  - "desc": "*Strength Saving Throw:* DC 16, one creature the erinyes can see within\
      \ 120 feet. *Failure:* 14 (4d6) Force damage, and the target has the [Restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained)\
      \ condition until the rope is destroyed, the erinyes uses a [Bonus Action](Sonstige/z_Content%20&%20Rules/variant-rules/bonus-action-xphb.md)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fiend/token/erinyes-xmm.webp"
```
^statblock
