...
"actions":
  ...
  - "desc": "*Melee  or Ranged Attack Roll:* +6, reach 5 ft. or range 60 ft. *Hit:*\
    ...
    "name": "Abyssal Strike"
  - "desc": "The gnoll conjures a 30-foot [Cube](Sonstige/z_Content%20&%20Rules/variant-rules/cube-area-of-effect-xphb.md)\
      \ of magical [Darkness](Sonstige/z_Content%20&%20Rules/variant-rules/darkness-xphb.md)\
      \ originating from a point it can see within 60 feet, which lasts for 1 minute\
      \ or until the gnoll's [Concentration](Sonstige/z_Content%20&%20Rules/conditions.md#Concentration)\
      \ ends on it. This area is [Difficult Terrain](Sonstige/z_Content%20&%20Rules/variant-rules/difficult-terrain-xphb.md).\
      ...
      \ Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/temporary-hit-points-xphb.md).\
      \ *Success:* Half damage only."
    "name": "Hunger of Yeenoghu (Recharge 5-6)"
"bonus_actions":
  - "desc": "Immediately after dealing damage to a creature that is already [Bloodied](Sonstige/z_Content%20&%20Rules/conditions.md#Bloodied),\
      \ the gnoll moves up to half its [Speed](Sonstige/z_Content%20&%20Rules/variant-rules/speed-xphb.md),\
      \ and it makes one Abyssal Strike attack."
    "name": "Rampage (2/Day)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fiend/token/gnoll-demoniac-xmm.webp"
```
^statblock
