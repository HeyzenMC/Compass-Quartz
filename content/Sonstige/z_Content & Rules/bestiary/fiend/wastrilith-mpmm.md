...
- "Wastrilith"
---
# [Wastrilith](Sonstige/z_Content%20&%20Rules/bestiary/fiend/wastrilith-mpmm.md)
...
Creatures that ingest water corrupted by a wastrilith risk their very souls. Those who drink the poisonous liquid might wither away until they finally die, or they remain alive only to become thralls of chaos and evil. To represent this defilement, you can use the [optional rule on abyssal corruption](Sonstige/z_Content%20&%20Rules/tables/optional-rule-abyssal-corruption-abyssal-corruption.md) in "chapter 2 of the Dungeon Master's Guide", causing the poisoned creature to be corrupted.
...
"traits":
  ...
  - "desc": "At the start of each of the wastrilith's turns, exposed water within\
      ...
      \ 14 (4d6) poison damage and is [poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned)\
      \ for 1 minute. At the end of this time, the [poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned)\
      \ creature must repeat the saving throw. On a failure, the creature takes 18\
      \ (4d8) poison damage and is [poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fiend/token/wastrilith-mpmm.webp"
```
^statblock
