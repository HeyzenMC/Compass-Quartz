...
- "Oinoloth"
---
# [Oinoloth](Sonstige/z_Content%20&%20Rules/bestiary/fiend/oinoloth-mpmm.md)
...
"actions":
  ...
  - "desc": "The oinoloth touches one willing creature within 5 feet of it. The target\
      ...
      \ on the target or remove one of the following conditions from it: [blinded](Sonstige/z_Content%20&%20Rules/conditions.md#Blinded),\
      \ [deafened](Sonstige/z_Content%20&%20Rules/conditions.md#Deafened), [paralyzed](Sonstige/z_Content%20&%20Rules/conditions.md#Paralyzed),\
      \ or [poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned). The\
      \ target then gains 1 level of [exhaustion](Sonstige/z_Content%20&%20Rules/conditions.md#Exhaustion),\
      \ and its hit point maximum is reduced by 7 (2d6). This reduction can be removed\
      \ only by a [wish](Sonstige/z_Content%20&%20Rules/spells/wish-xphb.md) spell\
      \ or by casting [greater restoration](Sonstige/z_Content%20&%20Rules/spells/greater-restoration-xphb.md)\
  ...
  - "desc": "The oinoloth casts one of the following spells, requiring no material\
      ...
      \n**At will:** [darkness](Sonstige/z_Content%20&%20Rules/spells/darkness-xphb.md),\
...
"bonus_actions":
  - "desc": "The oinoloth blights the area in a 30-foot-radius sphere centered on\
      ...
      \ and is [poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned).\
      \ On a successful save, the creature is immune to the oinoloth's Bringer of\
      \ Plagues for the next 24 hours.\n\nThe [poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned)\
      \ creature can't regain hit points. After every 24 hours that elapse, the [poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fiend/token/oinoloth-mpmm.webp"
```
^statblock
