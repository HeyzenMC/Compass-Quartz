...
- "Sibriex"
---
# [Sibriex](Sonstige/z_Content%20&%20Rules/bestiary/fiend/sibriex-mpmm.md)
...
"actions":
  ...
  - "desc": "The sibriex targets up to three creatures it can see within 120 feet\
      ...
      \ save, the target is [poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned),\
      \ which causes it to also gain 1 level of [exhaustion](Sonstige/z_Content%20&%20Rules/conditions.md#Exhaustion).\
      \ While [poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned) in\
      \ this way, the target must repeat the saving throw at the start of each of\
      \ its turns. Three successful saves against the poison end it, and ending the\
      \ poison removes any levels of [exhaustion](Sonstige/z_Content%20&%20Rules/conditions.md#Exhaustion)\
      \ caused by it. Each failed save causes the target to gain another level of\
      \ [exhaustion](Sonstige/z_Content%20&%20Rules/conditions.md#Exhaustion). Once\
      \ the target reaches 6 levels of [exhaustion](Sonstige/z_Content%20&%20Rules/conditions.md#Exhaustion),\
      \ it dies and instantly transforms into a living [manes](Sonstige/z_Content%20&%20Rules/bestiary/fiend/manes-xmm.md)\
  ...
  - "desc": "The sibriex casts one of the following spells, requiring no material\
      ...
      \n**1/day:** [feeblemind](Sonstige/z_Content%20&%20Rules/spells/befuddlement-xphb.md)"
    "name": "Spellcasting"
...
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fiend/token/sibriex-mpmm.webp"
```
^statblock
