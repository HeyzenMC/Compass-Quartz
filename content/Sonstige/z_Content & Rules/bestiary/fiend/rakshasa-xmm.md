...
"damage_vulnerabilities": "piercing damage from weapons wielded by creatures under\
  \ the effect of a [Bless](Sonstige/z_Content%20&%20Rules/spells/bless-xphb.md) spell"
...
"traits":
  ...
  - "desc": "If the rakshasa dies outside the Nine Hells, its body turns to ichor,\
      \ and it gains a new body instantly, reviving with all its [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +10, reach 5 ft. *Hit:* 12 (2d6 + 5) Slashing\
      ...
      \ cursed. While cursed, the target gains no benefit from finishing a [Short](Sonstige/z_Content%20&%20Rules/variant-rules/short-rest-xphb.md)\
      \ or [Long Rest](Sonstige/z_Content%20&%20Rules/variant-rules/long-rest-xphb.md)."
    "name": "Cursed Touch"
  - "desc": "*Wisdom Saving Throw:* DC 18, each enemy in a 30-foot [Emanation](Sonstige/z_Content%20&%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the rakshasa. *Failure:* 28 (8d6) Psychic damage, and the\
      \ target has the [Frightened](Sonstige/z_Content%20&%20Rules/conditions.md#Frightened)\
      \ and [Incapacitated](Sonstige/z_Content%20&%20Rules/conditions.md#Incapacitated)\
  ...
  - "desc": "The rakshasa casts one of the following spells, requiring no Material\
      ...
      \ Illusion](Sonstige/z_Content%20&%20Rules/spells/minor-illusion-xphb.md)\n\n\
      **1/day each:** [Fly](Sonstige/z_Content%20&%20Rules/spells/fly-xphb.md), [Invisibility](Sonstige/z_Content%20&%20Rules/spells/invisibility-xphb.md),\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fiend/token/rakshasa-xmm.webp"
```
^statblock
