...
"cr": "4"
"traits":
  - "desc": "When the incubus finishes a [Long Rest](Sonstige/z_Content%20&%20Rules/variant-rules/long-rest-xphb.md),\
      \ it can shape-shift into a [Succubus](Sonstige/z_Content%20&%20Rules/bestiary/fiend/succubus-xmm.md),\
...
"actions":
  ...
  - "desc": "The incubus casts one of the following spells, requiring no Material\
      ...
      \n**1/day each:** [Dream](Sonstige/z_Content%20&%20Rules/spells/dream-xphb.md),\
...
"bonus_actions":
  - "desc": "*Wisdom Saving Throw:* DC 15, one creature the incubus can see within\
      \ 60 feet. *Failure:* If the target has 20 [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)\
      \ or fewer, it has the [Unconscious](Sonstige/z_Content%20&%20Rules/conditions.md#Unconscious)\
...
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fiend/token/incubus-xmm.webp"
```
^statblock
