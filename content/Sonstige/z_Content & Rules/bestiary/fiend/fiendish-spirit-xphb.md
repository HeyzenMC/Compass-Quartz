...
- "Fiendish Spirit"
---
# [Fiendish Spirit](Sonstige/z_Content%20&%20Rules/bestiary/fiend/fiendish-spirit-xphb.md)
...
"traits":
  - "desc": "When the spirit drops to 0 [Hit Points](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md)\
      \ or the spell ends, the spirit explodes. *Dexterity Saving Throw:* DC equals\
      \ your spell save DC, each creature in a 10-foot [Emanation](Sonstige/z_Content%20&%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
  ...
  - "desc": "The spirit has [Advantage](Sonstige/z_Content%20&%20Rules/variant-rules/advantage-xphb.md)\
...
"source":
  - "XPHB"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fiend/token/fiendish-spirit-xphb.webp"
```
^statblock