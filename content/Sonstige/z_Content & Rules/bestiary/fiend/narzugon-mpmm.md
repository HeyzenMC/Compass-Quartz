...
- "Narzugon"
---
# [Narzugon](Sonstige/z_Content%20&%20Rules/bestiary/fiend/narzugon-mpmm.md)
...
Narzugons wield hell-forged lances that shunt the souls of any they killed to the River Styx for rebirth as [lemures](Sonstige/z_Content%20&%20Rules/bestiary/fiend/lemure-xmm.md). Every lance bears the marks of both a narzugon and its master.

Each narzugon claims a [nightmare](Sonstige/z_Content%20&%20Rules/bestiary/fiend/nightmare-xmm.md) as its mount. These steeds are bound by [infernal tack](Sonstige/z_Content%20&%20Rules/items/infernal-tack-mtf.md) and must respond to the summons and commands of the spurs' wearer.
...
"cr": "13"
"traits":
  - "desc": "The narzugon wears spurs that are part of [infernal tack](Sonstige/z_Content%20&%20Rules/items/infernal-tack-mtf.md),\
      \ which allow it to summon its [nightmare](Sonstige/z_Content%20&%20Rules/bestiary/fiend/nightmare-xmm.md)\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +10 to hit, reach 10 ft., one target. *Hit:*\
      ...
      \ kills a creature with a soul, the soul rises from the River Styx as a [lemure](Sonstige/z_Content%20&%20Rules/bestiary/fiend/lemure-xmm.md)\
      \ in Avernus in 1d4 hours. If the creature isn't revived before then, only\
      \ a [wish](Sonstige/z_Content%20&%20Rules/spells/wish-xphb.md) spell or killing\
      \ the lemure and casting true resurrection on the creature's original body can\
      \ restore it to life. Constructs and devils are immune to this effect."
    "name": "Hellfire Lance"
  - "desc": "Each ally of the narzugon within 60 feet of it can't be [charmed](Sonstige/z_Content%20&%20Rules/conditions.md#Charmed)\
      \ or [frightened](Sonstige/z_Content%20&%20Rules/conditions.md#Frightened) until\
      \ the end of the narzugon's next turn."
    "name": "Infernal Command"
  - "desc": "Each creature within 60 feet of the narzugon that isn't a Fiend must\
      \ succeed on a DC 17 Charisma saving throw or become [frightened](Sonstige/z_Content%20&%20Rules/conditions.md#Frightened)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fiend/token/narzugon-mpmm.webp"
```
^statblock