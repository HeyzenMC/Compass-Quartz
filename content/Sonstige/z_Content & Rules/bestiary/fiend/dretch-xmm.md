...
"actions":
  - "desc": "*Melee Attack Roll:* +3, reach 5 ft. *Hit:* 4 (1d6 + 1) Slashing\
      \ damage."
    "name": "Rend"
  - "desc": "*Constitution Saving Throw:* DC 11, each creature in a 10-foot [Emanation](Sonstige/z_Content%20&%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the dretch. *Failure:* The target has the [Poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned)\
      \ condition until the end of its next turn. While [Poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned),\
      \ the creature can take either an action or a [Bonus Action](Sonstige/z_Content%20&%20Rules/variant-rules/bonus-action-xphb.md)\
      \ on its turn, not both, and it can't take Reactions."
    "name": "Fetid Cloud (1/Day)"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fiend/token/dretch-xmm.webp"
```
^statblock
