...
"traits":
  ...
  - "desc": "The chasme has [Advantage](Sonstige/z_Content%20&%20Rules/variant-rules/advantage-xphb.md)\
...
"actions":
  - "desc": "*Melee Attack Roll:* +5, reach 5 ft. *Hit:* 16 (4d6 + 2) Piercing\
      ...
      \ Point](Sonstige/z_Content%20&%20Rules/variant-rules/hit-points-xphb.md) maximum\
      \ decreases by an amount equal to the Necrotic damage taken."
    "name": "Proboscis"
"bonus_actions":
  - "desc": "*Constitution Saving Throw:* DC 12, each creature in a 30-foot [Emanation](Sonstige/z_Content%20&%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the chasme (demons automatically succeed on this save). *Failure:*\
      \ The target has the [Unconscious](Sonstige/z_Content%20&%20Rules/conditions.md#Unconscious)\
      ...
      \ within 5 feet of it takes an action to empty a flask of [Holy Water](Sonstige/z_Content%20&%20Rules/items/holy-water-xphb.md)\
      \ on it. *Success:* The target is immune to this chasme's Drone for 24 hours."
    "name": "Drone"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fiend/token/chasme-xmm.webp"
```
^statblock
