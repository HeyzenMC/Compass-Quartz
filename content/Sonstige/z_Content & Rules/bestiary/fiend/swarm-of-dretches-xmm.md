...
"traits":
  - "desc": "*Constitution Saving Throw:* DC 12, any creature that starts its turn\
      \ in a 10-foot [Emanation](Sonstige/z_Content%20&%20Rules/variant-rules/emanation-area-of-effect-xphb.md)\
      \ originating from the swarm. *Failure:* The target has the [Poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned)\
      \ condition until the start of its next turn. While [Poisoned](Sonstige/z_Content%20&%20Rules/conditions.md#Poisoned),\
      \ the target can take either an action or a [Bonus Action](Sonstige/z_Content%20&%20Rules/variant-rules/bonus-action-xphb.md)\
...
"actions":
  ...
  - "desc": "*Melee Attack Roll:* +4, reach 5 ft. *Hit:* 12 (3d6 + 2) Slashing\
      \ damage, or 9 (3d4 + 2) Slashing damage if the swarm is [Bloodied](Sonstige/z_Content%20&%20Rules/conditions.md#Bloodied)."
    "name": "Rend"
"source":
  - "XMM"
"image": "Sonstige/z_Content%20&%20Rules/bestiary/fiend/token/swarm-of-dretches-xmm.webp"
```
^statblock
