...
![](Sonstige/z_Content%20&%20Rules/races/img/halfling.webp#right)
...
You have [Advantage](Sonstige/z_Content%20&%20Rules/variant-rules/advantage-xphb.md) on saving throws you make to avoid or end the [Frightened](Sonstige/z_Content%20&%20Rules/conditions.md#Frightened) condition.
...
When you roll a 1 on the `d20` of a [D20 Test](Sonstige/z_Content%20&%20Rules/variant-rules/d20-test-xphb.md), you can reroll the die, and you must use the new roll.

### Naturally Stealthy

You can take the [Hide](Sonstige/z_Content%20&%20Rules/actions.md#Hide) action even when you are obscured only by a creature that is at least one size larger than you.
