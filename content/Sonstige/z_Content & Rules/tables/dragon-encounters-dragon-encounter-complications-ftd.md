...
| 12 | A feature in the dragon's lair has an unpredictable magical effect, perhaps similar to a [wand of wonder](Sonstige/z_Content%20&%20Rules/items/wand-of-wonder-xdmg.md), a sorcerer's [Wild Magic Surge](Sonstige/z_Content%20&%20Rules/tables/wild-magic-surge-xphb.md), or a "dungeon trick" as described in the "Dungeon Master's Guide". The dragon avoids the feature unless the encounter is going badly, then either activates the feature or tries to goad the characters into doing so. |
