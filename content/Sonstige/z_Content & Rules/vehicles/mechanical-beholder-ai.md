...
![](Sonstige/z_Content%20&%20Rules/vehicles/token/mechanical-beholder-ai.webp#token)
...
- **Paralyzing Ray.** The targeted creature must succeed on a DC 15 Constitution saving throw or be [paralyzed](Sonstige/z_Content%20&%20Rules/conditions.md#Paralyzed) for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.  
```
^statblock