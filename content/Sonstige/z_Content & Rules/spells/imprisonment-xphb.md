...
- **Chaining.** Chains firmly rooted in the ground hold the target in place. The target has the [Restrained](Sonstige/z_Content%20&%20Rules/conditions.md#Restrained) condition and can't be moved by any means.  
...
- **Slumber.** The target has the [Unconscious](Sonstige/z_Content%20&%20Rules/conditions.md#Unconscious) condition and can't be awoken.  
...
A [Dispel Magic](Sonstige/z_Content%20&%20Rules/spells/dispel-magic-xphb.md) spell can end the spell only if it is cast with a level 9 spell slot, targeting either the prison or the component used to create it.
